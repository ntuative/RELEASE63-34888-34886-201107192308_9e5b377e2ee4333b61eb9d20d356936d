package com.sulake.habbo.sound.object
{
   ...
   public class HabboSound implements IHabboSound
   {
      ...
      private var var_1188:Sound = null;
      ...
      public function HabboSound(param1:Sound)
      {
         ...
         this.var_1188.addEventListener(Event.COMPLETE,this.onComplete);
         this.var_1017 = 1;
      ...
      {
         this._complete = false;
         this.var_450 = this.var_1188.play(0);
      ...
      {
         return this.var_1188.length;
      }
      
      public function get ready() : Boolean
      {
         return !this.var_1188.isBuffering;
      }
