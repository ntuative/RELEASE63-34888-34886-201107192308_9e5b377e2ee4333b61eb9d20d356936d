package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1568:int = HabboMusicPrioritiesEnum.const_120;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_854.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_854.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_854)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_917,this.onJukeboxInit);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_294,this.onJukeboxDispose);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_857,this.onSoundMachineInit);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_992,this.onSoundMachineDispose);
         this.var_1268 = new Timer(1000);
         this.var_1268.start();
         this.var_1268.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1888)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_285)
            {
               ...
               {
                  _loc3_ = this.var_285.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_93)
            {
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_917,this.onJukeboxInit);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_294,this.onJukeboxDispose);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_857,this.onSoundMachineInit);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_992,this.onSoundMachineDispose);
            }
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_285.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_655.add(param1,param2);
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_285.length)
         {
            ...
            if(_loc3_.id != this.var_1536 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         while(_loc2_ < this.var_333.length)
         {
            if(this.var_333[_loc2_] != null)
            {
               ...
               _loc4_ = this.var_285.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_285.add(_loc6_.id,_loc10_);
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_1888 = this.getSongRequestCountAtPriority(param1);
         this.var_1536 = param2;
         if(this._priorityPlaying <= const_1568)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2595 != param1.id || _loc3_ > this.var_2596 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2595 = param1.id;
            this.var_2596 = _loc3_;
         }
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_549 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_93,this._connection) as IPlayListController;
      }
