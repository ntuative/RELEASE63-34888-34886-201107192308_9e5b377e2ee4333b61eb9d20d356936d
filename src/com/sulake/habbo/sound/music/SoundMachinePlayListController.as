package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_256:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_256 = param2;
         this.var_854 = [];
         this.var_854.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_854.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_854)
         {
         ...
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_991,this.onSoundMachinePlayEvent);
         this.var_93.addEventListener(RoomEngineSoundMachineEvent.const_846,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_93)
            {
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_991,this.onSoundMachinePlayEvent);
               this.var_93.removeEventListener(RoomEngineSoundMachineEvent.const_846,this.onSoundMachineStopEvent);
               this.var_93 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         {
            this.playCurrentSongAndNotify(this.var_477);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_256.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_477 = -1;
         this.var_688 = false;
         this.var_256.stop(HabboMusicPrioritiesEnum.const_120);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_256.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_256.playSong(param1,HabboMusicPrioritiesEnum.const_120,_loc3_,0,0,0))
         {
