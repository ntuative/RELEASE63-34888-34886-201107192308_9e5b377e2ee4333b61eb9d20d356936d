package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1559:int = 60;
      
      private static const const_1558:int = 25165823;
      
      private static const const_1557:int = 16777215;
      ...
      private var var_1016:IHabboNotifications;
      
      private var var_1017:Number = 1.0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1016)
         {
            this.var_1016.release(new IIDHabboNotifications());
            this.var_1016 = null;
         }
         super.dispose();
      }
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1015.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1287:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1727:
               ...
               case HabboSoundTypesEnum.SOUND_MESSAGE_SENT:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1280:
                  _loc3_ = "sound_catalogue_pixels";
                  break;
               case HabboSoundTypesEnum.const_1380:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_2004:
            ...
            this.var_1015.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_1017;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_145.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_145.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_646.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1251.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1016.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_145.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2531 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1016 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_145 == null || this._connection == null || this._roomEngine == null || this.var_256 != null)
         {
            return;
         }
         this.var_256 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_256.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1818,this.var_812));
         this.var_812 = -1;
         this.var_811 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_1017 * 100)));
         }
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_256.updateVolume(this.var_1017);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_646.remove(param1);
            if(this.var_281.getValue(_loc2_) == null)
            {
               this.var_1522.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1522,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1522,_loc2_,TraxSample.const_1763,TraxSample.const_1728);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1252.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1559 && this.var_1252.length > 0)
            {
               _loc3_ = this.var_1252.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_646.length == 0 && this.var_812 != -1)
            {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_811 == null && this.var_1251.length > 0)
         {
            _loc1_ = this.var_1251.getKey(0);
            _loc2_ = this.var_1251.remove(_loc1_);
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_256.samplesIdsInUse;
         var _loc4_:int = 0;
         ...
         if(_loc1_ > const_1558)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1557 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               ...
               this.var_256.samplesUnloaded(_loc7_);
            }
         }
      }
