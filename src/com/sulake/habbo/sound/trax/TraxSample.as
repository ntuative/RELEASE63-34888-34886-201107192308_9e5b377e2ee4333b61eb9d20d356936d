package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1763:String = "sample_44khz";
      
      public static const const_1930:String = "sample_22khz";
      
      public static const const_1928:String = "sample_11khz";
      
      public static const const_1728:String = "sample_16bit";
      
      public static const const_1856:String = "sample_8bit";
      
      public static const SAMPLE_VALUE_MULTIPLIER:Number = 0.000030517578125;
      
      private static const const_1142:int = 32;
      ...
      private var var_188:int = 2;
      
      private var var_88:int = 1;
      
      private var var_721:Array;
      
      private var var_2912:uint;
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_188 * this.var_88;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1142)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1142);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_188 == this.var_188 - 1)
            {
               this.var_140[int(_loc11_ / this.var_188)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_140.length * this.var_188 * this.var_88;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_188 * this.var_88;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_721.indexOf(param1) == -1)
         {
