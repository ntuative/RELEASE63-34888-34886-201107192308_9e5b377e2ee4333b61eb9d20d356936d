package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_732:String = "temporary_room";
      
      private static const const_391:int = -1;
      
      private static const const_731:String = "room";
      
      private static const const_1166:int = -2;
      
      private static const const_1720:String = "tile_cursor";
      
      private static const const_1165:int = -3;
      
      private static const const_1721:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_392:String = "object_icon_sprite";
      
      private static const const_490:int = 15;
      
      private static const const_1164:int = 40;
      ...
      private var var_356:IAdManager = null;
      
      private var var_426:ISessionDataManager = null;
      ...
      private var var_923:NumberBank;
      
      private var var_1406:Map;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_923 = new NumberBank(1000);
         this.var_1406 = new Map();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_356)
         {
            this.var_356.release(new IIDHabboAdManager());
            this.var_356 = null;
         }
         if(this.var_426)
         {
            this.var_426.release(new IIDSessionDataManager());
            this.var_426 = null;
         }
         if(this.var_15)
         {
         ...
         if(this.var_313 != null)
         {
            ...
            {
               _loc2_ = this.var_313.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         if(this.var_313 != null)
         {
            _loc4_ = this.var_313.getValue(_loc3_) as RoomInstanceData;
            if(_loc4_ == null)
            {
               _loc4_ = new RoomInstanceData(param1,param2);
               this.var_313.add(_loc3_,_loc4_);
            }
         }
         return _loc4_;
      }
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_296:
      ...
      public function addFloorHole(param1:int, param2:int, param3:int) : void
      {
         ...
         if(param3 >= 0)
         {
            ...
            if(_loc5_ != null && _loc5_.getModel() != null && _loc4_ != null && _loc4_.getEventHandler() != null)
            {
               ...
               _loc9_ = _loc5_.getModel().getNumber(RoomObjectVariableEnum.const_273);
               _loc10_ = _loc5_.getModel().getNumber(RoomObjectVariableEnum.const_350);
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1141 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc5_ = this.var_313.getWithIndex(_loc3_) as RoomInstanceData;
            _loc6_ = null;
            _loc7_ = 0;
            _loc8_ = 0;
            if(_loc5_ != null)
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  if(_loc7_ != this.var_91 || _loc8_ != this.var_90 || !this.var_1140)
                  {
         ...
         if(_loc4_ != null)
         {
            if(this.var_1140)
            {
               _loc4_.screenOffsetX += this.var_1700;
               _loc4_.screenOffsetY += this.var_1702;
               this.var_1700 = 0;
               this.var_1702 = 0;
            }
         }
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_935) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_887) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_984) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_948) + 0.5;
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            events.addEventListener(RoomContentLoader.const_1010,this.onContentLoaderReady);
            this.var_14.initialize(events,this.var_161);
         }
         this.var_3030 = this.var_161.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_1010)
         {
            this.var_3032 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_356 = param2 as IAdManager;
         this.var_356.events.addEventListener(AdEvent.const_665,this.showRoomAd);
         this.var_356.events.addEventListener(AdEvent.const_974,this.onRoomAdImageLoaded);
         this.var_356.events.addEventListener(AdEvent.const_1349,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_426 = param2 as ISessionDataManager;
         this.var_14.sessionDataManager = this.var_426;
      }
      ...
      {
         if(this.var_922 == null || this.var_548 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_161 == null || !this.var_3032)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_604 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_792,0,0));
            _loc2_ = 0;
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1258,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1258);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1382,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_961,1,true);
            _loc12_ = parseInt(this.var_161.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1345,_loc12_,true);
            if(this.var_14 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_391,const_731,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_961,0,true);
         }
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_935,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_984,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_887,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_948,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1272,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_985,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_218,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_1007,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_203,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_774,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               ...
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_602,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_293);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_752,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_748,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_752,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_748,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1182,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_1166,const_1720,RoomObjectCategoryEnum.const_378);
         if(this.var_161.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1165,const_1721,RoomObjectCategoryEnum.const_378);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_391,RoomObjectCategoryEnum.const_82);
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(param3 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_985,param3);
         ...
         if(param4 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_1007,param4);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         if(param5 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_774,param5);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1929,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1171,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1194,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_313.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1339;
         ...
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_752);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_748);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1182);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1699;
         var _loc9_:int = param3 - this.var_1698;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1140 = true;
               this.var_924 = false;
               this.var_3029 = this.var_1699;
               this.var_3031 = this.var_1698;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1140)
            {
               if(!this.var_924)
               {
                  _loc8_ = param2 - this.var_3029;
                  _loc9_ = param3 - this.var_3031;
                  if(_loc8_ <= -const_490 || _loc8_ >= const_490 || _loc9_ <= -const_490 || _loc9_ >= const_490)
                  {
                     this.var_924 = true;
                  }
                  _loc8_ = 0;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_576,this.var_91,this.var_90,-1,RoomObjectCategoryEnum.const_163));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_77 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_391,const_731);
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_91,this.var_90,this.var_1701);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1699 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1698 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_91,this.var_90,this.var_1701);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_91,this.var_90,this.var_1701);
         if(_loc1_ != null)
         {
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_961) != 0)
         {
            return false;
         }
         if(this.var_77 != null)
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1165,RoomObjectCategoryEnum.const_378);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1166,RoomObjectCategoryEnum.const_378);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_298,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_295,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_399,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_779,1,true);
            ...
            {
               _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1028,1);
            }
         }
      ...
      public function changeObjectState(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         {
            _loc6_ = Number(_loc5_.getModelController().getNumber(RoomObjectVariableEnum.const_925));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
            ...
            _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_925,_loc6_);
         }
      }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_298,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_295,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_399,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1339,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1028,1);
            }
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1320) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1392);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_1026,_loc5_);
                  }
               }
            }
         }
      ...
      public function updateObjectUserAction(param1:int, param2:int, param3:int, param4:String, param5:int, param6:String = null) : Boolean
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectVariableEnum.const_270:
               ...
               break;
            case RoomObjectVariableEnum.const_594:
            ...
            case RoomObjectVariableEnum.const_444:
               ...
               break;
            case RoomObjectVariableEnum.const_417:
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            if(_loc4_.disposeObject(param2,param3))
            {
               if(events != null)
               {
                  events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_394,this.var_91,this.var_90,param2,param3));
               }
            }
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_298));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_373);
                     break;
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_206);
               }
            }
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_732);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_732,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_923.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_27:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_298,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_373,param7);
               break;
            case RoomObjectCategoryEnum.const_29:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_206,param2);
               }
               else
               {
         ...
         {
            this.var_1406.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1180,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_923.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_91,this.var_90,const_391,RoomObjectCategoryEnum.const_82,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_732);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1180);
               ...
               this.var_923.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1406.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ != null && _loc6_.getModel() != null && _loc6_.getEventHandler() != null)
         {
            ...
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_800,_loc4_,_loc5_,param2,param3));
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_458,param1.image,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1290,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1327,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1374,RoomObjectVariableEnum.const_458,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         {
            this.var_356.loadRoomAdImage(param1,param2,param3,param4,param5,param6);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_974:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1385,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_1349:
