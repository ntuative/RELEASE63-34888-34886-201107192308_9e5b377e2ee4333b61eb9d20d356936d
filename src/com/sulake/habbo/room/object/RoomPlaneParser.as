package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private static const const_1194:Number = 0.25;
      
      public static const const_73:int = -110;
      
      public static const const_110:int = -100;
      ...
      private var var_1439:Number = 1.0;
      
      private var var_946:Number = 1.0;
      
      private var var_969:Number = 0.0;
      ...
      public function initializeTileMap(param1:int, param2:int) : Boolean
      {
         ...
         while(_loc3_ < param2)
         {
            ...
            this.var_519.push(_loc6_);
            _loc3_++;
         }
         this.var_213 = param1;
         this._height = param2;
         this._minX = this.var_213;
         this.var_439 = -1;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         var _loc8_:int = 0;
         if(param1 >= 0 && param1 < this.var_213 && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this._minX || param1 == this.var_439)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_438;
                  while(_loc6_ < this.var_440)
                  {
               ...
               if(param2 == this.var_438 || param2 == this.var_440)
               {
                  _loc7_ = false;
                  _loc8_ = this._minX;
                  while(_loc8_ < this.var_439)
                  {
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         while(_loc3_ < this._height)
         {
            ...
            while(_loc2_ < this.var_213)
            {
               if(this.var_519[_loc3_][_loc2_])
               {
                  this.var_120[_loc3_][_loc2_] = const_110;
               }
               _loc2_++;
            }
            _loc3_++;
      ...
      private function initialize(param1:Point, param2:Boolean) : Boolean
      {
         ...
         this.var_969 = getFloorHeight(this.var_120);
         if(!param2)
         {
      ...
      private function createWallPlanes() : Boolean
      {
         ...
         {
            if(this.getTileHeightInternal(_loc8_,_loc9_) > const_110)
            {
               _loc9_--;
               break;
            }
         ...
         if(_loc22_)
         {
            ...
            while(_loc2_ < _loc26_)
            {
               if(!_loc20_[_loc2_])
               {
                  ...
                  {
                     if(this.getTileHeightInternal(_loc29_.x + _loc3_ * _loc30_.x - _loc31_.x,_loc29_.y + _loc3_ * _loc30_.y - _loc31_.y) == const_110)
                     {
                        _loc20_[_loc2_] = true;
                        break;
                     }
      ...
      private function extractTopWall(param1:Point) : Point
      {
         ...
         while(_loc2_ < 1000)
         {
            if(this.getTileHeightInternal(param1.x + _loc2_,param1.y) > const_110)
            {
               return new Point(param1.x + _loc2_ - 1,param1.y);
            }
            if(this.getTileHeightInternal(param1.x + _loc2_,param1.y + 1) <= const_110)
            {
      ...
      private function extractRightWall(param1:Point) : Point
      {
         ...
         while(_loc2_ < 1000)
         {
            if(this.getTileHeightInternal(param1.x,param1.y + _loc2_) > const_110)
            {
               return new Point(param1.x,param1.y + (_loc2_ - 1));
            }
            if(this.getTileHeightInternal(param1.x - 1,param1.y + _loc2_) <= const_110)
            {
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         this.addPlane(RoomPlaneData.const_411,param1,param2,param3,[param4]);
         var _loc8_:Number = const_1194 * this.var_1439;
         var _loc9_:Number = const_680 * this.var_946;
      ...
      private function addFloor(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Number, param9:Number, param10:Number, param11:Number, param12:Boolean, param13:Boolean) : void
      {
         ...
         if(_loc14_)
         {
            _loc18_ = const_680 * this.var_946;
            _loc19_ = _loc18_;
            if(this.var_946 > 1)
            {
               _loc19_ = const_680;
      ...
      public function getXML() : XML
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:* = null;
         var _loc1_:XML = <tileMap width="{this.var_213}" height="{this._height}" wallHeight="{this.var_1438}"/>;
         var _loc2_:int = 0;
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_320.length)
         {
            _loc12_ = this.var_320.getWithIndex(_loc4_);
            if(_loc12_ != null)
            {
               _loc13_ = this.var_320.getKey(_loc4_);
      ...
      public function getPlaneLocation(param1:int) : IVector3d
      {
         ...
         var _loc2_:RoomPlaneData = this.var_157[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
            return _loc2_.loc;
         }
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1236;
         }
         var _loc2_:RoomPlaneData = this.var_157[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
      ...
      public function getPlaneMaskLeftSideLoc(param1:int, param2:int) : Number
      {
         ...
         var _loc3_:RoomPlaneData = this.var_157[param1] as RoomPlaneData;
         if(_loc3_ != null)
         {
      ...
      public function addFloorHole(param1:int, param2:int, param3:int, param4:int, param5:int) : void
      {
         ...
         this.var_320.add(param1,_loc6_);
      }
      
      public function removeFloorHole(param1:int) : void
      {
         this.var_320.remove(param1);
      }
      ...
      private function initializeHoleMap() : void
      {
         ...
         while(_loc2_ < this._height)
         {
            _loc3_ = this.var_519[_loc2_];
            _loc1_ = 0;
            while(_loc1_ < this.var_213)
            {
               _loc3_[_loc1_] = false;
               _loc1_++;
            }
         ...
         while(_loc4_ < this.var_320.length)
         {
            _loc5_ = this.var_320.getWithIndex(_loc4_);
            if(_loc5_ != null)
            {
               _loc6_ = _loc5_.x;
               ...
               _loc7_ = _loc7_ >= this.var_213 ? int(this.var_213 - 1) : int(_loc7_);
