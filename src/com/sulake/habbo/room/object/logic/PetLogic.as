package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_169,RoomObjectMoveEvent.const_443];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2778)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1598 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
            {
               _loc6_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
               _loc2_.setString(RoomObjectVariableEnum.const_141,_loc6_.gesture);
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_285,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_206);
            _loc2_.setString(RoomObjectVariableEnum.const_206,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1821,_loc10_.race);
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_231,_loc3_ + this.var_1066);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_2008;
            _loc2_.setNumber(RoomObjectVariableEnum.const_260,this.var_2008);
            _loc2_.setNumber(RoomObjectVariableEnum.const_141,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_2007;
            _loc2_.setNumber(RoomObjectVariableEnum.const_141,this.var_2007);
         }
         else
         {
            this.var_1066 += 45;
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_141,null);
            this.var_1599 = 0;
         }
         if(this.var_1598 > 0)
         {
