package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1978:int = 255;
      
      private var var_1661:uint = 16777215;
      
      private var var_2148:int = 255;
      
      private var var_1376:uint = 16777215;
      
      private var var_2149:int = 255;
      
      private var var_1375:int = 0;
      
      private var var_2147:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_514,RoomObjectMouseEvent.const_169];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_765,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_900,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_913,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_954,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_962,1);
         }
      }
         ...
         if(this.var_1660)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_765,_loc3_.toString());
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1375)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1978;
            if(_loc2_ - this.var_1375 >= this.var_2147)
            {
               _loc3_ = this.var_1376;
               _loc4_ = this.var_2149;
               this.var_1375 = 0;
            }
            else
            {
               _loc7_ = this.var_1661 >> 16 & 255;
               _loc8_ = this.var_1661 >> 8 & 255;
               _loc9_ = this.var_1661 & 255;
               _loc10_ = this.var_1376 >> 16 & 255;
               _loc11_ = this.var_1376 >> 8 & 255;
               _loc12_ = this.var_1376 & 255;
               _loc13_ = (_loc2_ - this.var_1375) / this.var_2147;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_2148 + (this.var_2149 - this.var_2148) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_900,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_985:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_1007:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_602:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_293)
               {
                  _loc5_ = "null";
               }
               this.var_562.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_1026:
               _loc4_ = this.var_562.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_562.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1174,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1171:
               param2.setNumber(RoomObjectVariableEnum.const_913,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1251:
               param2.setNumber(RoomObjectVariableEnum.const_954,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_962,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_680:
               param2.setNumber(RoomObjectVariableEnum.const_1269,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1194:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1237,int(param1.bgOnly));
         this.var_1661 = this._color;
         this.var_2148 = this.var_1978;
         this.var_1376 = _loc3_;
         this.var_2149 = _loc4_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_550,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1726,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_2009,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1894,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_550,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_251 || _loc12_ == RoomPlaneData.const_411)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
