package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_882:DirectionData = null;
      
      private var var_301:Map;
      
      private var _colors:Map;
      
      private var var_1346:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_882 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_301 != null)
         {
            ...
            {
               _loc2_ = this.var_301.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_882,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_301.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_882);
            this.defineDirection(_loc3_,_loc8_);
            this.var_301.add(String(_loc7_),_loc3_);
            this.var_2054 = -1;
            this.var_1346 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1347);
                  break;
               case "SUBTRACT":
      ...
      public function getDirectionValue(param1:int) : int
      {
         ...
         if(this.var_301.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < this.var_301.length)
         {
            _loc6_ = int(this.var_301.getKey(_loc5_)) * this.var_1620;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_301.getKey(_loc4_));
         }
         return const_1945;
      }
      ...
      {
         if(param1 == this.var_2054)
         {
            return this.var_1346;
         }
         var _loc2_:* = null;
         _loc2_ = this.var_301.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_882;
         }
