package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetAnimationSizeData extends AnimationSizeData
   {
      ...
      public function definePostures(param1:XML) : Boolean
      {
         ...
         {
            this.var_791 = param1.@defaultPosture;
         }
         else
         {
            this.var_791 = null;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_635.add(_loc6_,_loc7_);
         ...
         if(this.var_635.getValue(this.var_791) == null)
         {
            return false;
         }
         return true;
      ...
      public function defineGestures(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            _loc6_ = String(_loc5_.@id);
            _loc7_ = int(_loc5_.@animationId);
            this.var_792.add(_loc6_,_loc7_);
            _loc4_++;
         }
         return true;
      }
      ...
      {
         if(this.var_635.getValue(param1) == null)
         {
            param1 = this.var_791;
         }
      ...
      public function getAnimationForGesture(param1:String) : int
      {
         ...
         return int(this.var_792.getValue(param1));
      }
      ...
      public function getPostureForAnimation(param1:int) : String
      {
         ...
         {
            return this.var_635.getKey(param1);
         }
         return this.var_791;
      }
      ...
      {
         if(param1 >= 0 && param1 < this.var_792.length)
         {
            return this.var_792.getKey(param1);
         }
         return null;
      }
      ...
      {
         return this.var_635.length;
      }
      
      public function getGestureCount() : int
      {
         return this.var_792.length;
      }
   }
}
