package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_670:PetVisualizationData = null;
      ...
      private var var_1937:Number = NaN;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_595.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_595.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      {
         this.var_670 = param1 as PetVisualizationData;
         createSprites(this.const_1606);
         var _loc2_:BitmapData = (this.var_670.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1938 = param1.getNumber(RoomObjectVariableEnum.const_285) > 0;
            this.var_1564 = param1.getString(RoomObjectVariableEnum.const_141);
            this.var_290 = param1.getString(RoomObjectVariableEnum.const_260);
            this.var_1567 = param1.getString(RoomObjectVariableEnum.const_740);
            this.var_1937 = param1.getNumber(RoomObjectVariableEnum.const_231);
            this.var_1634 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2427 = param1.getNumber(RoomObjectVariableEnum.const_396);
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_512 != param1.getUpdateID() || this.var_1833 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1937;
            if(isNaN(this.var_1937))
            {
               _loc5_ = _loc4_;
            }
            else
            ...
            if(_loc4_ != this.var_1939 || param3)
            {
            ...
            if(_loc5_ != this.var_1933 || param3)
            {
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_595.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_670.getAvatar(this._figure,param1,this);
            if(_loc3_ != null)
            {
               this.var_595.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         var _loc12_:Boolean = this.var_1129 || this.var_1383 > 0 || this.var_2159;
         this.var_412.alpha = 0;
         if(this.var_1634 > 0)
         {
            _loc13_ = param2 - this.var_1634;
            if(_loc13_ < AvatarAction.const_1141)
            {
               this.var_412.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_412.setExperience(this.var_2427);
               this.var_1383 = this.const_2375;
            }
            else
            {
               this.var_1634 = 0;
            }
            _loc14_ = getSprite(this.const_2072);
            if(_loc14_ != null)
            {
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_1110);
            if(_loc14_)
            {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         {
            param1.appendAction(AvatarAction.const_366,this.var_1564);
         }
