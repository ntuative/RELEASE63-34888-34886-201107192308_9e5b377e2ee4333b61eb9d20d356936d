package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1685:String = "head";
      
      private static const const_719:int = 1;
      
      private static const const_1141:int = 1000;
      
      private static const const_1687:String = "pet_experience_bubble_png";
      
      private static const const_1686:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1687) as BitmapDataAsset;
            if(_loc3_ != null)
            {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2905)
            {
               this.var_2905 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_147)
         {
            ...
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_141);
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_141);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_1938 = _loc3_.getNumber(RoomObjectVariableEnum.const_285) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_231);
            if(!isNaN(_loc8_))
            {
               this.var_2095 = _loc8_;
            }
            else
            {
               this.var_2095 = direction;
            }
            this.var_1634 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2427 = _loc3_.getNumber(RoomObjectVariableEnum.const_396);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_733);
            if(_loc9_ != this.var_2094)
            {
               this.var_2094 = _loc9_;
               this.var_2906 = this.var_2094.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_412 != null)
         {
            ...
            if(this.var_1634 > 0)
            {
               _loc2_ = param1 - this.var_1634;
               if(_loc2_ < const_1141)
               {
                  this.var_412.alpha = int(Math.sin(_loc2_ / const_1141 * 0) * 255);
      ...
      {
         return super.getAdditionalSpriteCount() + const_719;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2906);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_719)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_719))
            {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_2095);
         }
         return direction;
      }
      ...
      {
         if(this.var_1092[param1] == null)
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1685)
            {
               this.var_1092[param1] = true;
            }
            else
            {
               this.var_1092[param1] = false;
            }
         }
