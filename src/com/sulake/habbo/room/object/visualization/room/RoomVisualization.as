package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1923:int = 16777215;
      
      public static const const_1957:int = 13421772;
      ...
      public static const const_1918:int = 16777215;
      
      public static const const_1807:int = 13421772;
      
      public static const const_1887:int = 10066329;
      ...
      private var var_562:RoomPlaneBitmapMaskParser = null;
      
      private var var_1588:String = null;
      
      private var _floorType:String = null;
      
      private var var_1589:String = null;
      ...
      private var var_1962:String = null;
      
      private var var_1307:uint = 16777215;
      
      private var var_2684:int = 255;
      ...
      private const const_2352:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_562 = new RoomPlaneBitmapMaskParser();
         this.var_335["null"] = false;
         this.var_335["null"] = true;
         this.var_335["null"] = true;
         this.var_335["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_157 != null)
         {
            ...
            {
               _loc2_ = this.var_157[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_157.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_157[_loc2_] as RoomPlane;
            _loc4_ = getSprite(_loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.method_3 != null)
            {
               if(_loc3_.type == RoomPlane.const_75 && (_loc3_.leftSide.length < 1 || _loc3_.method_3.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         {
            this._planeParser.wallThicknessMultiplier = this.var_1439;
         }
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_765);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1272);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_253)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1923;
               }
               else
               {
                  _loc13_.color = const_1957;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_411)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1840)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_75,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_411)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2352 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_396.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1963)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2681 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2683 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2684 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1833)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1637 || _loc3_.y != this.var_2685 || _loc3_.z != this.var_2686 || param1.scale != this.var_1961))
            {
               this.var_1637 = _loc3_.x;
               this.var_2685 = _loc3_.y;
               this.var_2686 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1174);
            if(_loc3_ != this.var_1962)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1962 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_900));
            if(_loc4_ != this.var_1307)
            {
               this.var_1307 = _loc4_;
               this.var_2681 = this.var_1307 & 255;
               this.var_2683 = this.var_1307 >> 8 & 255;
               this.var_2684 = this.var_1307 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1237));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            ...
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_954));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_962));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1269);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1305);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_946 || _loc3_ != this.var_1439))
            {
               this.var_946 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            ...
            if(!isNaN(_loc2_) && _loc2_ != this.var_2682)
            {
               this.var_2682 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_157.length)
         {
            _loc5_ = this.var_157[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
      ...
      {
         if(param1 != this.var_335["null"] || param2 != this.var_335["null"] || param3 != this.var_335["null"])
         {
            this.var_335["null"] = param1;
            this.var_335["null"] = param2;
            this.var_335["null"] = param3;
            this.var_396 = [];
            this.var_676 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_335[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1306;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_562.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_157.length)
         {
            _loc3_ = this.var_157[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_562.maskCount)
         {
            _loc10_ = this.var_562.getMaskType(_loc8_);
            _loc11_ = this.var_562.getMaskLocation(_loc8_);
            _loc12_ = this.var_562.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_157.length)
               {
                  _loc3_ = this.var_157[_loc13_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_75 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.method_3 != null)
                           {
                              _loc16_ = Vector3d.scalarProjection(_loc14_,_loc3_.leftSide);
                              _loc17_ = Vector3d.scalarProjection(_loc14_,_loc3_.method_3);
                              if(_loc3_.type == RoomPlane.const_75 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_293)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_157[_loc18_] as RoomPlane;
