package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_1842:int = 0;
      ...
      private var var_1069:IPlaneRasterizer = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2811 = param9;
         this.var_2808 = param10;
         this.var_2809 = param11;
         this.var_2812 = param12;
         this.var_1070 = param6;
      }
      ...
      {
         return this._isVisible && this.var_867;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_227 != null)
         {
            ...
            {
               _loc2_ = this.var_227.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_227.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_227 != null)
         {
            ...
            {
               _loc3_ = this.var_227.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1069.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = this.var_227.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_867 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_401))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1069 != null)
            {
               _loc3_ = this.var_1069.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2015,this.var_2811,this.var_2808,this.var_2809,this.var_2812,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(!geometryChanged || !this.var_867)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1571.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1571[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1332);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_185.z - originZ,this.var_136.z - originZ,this.var_100.z - originZ,this.var_137.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2813 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2810);
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_1070)
         {
            _loc4_ = null;
            _loc5_ = 0;
            while(_loc5_ < this.var_296.length)
            {
               _loc4_ = this.var_296[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_296.length == this.var_1068.length)
         {
            while(_loc1_ < this.var_296.length)
            {
               _loc4_ = this.var_296[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
         ...
         if(this.var_402.length > this.var_1604.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1070 || this.var_296.length == 0 && this.var_402.length == 0 && !this.var_401 || this.var_771 == null)
         {
            return;
         }
         ...
         if(this.var_401)
         {
            ...
            while(_loc5_ < this.var_296.length)
            {
               _loc3_ = this.var_296[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc3_.leftSideLoc / this.var_344.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc3_.rightSideLoc / this.var_345.length;
                  _loc12_ = _loc3_.type;
                  this.var_771.updateMask(this.var_80,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_402.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_80.width - this.var_80.width * _loc4_.leftSideLoc / this.var_344.length;
                  _loc11_ = this.var_80.height - this.var_80.height * _loc4_.rightSideLoc / this.var_345.length;
                  _loc13_ = this.var_80.width * _loc4_.leftSideLength / this.var_344.length;
                  _loc14_ = this.var_80.height * _loc4_.rightSideLength / this.var_345.length;
                  this.var_80.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1604.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_401 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_258 != null && (this.var_258.width != param1.width || this.var_258.height != param1.height))
         {
            this.var_258.dispose();
            this.var_258 = null;
         }
         if(this.var_258 == null)
         {
            this.var_258 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_258.copyChannel(param1,param1.rect,const_716,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_258.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_258,this.var_258.rect,const_716,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
