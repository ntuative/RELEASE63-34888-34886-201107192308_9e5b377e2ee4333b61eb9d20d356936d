package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2257:int = 16777216;
      ...
      private var var_2000:int = 16777216;
      
      private var var_3091:int = 69069;
      
      private var var_3092:int = 5;
      ...
      {
         var _loc1_:int = this.var_3091 * this.var_2001 + this.var_3092;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2000;
         this.var_2001 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2000 * param2);
      }
   }
}
