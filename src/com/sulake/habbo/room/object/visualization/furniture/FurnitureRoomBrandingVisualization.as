package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1446:String = "branded_image";
      
      private static const const_1447:int = 0;
      
      private static const const_1443:int = 1;
      
      private static const const_1445:int = 2;
      
      private static const const_1444:int = 3;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1706 = _loc4_.getNumber(RoomObjectVariableEnum.const_637);
                  this.var_1705 = _loc4_.getNumber(RoomObjectVariableEnum.const_535);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_525);
               }
            }
         }
         if(!this.var_1414)
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_324);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_591);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1446)
         {
