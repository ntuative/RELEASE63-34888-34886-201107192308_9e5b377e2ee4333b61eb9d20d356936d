package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1674:Number = 30;
      ...
      {
         this.var_885 = new Vector3d(0,0,0);
      ...
      {
         var _loc3_:Number = this.var_1593 * Math.cos(this.var_1355 + this.var_2083);
         var _loc4_:Number = this.var_1593 * Math.sin(this.var_1355 + this.var_2083);
         var _loc5_:Number = this._height;
         this.var_885.x = (_loc3_ - _loc4_) * (param2 / 2);
         this.var_885.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - this._height * (param2 / 2);
         this.var_885.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            this.var_885.add(param1);
         }
         return this.var_885;
      }
