package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_113 = this.var_1244[param1];
         this.var_1003 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1837 >= 0)
         {
            this.var_280 = this._visualization.getSprite(this.var_1837);
            if(this.var_280 && this.var_280.asset)
            {
               ...
               if(this.var_98 == null)
               {
                  this.var_98 = this.var_280.asset.clone();
                  if(this.var_805.alphaMultiplier != 1)
                  {
                     this.var_642 = new BitmapData(this.var_98.width,this.var_98.height,true,4278190080);
                  }
               }
               this.var_2471 = -this.var_280.offsetX;
               this.var_2472 = -this.var_280.offsetY;
               this.var_280.asset = this.var_98;
            }
            if(this.var_98)
            {
            ...
            if(this.var_642)
            {
               this.var_642.fillRect(this.var_642.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_113.y * this.var_1245;
         }
         return 0;
      }
      ...
      public function updateSprites() : void
      {
         ...
         if(this.var_98 && this.var_280.asset != this.var_98)
         {
            this.var_280.asset = this.var_98;
         }
         if(this.var_1003)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_1003 && this.var_113.hasIgnited)
         {
            this.var_1003 = true;
         }
         _loc8_ = this.var_1198 * this.var_1245;
         this.var_113.update();
         if(this.var_1003)
         {
            if(this.var_113.roomObjectSpriteId >= 0)
            ...
            {
               this.var_98.draw(this.var_642,this.var_1836,this.var_805,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_113.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2471 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1245;
               _loc4_ = this.var_2472 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1245;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_98.draw(_loc7_,this._translationMatrix,this.var_1517,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
