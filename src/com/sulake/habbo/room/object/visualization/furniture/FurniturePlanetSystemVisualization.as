package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         if(this.var_302 == null && spriteCount > 0)
         {
         ...
         if(this.var_302 != null)
         {
            ...
            {
               _loc2_ = this.var_302[_loc3_];
               _loc2_.update(this._offsetArray,this.var_2866,param1);
               _loc3_++;
            }
