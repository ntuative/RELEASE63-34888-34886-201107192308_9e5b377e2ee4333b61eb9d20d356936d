package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_2155:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_3008:IContainerButtonWindow;
      
      private var var_3007:IContainerButtonWindow;
      
      private var var_3006:IContainerButtonWindow;
      ...
      {
         this.var_3008 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_3007 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_3006 = this.initButton("room_invite",this.onInviteButtonClick,param1);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_3008,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_3007,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_3006,this.isEnableInviteButton(_loc1_));
