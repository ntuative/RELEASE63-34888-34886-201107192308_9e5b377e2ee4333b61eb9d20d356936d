package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1825:AvatarSearchResults;
      ...
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1825 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_803)
         {
            this.var_803.release(new IIDSessionDataManager());
            this.var_803 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1826 = new OpenedToWebPopup(this);
         }
         this.var_1826.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_445);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_321,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_612.createAvatarImage(param1,AvatarScaleType.const_113,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_145.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_145.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_1016 = param2 as IHabboNotifications;
      ...
      {
         this.var_803 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_1169,this.getText("friendlist.friends")));
         this.var_119.addCategory(new FriendCategory(FriendCategory.const_401,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_119.addFriend(new Friend(_loc4_));
         }
         this.var_482 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_641)
         {
         ...
         {
            _loc5_ = this.var_119.findCategory(FriendCategory.const_401);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_482.findTab(FriendListTab.const_87).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_482.findTab(FriendListTab.const_87);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1825.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_482.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_482.findTab(FriendListTab.const_87);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_803 || !this.var_121)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_803.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_41))
         {
            _loc2_ = this.var_121.vipLimit;
         }
         else if(this.var_803.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
