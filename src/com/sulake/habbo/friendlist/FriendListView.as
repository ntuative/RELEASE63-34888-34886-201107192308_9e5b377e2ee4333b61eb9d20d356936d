package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1473:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1832:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1832 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1473;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_997 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_272 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1832.prepare(this.var_997);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1362,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1360,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_802,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_939,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_802,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_939,true);
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc4_:int = this.var_1829 == -1 ? 0 : int(this.var_16.width - this.var_1829);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1397,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_802,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1362,false);
         ...
         this.var_1829 = this.var_16.width;
