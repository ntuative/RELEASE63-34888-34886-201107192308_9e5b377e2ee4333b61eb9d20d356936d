package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      public function fillFooter(param1:IWindowContainer) : void
      {
         ...
         this.var_868.addEventListener(WindowKeyboardEvent.const_183,this.onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            this.var_65.getListItemAt(_loc1_).color = this._friendList.laf.getRowShadingColor(FriendListTab.const_445,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
