package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2127:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107192302));
         this.var_141 = new Map();
         this.var_141.add(HabboHelpViewEnum.const_1837,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_214,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_586,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_340,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_249,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_454,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_997,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_266,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_141.add(HabboHelpViewEnum.const_1185,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_141.add(HabboHelpViewEnum.const_1361,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_141.add(HabboHelpViewEnum.const_1021,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_2127)
         {
            this.var_585 = new Array();
         }
         else if(param2)
         {
            if(this.var_585.length == 0 || param1 != this.var_416)
            {
               this.var_585.push(this.var_416);
            }
         }
         this.var_416 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_266:
               this.showUI(HabboHelpViewEnum.const_266);
               break;
            case CallForHelpResultEnum.const_1248:
               this.showUI(HabboHelpViewEnum.const_1361);
               break;
            case CallForHelpResultEnum.const_1297:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_141.getValue(HabboHelpViewEnum.const_214) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_673));
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2453 = this._window.width - _loc3_.width;
         this.var_2452 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2452;
         this._window.width = _loc1_.width + this.var_2453;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_585.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_416 == HabboHelpViewEnum.const_214)
         {
            return;
         }
         if(this.var_726.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_726.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_726[1],this.var_726[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_726[0],this.var_726[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_416 == HabboHelpViewEnum.const_214 || this.var_585.length == 0)
         {
            return;
         }
         if(this.var_415 == null)
