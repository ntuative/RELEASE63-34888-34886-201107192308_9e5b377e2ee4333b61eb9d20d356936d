package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1448:uint = 13232628;
      
      private static var var_1742:uint = 11129827;
      ...
      private var var_1168:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1741 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_766)
         {
            this.var_766 = this.var_26.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_766)
            {
               return;
            }
            this._window.content.addChild(this.var_766);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_765)
         {
            this.var_765 = this.var_26.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_765)
            {
               return;
            }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this.var_26.localization.registerParameter("help.tutorial.name.available","name",this.var_522);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            ...
            case ChangeUserNameResultMessageEvent.var_1142:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1143:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1143 || param1 == ChangeUserNameResultMessageEvent.var_1142)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1168 = new NameSuggestionListRenderer(this.var_26);
         var _loc6_:int = this.var_1168.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1448;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_522 = this.var_26.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this.var_26.changeName(this.var_522);
               break;
            ...
            case "header_button_close":
               this.var_26.showView(TutorialUI.const_100);
         }
      }
