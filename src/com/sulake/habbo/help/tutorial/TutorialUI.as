package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_549:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_538,this.onTaskDoneEvent);
         ...
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_335,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1219 && this.var_1218 && this.var_1500;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            ...
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_538,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_515,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_335,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_673:
               this.var_1500 = true;
               if(this.var_54 != null && this.var_54.id == const_549)
               {
                  this.showView(const_100);
               }
               break;
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2453 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2452;
         this._window.width = _loc2_.width + this.var_2453;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_54 != null && (this.var_54.id == const_372 || this.var_54.id == const_100))
         {
            this.showView(const_100);
         }
      }
      ...
      {
         this.var_1219 = true;
         if(this.var_54 != null && (this.var_54.id == const_395 || this.var_54.id == const_100))
         {
            this.showView(const_100);
         }
      }
