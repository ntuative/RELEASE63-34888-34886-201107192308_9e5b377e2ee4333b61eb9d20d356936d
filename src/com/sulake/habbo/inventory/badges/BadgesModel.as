package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public static const const_668:int = 0;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_426 = param5;
         this.var_426.events.addEventListener(BadgeImageReadyEvent.const_212,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_426.events.removeEventListener(BadgeImageReadyEvent.const_212,this.onBadgeImageReady);
            this.var_426 = null;
         }
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_864[_loc2_] == param1)
            {
               this.var_864.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1322.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_687.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_426.getBadgeImage(param1);
            if(_loc10_)
            {
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_349);
         var _loc3_:int = 0;
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_668);
         ...
         var _loc3_:Array = this.getBadges(const_349);
      ...
      {
         return this.getItemInIndex(param1,const_349);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_668);
      }
      ...
      {
         if(param1 == InventoryCategory.const_220 && this.var_26.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_687.indexOf(_loc2_) == -1)
            {
               this.var_687.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_687 && this.var_687.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1256));
            this.var_687 = [];
