package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_709:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_709 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_709.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_1080 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1080.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_709.scrollV;
         this.var_709.removeGridItems();
         this.var_1080.removeGridItems();
         var _loc2_:Array = this.var_78.getBadges(BadgesModel.const_668);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_709.addGridItem(_loc3_.window);
         ...
         if(_loc1_ > 0)
         {
            this.var_709.scrollV = _loc1_;
         }
         var _loc5_:Array = this.var_78.getBadges(BadgesModel.const_349);
         _loc4_ = 0;
         while(_loc4_ < _loc5_.length)
         {
            _loc3_ = _loc5_[_loc4_] as Badge;
            this.var_1080.addGridItem(_loc3_.window);
      ...
      public function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_78.getBadges(BadgesModel.const_349);
      ...
      {
         var _loc2_:int = this.var_709.getGridItemIndex(param1.window);
      ...
      {
         var _loc2_:int = this.var_1080.getGridItemIndex(param1.window);
