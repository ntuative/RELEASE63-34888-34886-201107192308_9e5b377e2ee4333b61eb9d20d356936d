package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1461:int = 13421772;
      
      private static const const_1462:int = 10275685;
      ...
      protected var var_935:int = 0;
      
      protected var var_748:BitmapData;
      
      protected var var_2940:int;
      ...
      private const const_2064:Number = 1;
      
      private const const_2065:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1478 = this._window.findChildByTag("BG_COLOR");
         this.var_2344 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2255 == FurniModelCategory.const_36)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1510));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2257);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_1033)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               this._window.blend = this.const_2064;
               _loc1_.blend = this.const_2064;
            }
         }
         this.var_1478.color = !!this.var_1481 ? uint(const_1462) : uint(const_1461);
         this.var_2344.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2256 && this.getRecyclableCount() > 0)
            {
