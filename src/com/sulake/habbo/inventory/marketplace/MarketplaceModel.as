package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_26 != null && this.var_26.furniModel != null && this.var_255 != null)
         {
            this.var_26.furniModel.removeLockFrom(this.var_255.id);
            this.var_255 = null;
         }
      }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_255 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_255.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_255 is FloorItem ? 1 : 2;
         this.var_2861 = _loc2_;
         this.var_2856 = this.var_255.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_255.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.showMakeOffer(this.var_255);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_2193,this.var_2192);
         }
      }
      ...
      {
         if(param1 != this.var_2861 || param2 != this.var_2856)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2672);
      }
