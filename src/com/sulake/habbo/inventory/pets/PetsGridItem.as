package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_46:
               this.var_1479.setSelectedGridItem(this);
               this.var_1480 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1480 = false;
                  this.var_1479.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         if(!this._window || !this.var_1478)
         {
            return;
         }
         this.var_1478.color = !!this.var_1462 ? uint(const_1462) : uint(const_1461);
         this.var_2344.visible = param1;
      }
