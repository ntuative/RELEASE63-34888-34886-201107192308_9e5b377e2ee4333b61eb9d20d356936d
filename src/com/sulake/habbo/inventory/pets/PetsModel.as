package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_121 && this.var_26.isVisible)
         {
      ...
      public function switchToFurnitureCategory(param1:String, param2:Boolean = false) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_26.toggleInventoryPage(InventoryCategory.const_76,param2);
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1753 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_29,RoomObjectTypeEnum.const_210,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1753 && param1.type == RoomEngineObjectEvent.const_173)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_524.indexOf(_loc2_) == -1)
            {
               this.var_524.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      {
         return this.var_524.length;
      }
      
      public function isUnseen(param1:int) : Boolean
      {
         return this.var_524.indexOf(param1) > -1;
      }
   }
}
