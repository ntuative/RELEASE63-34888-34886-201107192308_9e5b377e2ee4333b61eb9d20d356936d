   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_604,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_62.getValue(InventoryCategory.const_76));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_62.getValue(InventorySubCategory.const_374));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_62.getValue(InventoryCategory.const_160));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_62.getValue(InventoryCategory.const_220));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_62.getValue(InventorySubCategory.const_1334));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_62.getValue(InventoryCategory.const_121));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_62.getValue(InventoryCategory.const_449) as MarketplaceModel;
      }
      ...
      {
         this.var_426 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_604,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_83:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_604:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_426 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_62.add(InventoryCategory.const_449,_loc1_);
         ...
         this.var_62.add(InventoryCategory.const_76,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_426);
         this.var_62.add(InventoryCategory.const_220,_loc3_);
         ...
         this.var_62.add(InventoryCategory.const_160,_loc4_);
         ...
         this.var_62.add(InventorySubCategory.const_374,_loc5_);
         ...
         this.var_62.add(InventorySubCategory.const_1334,_loc6_);
         ...
         this.var_62.add(InventoryCategory.const_121,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_974.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_974.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_974.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_974.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_304));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2401)
         {
            this.var_2401 = _loc1_;
