package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1129:uint = 4284532064;
      
      private static const const_1128:uint = 2577770;
      ...
      private var var_1046:GroupItem;
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1977 = this.createMinimizedWindow();
         }
         if(!this.var_1158)
         {
            return this.var_79;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_79)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1129) : uint(const_1128);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1129) : uint(const_1128);
            }
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(_loc6_)
         {
            this.method_4(this.var_19.ownUserId);
         }
         ...
         if(_loc6_)
         {
            this.method_4(this.var_19.otherUserId);
         }
      }
      ...
      public function removeSelection() : void
      {
         if(this.var_1046)
         {
            this.var_1046.isSelected = false;
            this.var_1046 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1933)
            {
            ...
            this.var_679.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_642);
            this.var_679.show();
         }
         ...
         if(this.var_201.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_679.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_642);
               }
            }
            else
            {
