package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_76,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_160);
         _loc2_.refreshViews();
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_12.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember,_loc2_.isVIP,_loc2_.responseType == ScrSendUserInfoMessageParser.const_1335);
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_233)
            {
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_449);
      ...
      {
         var _loc2_:* = null;
         if(this.var_12.isInventoryCategoryInit(InventoryCategory.const_449))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_12.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_423));
         this.var_12.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_398));
         this.var_12.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_58));
         this.var_12.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1256));
