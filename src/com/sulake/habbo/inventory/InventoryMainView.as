package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_479:int = 3;
      ...
      private var var_2442:IWindowContainer;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_26.inventoryViewOpened(this.var_786);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_378 != null && this.var_378 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_378 || !this.var_26.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_378);
         }
         ...
         _loc2_.container.removeChild(this.var_1799);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_378 == InventoryCategory.const_121)
            {
               this.toggleCategoryView(InventoryCategory.const_121);
            }
            else if(this.var_378 == InventoryCategory.const_76)
            {
               this.toggleCategoryView(InventoryCategory.const_76);
            }
            else if(this.var_26 != null)
            {
               this.var_26.toggleInventoryPage(InventoryCategory.const_76);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1798)
         {
            this.var_1798 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_26.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1798,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_479;
            _loc3_.y = const_479;
         }
         return _loc3_;
      }
