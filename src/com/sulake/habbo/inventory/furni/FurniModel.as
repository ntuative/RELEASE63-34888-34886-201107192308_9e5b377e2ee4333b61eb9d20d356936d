package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1660:int = 100;
      
      private static const const_1661:int = 1000;
      ...
      private var var_1607:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_485 = [];
         this.var_484 = [];
         this.var_699 = new Timer(const_1660,1);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_173,this.onObjectPlaced);
               }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_36)
            {
               ...
               {
                  this.var_1607 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1607;
            }
            else
            {
         ...
         this.var_26.setInventoryCategoryInit(InventoryCategory.const_76);
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         if(param3 == FurniCategory.const_383)
         {
         ...
         if(this.var_869 == null)
         {
            this.var_869 = this._windowManager.buildFromXML(this.var_2817) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_869.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_869.clone() as IWindowContainer;
      ...
      {
         if(param1 == InventoryCategory.const_76 && this.var_26.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_274:
                  this.var_26.toggleInventoryPage(InventoryCategory.const_121);
            }
         }
      }
      ...
      {
         this.var_2818 = getTimer();
         this.switchCategory(const_274);
      }
      ...
      {
         this.var_26.checkCategoryInitilization(InventoryCategory.const_449);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_698.add(const_36,new Array());
         this.var_698.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         else
         {
            ...
            for(; _loc10_ < _loc8_.length; _loc10_++)
            {
               ...
               if(_loc9_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_233)
                  {
                     _loc7_ = _loc9_;
                  }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_274)
            {
      ...
      {
         return getTimer() < this.var_2818 + const_1661;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_333 || _loc3_.category == FurniCategory.const_383 || _loc3_.category == FurniCategory.const_348)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_698.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_1033)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_423:
               return this.var_485.length;
            case UnseenItemCategoryEnum.const_398:
               return this.var_484.length;
            default:
               return this.var_485.length + this.var_484.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            case const_45:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_398));
                  this.var_484 = [];
            ...
            case const_36:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_423));
                  this.var_485 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }
