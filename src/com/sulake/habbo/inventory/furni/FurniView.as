package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_2061:int = 0;
      ...
      private var var_866:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_216.add(FurniModelCategory.const_36,new FurniGridView(this.var_78,FurniModelCategory.const_36,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_216.add(FurniModelCategory.const_45,new FurniGridView(this.var_78,FurniModelCategory.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1055;
            _loc3_.y = _loc4_.y + const_1055;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_216.getValue(this.var_443);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_78.getCategoryContent(this.var_443);
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_216.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_216.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function moveItemTo(param1:GroupItem, param2:int) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_216.getValue(param1.mainCategory);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.getUnseenItemCount(UnseenItemCategoryEnum.const_423) > 0;
         _loc1_ = this._view.findChildByTag("unseen_symbol_wall");
         _loc1_.visible = this.var_78.getUnseenItemCount(UnseenItemCategoryEnum.const_398) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_78.getGroupItemInIndex(_loc3_,this.var_443);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            if(_loc5_.category == FurniCategory.const_383)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_233)
               {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_866 && this.var_866.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1226)
            {
         ...
         else if(param1.type == WindowEvent.const_48)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_274);
            }
         }
      }
