package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_225:IItemGridWindow;
      
      private var var_567:IWindow;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_225 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function clearGrid() : void
      {
         ...
         {
            this.var_225.removeGridItems();
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = this.var_225.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_225.autoArrangeItems = false;
            this.var_225.lock();
         }
         else
         {
            this.var_225.autoArrangeItems = true;
            this.var_225.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            this.var_78.toggleItemSelection(this._category,this.var_225.getGridItemIndex(param1.window));
            this.var_567 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_567 != null && this.var_567 == param2 && !this.var_78.isTradingOpen)
         {
