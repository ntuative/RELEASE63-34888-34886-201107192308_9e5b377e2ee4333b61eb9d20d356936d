package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1139:uint = 11;
      ...
      private var var_356:IAdManager;
      ...
      private var var_232:IHabboFriendList;
      
      private var var_1354:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_194:IHabboHelp;
      
      private var var_1627:Array;
      
      private var _crashed:Boolean = false;
      
      private var var_303:PerformanceTracker = null;
      
      private var var_492:FramerateTracker = null;
      
      private var var_304:LatencyTracker = null;
      
      private var var_715:LagWarningLogger = null;
      
      private var var_491:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_303 = new PerformanceTracker();
         this.var_492 = new FramerateTracker();
         this.var_304 = new LatencyTracker();
         this.var_715 = new LagWarningLogger();
         this.var_491 = new ToolbarClickTracker(this);
         this.var_1627 = new Array(const_1139);
         var _loc4_:int = 0;
         while(_loc4_ < const_1139)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1733,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1751,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1772,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_995,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1354)
            {
               this.var_1354.release(new IIDHabboWindowManager());
               this.var_1354 = null;
            }
            if(this.var_356)
            {
            ...
            if(this._navigator)
            {
               if(!this._navigator.disposed)
               {
                  ...
                  this._navigator.events.removeEventListener(HabboNavigatorEvent.const_369,this.onZoomToggle);
               }
            ...
            if(this.var_232)
            {
               ...
               {
                  Component(this.var_232).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_232).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_232).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_232).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_232).events.removeEventListener(HabboFriendListTrackingEvent.const_585,this.onFriendlistTrackingEvent);
               }
               this.var_232.release(new IIDHabboFriendList());
               this.var_232 = null;
            }
            if(this.var_194)
            {
               if(!this.var_194.disposed)
               {
                  this.var_194.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_194.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_194.release(new IIDHabboHelp());
               this.var_194 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_219,this.onRoomAdClick);
      ...
      {
         this.var_145 = IHabboConfigurationManager(param2);
         if(this.var_145)
         {
            if(this.var_304 != null)
            {
               this.var_304.configuration = this.var_145;
            }
            if(this.var_303 != null)
            {
               this.var_303.configuration = this.var_145;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1753);
            if(this.var_145)
            {
               if(this.var_715 != null)
               {
                  this.var_715.configure(this.var_145);
               }
               if(this.var_492 != null)
               {
                  this.var_492.configure(this.var_145);
               }
               if(this.var_491 != null)
               {
                  this.var_491.configure(this.var_145);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_967,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_491,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_303 != null)
            {
               this.var_303.connection = param1;
            }
            if(this.var_304 != null)
            {
               this.var_304.communication = this._communication;
               this.var_304.connection = param1;
            }
            if(this.var_715 != null)
            {
               this.var_715.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1735);
         }
         else if(param1.type == HabboHotelViewEvent.const_491)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1891);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_967:
               this.trackLoginStep(HabboLoginTrackingStep.const_1833,String(this._communication.port));
               break;
      ...
      {
         this.var_1354 = IHabboWindowManager(param2);
         if(this.var_1354)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_145)
            {
               if(this.var_145.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_145.getKey("client.fatal.error.url");
                  ...
                  if(this.var_303 != null)
                  {
                     _loc4_["null"] = this.var_303.flashVersion;
                     _loc4_["null"] = this.var_303.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1205);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1205,this.onCoreRunning);
         }
      }
      ...
      private function onNavigatorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_369,this.onZoomToggle);
      }
      ...
      {
         this.var_232 = param2 as IHabboFriendList;
         Component(this.var_232).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_232).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_232).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_232).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_232).events.addEventListener(HabboFriendListTrackingEvent.const_585,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_585:
      ...
      {
         this.var_194 = param2 as IHabboHelp;
         this.var_194.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_194.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2885)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1734);
            this.var_2885 = true;
         }
         ...
         if(_loc2_.privateRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_995,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_219,this.onRoomAdClick);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_356.events.addEventListener(AdEvent.const_665,this.onRoomAdLoad);
      }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_492)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_492.frameRate),_loc2_);
                  ++this.var_2079;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_491)
         {
            this.var_491.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_491)
         {
            this.var_491.track(param1.type);
         }
      }
      ...
      {
         if(this.var_145 != null && !Boolean(this.var_145.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_715.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_575 > -1 && _loc2_ < this.var_575)
         {
            ++this.var_2081;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2081);
         }
         if(this.var_575 > -1 && _loc2_ - this.var_575 > 15000)
         {
            ++this.var_2080;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2080);
         }
         this.var_575 = _loc2_;
         if(this.var_303 != null)
         {
            this.var_303.update(param1,this.var_575);
         }
         if(this.var_304 != null)
         {
            this.var_304.update(param1,this.var_575);
         }
         if(this.var_492 != null)
         {
            this.var_492.trackUpdate(param1,this,this.var_575);
         }
         if(this.var_715 != null)
         {
            this.var_715.update(this.var_575);
         }
      }
   }
}
