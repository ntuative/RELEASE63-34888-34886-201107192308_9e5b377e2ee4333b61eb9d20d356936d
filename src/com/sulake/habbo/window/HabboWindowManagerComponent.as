package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_484:uint = 3;
      
      private static const const_1672:uint = 1;
      ...
      private var var_1617:IEventDispatcher;
      
      private var var_1338:Boolean = false;
      
      private var var_2043:ProfilerOutput;
      
      private var var_1618:ProfilerAgentTask;
      
      private var var_1619:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_231 = new Array(const_484);
         ...
         this.var_630 = this.var_231[const_1672];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2043)
            {
               this.var_2043 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2043.profiler = _loc3_;
            this.var_1618 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1618);
            this.var_1619 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1619);
            this.var_1338 = true;
         }
      }
      ...
      {
         return this.var_630.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_630.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_299[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_299[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_231[param1].getDesktopWindow().getChildAt(this.var_630.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1617.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_484 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1617.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_484)
         {
         ...
         this.var_1617.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1738,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2014,param2.name + ": " + param2.toString());
            }
