package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_681:String = "room_view";
      
      private static const const_1421:String = "room_widget";
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager, param3:IHabboConfigurationManager) : void
      {
         ...
         while(_loc6_ < this.var_97.numChildren)
         {
            ...
            {
               _loc5_.addEventListener(WindowEvent.const_174,this.trimContainer);
            }
            _loc6_++;
         }
      }
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_356)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1421) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_97.getChildByTag(const_681) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_97.findChildByTag(const_681) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
