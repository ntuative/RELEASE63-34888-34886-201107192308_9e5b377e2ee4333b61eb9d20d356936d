package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1399:IRoomWidgetFactory;
      ...
      private var var_1521:IHabboAvatarEditor = null;
      ...
      private var var_1315:IHabboHelp;
      
      private var var_1134:IHabboModeration;
      ...
      private var var_1400:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1688 = RoomDesktop.const_534;
         super(param1,param2,param3);
         var _loc4_:RoomWidgetFactory = new RoomWidgetFactory(this,0,param3);
         this.var_1399 = _loc4_;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1315.release(new IIDHabboHelp());
            this.var_1315 = null;
         }
         ...
         {
            this.var_1134.release(new IIDHabboModeration());
            this.var_1134 = null;
         }
         ...
         if(this.var_1400)
         {
            this.var_1400.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1400 = null;
         }
         this.var_1521 = null;
         ...
         if(this.var_357)
         {
            while(this.var_357.length > 0)
            {
               _loc1_ = this.var_357.getKey(0) as String;
               _loc2_ = this.var_357.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1521 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_356 != null && this.var_356.events != null)
         {
            this.var_356.events.addEventListener(InterstitialEvent.const_639,this.interstitialCompleteEventHandler);
            this.var_356.events.addEventListener(InterstitialEvent.const_651,this.adEventHandler);
            this.var_356.events.addEventListener(AdEvent.const_665,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1315 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1134 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1134);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_235,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_592,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionUserBadgesEvent.const_142,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_130,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_165,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionDoorbellEvent.const_59,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_353,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_512,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_537,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_589,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_605,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1232,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1306,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_944,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_999,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_801,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_654,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_667,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionFriendRequestEvent.const_158,this.roomSessionEventHandler);
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_83:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_930);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_882:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_999:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this._interstitialRoomId,this.var_3013);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1400 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_792,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_1032,this.roomEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_394,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_294,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_792)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_524 || param1.type == RoomEngineEvent.const_581)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_187:
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_614);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_1000);
               ...
               if(this.var_1688 != RoomDesktop.const_534)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_341,this.var_1688);
               }
               if(this.var_356 != null)
               {
                  this.var_356.showRoomAd(param1.roomId,param1.roomCategory);
               }
            ...
            case RoomEngineEvent.const_339:
               ...
               break;
            case RoomEngineRoomColorEvent.const_1032:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1399;
         _loc3_.sessionDataManager = this.var_426;
         ...
         _loc3_.avatarEditor = this.var_1521;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_356;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1315;
         _loc3_.moderation = this.var_1134;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1400;
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_3013 = param1.roomCategory;
         }
         else
         {
            this.var_1689 = false;
         }
         this.var_357.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_357.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_341);
            if(_loc3_ != RoomDesktop.const_534)
            {
               this.var_1688 = _loc3_;
            }
            _loc2_.dispose();
            this.var_1689 = false;
         }
      ...
      {
         return this.var_357.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_357.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
