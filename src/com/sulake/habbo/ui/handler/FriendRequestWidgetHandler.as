package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_821);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_830);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_1015);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_821:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_830:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_1015:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_158);
         _loc1_.push(FriendRequestEvent.const_59);
         _loc1_.push(FriendRequestEvent.const_209);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_158:
            ...
            case FriendRequestEvent.const_209:
