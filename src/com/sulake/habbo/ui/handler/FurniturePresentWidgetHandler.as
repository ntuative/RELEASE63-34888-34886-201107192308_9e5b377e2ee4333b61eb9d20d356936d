package com.sulake.habbo.ui.handler
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1585:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_836,RoomWidgetPresentOpenMessage.const_186];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_836:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_295);
                     _loc8_ = _loc5_.getString(RoomObjectVariableEnum.const_373);
            ...
            case RoomWidgetPresentOpenMessage.const_186:
               ...
               if(_loc4_.objectId != this.var_240)
               {
                  return null;
               }
      ...
      {
         return [RoomSessionPresentEvent.const_353];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_353:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_64:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_607,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == TYPE_LANDSCAPE)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_536,0,this._container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           ...
                           {
                              if(_loc3_ != null && _loc3_.name == const_1585)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_346:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_561,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
