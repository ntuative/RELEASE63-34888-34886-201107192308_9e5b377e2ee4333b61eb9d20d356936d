package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1713:int = 1000;
      ...
      private var var_1399:IRoomWidgetFactory = null;
      
      private var var_426:ISessionDataManager = null;
      
      private var var_15:IRoomSessionManager = null;
      
      private var var_1095:IAvatarRenderManager = null;
      ...
      private var var_1315:IHabboHelp = null;
      ...
      private var var_265:IToolTipWindow;
      
      private var var_3011:uint = 16777215;
      ...
      private var var_2185:Rectangle;
      ...
      public function set friendList(param1:IHabboFriendList) : void
      {
         ...
         if(this._friendList)
         {
            ...
            this._friendList.events.addEventListener(FriendRequestEvent.const_209,this.processEvent);
         }
      }
      ...
      public function set navigator(param1:IHabboNavigator) : void
      {
         ...
         this._navigator.events.addEventListener(HabboNavigatorEvent.const_369,this.onNavigatorEvent);
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_421,this.onRoomContentLoaded);
      ...
      public function dispose() : void
      {
         ...
         if(this._friendList && this._friendList.events)
         {
            ...
            this._friendList.events.removeEventListener(FriendRequestEvent.const_209,this.processEvent);
         }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_421,this.onRoomContentLoaded);
         ...
         {
            this._navigator.events.removeEventListener(HabboNavigatorEvent.const_369,this.onNavigatorEvent);
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_33 != null)
         {
            this.var_915 = this._roomEngine.loadRoomResources(this.var_33.roomResources);
      ...
      {
         if(this.var_356 != null && this.var_33.state == RoomSessionEvent.const_284)
         {
            this.var_2186 = !this.var_356.showInterstitial();
         }
      ...
      {
         if(this.var_915 == null || this.var_915.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_915.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
      ...
      public function createWidget(param1:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc8_ = this.var_914.getValue(_loc11_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_914.add(_loc11_,_loc8_);
                  }
                  else
                  {
            ...
            if(_loc10_ != null)
            {
               ...
               {
                  _loc8_ = this.var_913.getValue(_loc12_);
                  if(_loc8_ == null)
                  {
                     _loc8_ = [];
                     this.var_913.add(_loc12_,_loc8_);
                  }
                  _loc8_.push(_loc4_);
               }
            }
         }
         _loc2_ = this.var_1399.createWidget(param1,_loc4_);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_914.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_913.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               {
                  _loc2_ = true;
                  if(this.var_426.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineObjectEvent.const_576:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_172,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_190:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_816,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_196:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_438,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               break;
            case RoomEngineObjectEvent.const_851:
               if(!this.var_33.isRoomController && !this.var_426.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.const_177:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1017,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_149:
               ...
               this.processWidgetMessage(_loc5_);
               break;
            case RoomEngineSoundMachineEvent.const_294:
               this.processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomEngineEvent.const_524:
               _loc2_ = new RoomWidgetRoomEngineUpdateEvent(RoomWidgetRoomEngineUpdateEvent.const_437,param1.roomId,param1.roomCategory);
         }
         if(_loc2_ != null)
         {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc5_:int = 0;
         if(this.var_355.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_935);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_984);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_887);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_948);
         ...
         _loc10_.addEventListener(WindowMouseEvent.const_254,this.canvasMouseHandler);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_3011);
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            this._roomEngine.handleRoomCanvasMouseEvent(this.var_355[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_265 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_265.width / 2,15);
            this.var_265.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_2185 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_33.roomId,this.var_33.roomCategory,this.var_355[0],_loc2_.width,_loc2_.height);
         if(this.var_520 == null)
         {
            this.var_520 = new Timer(const_1713,1);
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_2185));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_2188) / 1000);
      ...
      {
         var _loc2_:* = null;
         if(param1.type == HabboNavigatorEvent.const_369)
         {
            if(this.var_33 != null)
            {
               _loc2_ = this._roomEngine.getRoomCanvasGeometry(this.var_33.roomId,this.var_33.roomCategory,this.getFirstCanvasId());
      ...
      {
         if(this.var_15 != null && this.var_33 != null && this.var_2186 && this.var_2187)
         {
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_570:
               ...
               this.var_265 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_393,WindowStyle.const_102,WindowParam.const_104) as IToolTipWindow;
               this.var_265.setParamFlag(WindowParam.const_30,false);
