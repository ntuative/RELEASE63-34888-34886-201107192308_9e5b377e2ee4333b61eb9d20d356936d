package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1220;
         if(this.var_1220 < this.var_991.length)
         {
            _loc1_ = this.var_991[this.var_1220] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_991.length);
                  _loc2_.text = _loc6_;
               }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_991[this.var_1220] as Dictionary;
