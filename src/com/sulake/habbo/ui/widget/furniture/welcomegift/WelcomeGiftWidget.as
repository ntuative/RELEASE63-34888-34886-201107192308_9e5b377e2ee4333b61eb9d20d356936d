package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_694:String = "welcome_gift_email_unverified";
      
      private const const_1069:String = "welcome_gift_email_verified";
      
      private const const_1491:String = "welcome_gift_email_change";
      
      private const const_2345:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1205)
         {
            this.setViewState(this.const_1069);
         }
         else
         {
            this.setViewState(this.const_694);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_694:
               ...
               this._view.findChildByName("edit_text").visible = this.var_984;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_30,this.var_984);
               break;
            ...
            case this.const_1491:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_984);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1495;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1491);
      }
      ...
      {
         this.setViewState(!!this.var_1205 ? this.const_1069 : this.const_694);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1496 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1496));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_780,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_780,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_638:
               this.var_1495 = param1.email;
               this.var_1205 = param1.isVerified;
               this.var_984 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1495 = this.var_1496;
            this.setViewState(this.const_694);
         }
         else
         {
            if(param1.result == this.const_2345)
            {
               this.var_984 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1496);
