package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2096:int = 0;
      ...
      private const const_2090:String = "deco_img";
      
      private const const_2091:String = "dialog_bg";
      
      private const const_2365:String = "%campaign%_dialog_bg.png";
      
      private const const_388:String = "%campaign%_gift_package.png";
      
      private const const_2368:String = "%campaign%_gift_content.png";
      
      private const const_2366:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1648 = this.var_161.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1648 += "Viral/";
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_742,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_950:
               ...
               this._shareId = null;
               this.var_1649 = param1.itemCategory;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_742:
               _loc2_ = this.const_2093;
               this.var_240 = param1.objectId;
         ...
         if(this._window && (this.var_1647 != _loc2_ || _loc3_ != this.var_209))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_209 = _loc3_;
         this.var_1647 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1647)
            {
               ...
               case this.const_2093:
                  if(this.var_431 == this.const_2367)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_locked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_209,"client.show.locked");
                     _loc2_ = this.const_388;
                  }
                  else if(this.var_431 == this.const_2370)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_unlocked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_209,"client.show.unlocked");
                  ...
                  else if(this.var_431 == this.const_2369)
                  {
                     ...
                     this.sendConversionPoint("viral_" + this.var_209,"client.show.no_fb");
                  ...
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_209,"client.show.not_enough_fb_friends");
                  ...
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_209,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_2365.replace("%campaign%",this.var_209);
            this.setDecoImage(_loc5_,this.const_2091);
            _loc2_ = _loc2_.replace("%campaign%",this.var_209);
            this.setDecoImage(_loc2_,this.const_2090);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_1029);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_209,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_209,"client.start_post",this._shareId);
         var _loc4_:String = this.var_161.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_209,_loc2_,_loc3_,this._shareId,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_12)
         {
            if(this.var_1649 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1649 == 1 ? "null" : InventoryCategory.const_121);
            }
         }
         this.sendConversionPoint("viral_" + this.var_209,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_889,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1650.push(new ImageDownloader(this,_assets,this.var_209,this.var_1648,param1,param2));
            return;
         }
      ...
      function onDecoImageReady(param1:ImageDownloader) : void
      {
         ...
         if(!this._window || this.var_209 != param1.campaignID)
         {
            return;
         }
