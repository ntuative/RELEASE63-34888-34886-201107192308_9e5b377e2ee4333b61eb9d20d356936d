package com.sulake.habbo.ui.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_561,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_607,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_561,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_607,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_74:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_607:
               if(!this.var_397)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_532:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_561:
               if(!this.var_397)
               {
                  return;
               }
      ...
      {
         var _loc1_:* = null;
         if(this.var_397 || this.var_240 == -1 || !this.var_26)
         {
            return;
         }
         this.var_397 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_186,this.var_240);
