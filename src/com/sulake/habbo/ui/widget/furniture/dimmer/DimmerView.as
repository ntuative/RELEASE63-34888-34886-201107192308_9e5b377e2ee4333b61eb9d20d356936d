package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_501:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_70,HabboWindowStyle.const_31,0 | 0,new Rectangle(const_1570,const_1571,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_501 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_307 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_307.numTabItems)
         {
            _loc6_ = this.var_307.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1659 = _loc2_.light;
         if(this.var_501 != null)
         {
            this.var_501.setValue(this.var_1659);
         }
         this.var_594 = this.colors.indexOf(_loc2_.color);
         if(this.var_732 != null)
         {
            this.var_732.setSelectedColorIndex(this.var_594);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_307.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_307.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_307.selector.getSelected();
         return this.var_307.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1658 = XML(_loc1_.content);
         return this.var_1658;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_501 != null)
         {
            this.var_501.min = this._widget.minLights[param1 - 1];
         }
      }
