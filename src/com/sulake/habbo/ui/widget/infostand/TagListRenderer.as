package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1197:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1198 = 0;
         this.var_1197 = param2.rectangle.clone();
         this.var_1197.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1197.width)
         {
            return false;
         }
         if(this.var_1198 + param1.height > this.var_1197.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1197.width)
         {
            this._offsetX = 0;
            this.var_1198 += param1.height + this.const_2343;
      ...
      {
         var _loc2_:* = null;
         if(this.var_1573 != null && this.var_1573.indexOf(param1) != -1)
         {
