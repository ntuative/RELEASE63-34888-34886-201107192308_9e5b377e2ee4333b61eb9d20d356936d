package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc5_.name)
         {
            ...
            case "save_branding_configuration":
               break;
            case "CancelOfferMessageComposer":
               _loc3_ = "null";
         }
         if(_loc3_ != null)
         {
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1372 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_672 && param1.isRoomOwner)
         {
         ...
         this.showButton("CancelOfferMessageComposer",_loc6_);
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc6_.addEventListener(WindowKeyboardEvent.const_183,this.adElementKeyEventProc);
                  }
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1337.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
