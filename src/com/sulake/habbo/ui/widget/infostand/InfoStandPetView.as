package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1621:int = 162;
      
      private static const const_1620:int = 16;
      
      private static const const_711:int = 4;
      
      private static const const_1616:uint = 14342874;
      
      private static const const_1611:uint = 3815994;
      
      private static const const_1618:uint = 2085362;
      
      private static const const_1615:uint = 39616;
      
      private static const const_1613:uint = 10513106;
      
      private static const const_1614:uint = 8734654;
      
      private static const const_1622:uint = 9094430;
      
      private static const const_1612:uint = 6200576;
      
      private static const const_1619:String = "happiness";
      
      private static const const_1609:String = "experience";
      
      private static const const_1610:String = "energy";
      
      private static const const_1617:int = 250;
      
      private static const const_1112:int = 25;
      
      private static const const_1111:int = 5;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1619,param1.nutrition,param1.nutritionMax,const_1615,const_1618);
         this.updateStateElement(const_1609,param1.experience,param1.experienceMax,const_1614,const_1613);
         this.updateStateElement(const_1610,param1.energy,param1.energyMax,const_1612,const_1622);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1621,const_1620,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1616);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1611);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_711,_loc7_.width - 2,_loc7_.height - 2 - const_711);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_711);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_221 && this.var_221.getPetId() == this.var_533)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1778,true);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1112 + const_1111;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1111;
            }
         }
         this.var_108.height = _loc4_ + const_1112;
         this.updateWindow();
      }
   }
}
