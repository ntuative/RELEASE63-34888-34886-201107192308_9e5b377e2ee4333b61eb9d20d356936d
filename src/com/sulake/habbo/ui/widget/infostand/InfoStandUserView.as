package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1133:TagListRenderer;
      
      private var var_162:IBorderWindow;
      
      private var var_2942:int;
      
      private var var_2941:Boolean = true;
      
      private const const_1145:int = 5;
      
      private const const_2362:int = 3;
      
      private const const_1695:int = 11184810;
      
      private const const_1694:int = 16777215;
      
      private const const_2363:int = 2000;
      
      private const const_2361:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1133 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2941 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_162.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_162.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_162.x = _loc5_.left - this.var_162.width;
         this.var_162.y = _loc5_.top + (_loc5_.height - this.var_162.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_162.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_162.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_162.x = _loc7_.left - this.var_162.width;
         this.var_162.y = _loc7_.top + (_loc7_.height - this.var_162.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_162 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_162 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1145;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1695;
            }
            else
            {
               _loc5_.textColor = this.const_1694;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1145,this.const_2361);
         _loc5_.height = Math.max(_loc5_.height,this.const_2364);
         _loc3_.height = _loc5_.height + this.const_2362;
         if(param2)
         {
            _loc5_.addEventListener(WindowKeyboardEvent.const_379,this.onMottoKeyboard);
            _loc5_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc5_.removeEventListener(WindowKeyboardEvent.const_379,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1133.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2942 > this.const_2363 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2942 = _loc6_;
               _loc3_.textColor = this.const_1694;
            }
         }
         else
         {
            _loc3_.textColor = this.const_1695;
         }
      }
