package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_445:IFrameWindow;
      ...
      private const const_2341:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_376 = new Timer(this.const_2341);
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1193.getValue(this.var_533) as CommandConfiguration;
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.position = const_1473;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_445 == null)
         {
            ...
            this.var_445 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_445 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_445.x = 200;
            this.var_445.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_312,this.var_533));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_610,this.var_533,this.var_1782 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_610,this.var_533,this.var_1782 + " " + _loc5_);
