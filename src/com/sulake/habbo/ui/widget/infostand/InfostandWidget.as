package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_2086:String = "infostand_user_view";
      
      private const const_2085:String = "infostand_furni_view";
      
      private const const_2082:String = "infostand_pet_view";
      
      private const const_2083:String = "infostand_bot_view";
      
      private const const_2084:String = "infostand_jukebox_view";
      
      private const const_2081:String = "infostand_songdisk_view";
      ...
      private var var_1059:InfoStandJukeboxView;
      
      private var var_1060:InfoStandSongDiskView;
      
      private var var_2763:Array;
      
      private var var_1591:InfostandUserData;
      
      private var var_698:InfostandFurniData;
      ...
      private const const_2355:int = 3000;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1323 = new InfoStandFurniView(this,this.const_2085,this._catalog);
         this.var_205 = new InfoStandUserView(this,this.const_2086);
         this.var_399 = new InfoStandPetView(this,this.const_2082,this._catalog);
         this.var_478 = new InfoStandBotView(this,this.const_2083);
         this.var_1059 = new InfoStandJukeboxView(this,this.const_2084,this._catalog);
         this.var_1060 = new InfoStandSongDiskView(this,this.const_2081,this._catalog);
         this.var_1591 = new InfostandUserData();
         this.var_698 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_184 = new Timer(this.const_2355);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_172,this.onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_194,this.onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_381,this.onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_811,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_172,this.onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_194,this.onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_381,this.onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_811,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_312,this.var_399.getCurrentPetId()));
      }
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_2086);
         if(this.var_184)
         {
            this.var_184.stop();
         }
      ...
      private function onBotInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_2083);
         if(this.var_184)
         {
            this.var_184.stop();
         }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_672)
         {
            this.var_1059.update(param1);
            this.selectView(this.const_2084);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_420) != -1)
         {
         ...
         else
         {
            ...
            this.selectView(this.const_2085);
         }
         if(this.var_184)
         {
            this.var_184.stop();
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_2082);
         if(this.var_184)
         {
            this.var_184.start();
         }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_205.setTags(param1.tags,this.var_2763);
         }
      }
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_575,param1.id,param1.category);
      ...
      {
         this.var_1059.updateSongInfo(param1);
