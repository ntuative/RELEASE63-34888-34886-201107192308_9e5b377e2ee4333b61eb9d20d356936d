package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoView implements IDisposable
   {
      ...
      protected static const const_1416:uint = 4281149991;
      ...
      protected static const const_2052:uint = 13947341;
      
      protected static const const_2053:uint = 5789011;
      ...
      protected var var_2527:int;
      
      protected var var_1893:Boolean;
      
      protected var var_2270:FixedSizeStack;
      ...
      {
         this.var_2270 = new FixedSizeStack(const_1683);
         super();
         this._widget = param1;
         this.var_1155 = true;
         this.var_1717 = false;
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_1716 = param5;
         param1.var_2527 = param4;
         param1.var_2271 = param6;
         ...
         if(param1.var_1155)
         {
            if(!param1.var_515)
            {
               param1.var_515 = new Timer(param1.var_3060,1);
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_655));
      ...
      public function update(param1:Rectangle, param2:Point, param3:uint) : void
      {
         ...
         if(this.var_1715)
         {
            ...
            this._blend = 1 - this.var_1714 / Number(this.var_3061);
         }
         else
         {
            this._blend = 1;
         ...
         if(!this.var_1893 || this.var_2092)
         {
            _loc4_ = -this.var_192.height;
            if(this.var_1716 == RoomObjectTypeEnum.const_135 || this.var_1716 == RoomObjectTypeEnum.const_545)
            {
            ...
            this.var_2270.addValue(_loc5_);
            _loc6_ = this.var_2270.getMax();
            if(_loc6_ < this.var_2272 - const_1140)
            {
               _loc6_ = this.var_2272 - const_1140;
            }
