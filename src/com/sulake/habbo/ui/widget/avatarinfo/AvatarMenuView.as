package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1041:uint = 1;
      
      protected static const const_1040:uint = 2;
      
      protected static var var_1435:uint = const_1041;
      
      private static const const_1688:uint = 16744755;
      
      private static const const_1689:uint = 16756591;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1718)
         {
            ...
            {
               this.var_692 = const_1040;
            }
            else
            {
               this.var_692 = var_1435;
            }
         }
         if(this.var_692 == const_1041)
         {
      ...
      private function showButton(param1:String, param2:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            ...
            {
               _loc6_.x = _loc5_.x + (_loc5_.width - _loc5_.textWidth) / 2 - _loc6_.width - const_1100;
            }
            if(_loc6_.tags.indexOf("arrow_right") != -1)
            {
               _loc6_.x = _loc5_.x + (_loc5_.width + _loc5_.textWidth) / 2 + const_1100;
            }
         }
      }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = param2.tags.indexOf("moderate") > -1 ? uint(const_2054) : uint(const_1039);
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1689;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            ...
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1688;
               }
            }
         }
         if(_loc3_)
