package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2378:int = 1000;
      
      private var _widget:EffectsWidget;
      
      private var _window:IWindowContainer;
      
      private var var_117:IWidgetAvatarEffect;
      
      private var var_742:IWindow;
      
      private var var_341:Number;
      
      private var var_424:ITextWindow;
      
      private var var_223:Timer;
      
      private var var_741:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_117 = param2;
         this._widget = param1;
         this.var_223 = new Timer(this.const_2378);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_117.isActive)
         {
            _loc2_ = this.var_117.secondsLeft / Number(this.var_117.duration);
            this.var_742.width = _loc2_ * this.var_341;
         }
         else
         {
            this.var_742.width = 0;
            this.var_223.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_424 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_424 == null)
            {
               return;
            }
         ...
         if(!this.var_117.isActive)
         {
            this.var_424.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         if(this.var_117.secondsLeft > 86400)
         {
            this.var_424.caption = "${widgets.memenu.effects.active.daysleft}";
            _loc1_ = this.var_424.text;
            _loc2_ = Math.floor(this.var_117.secondsLeft / 86400);
            _loc1_ = _loc1_.replace("%days_left%",_loc2_);
         }
         else
         {
            this.var_424.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_424.text;
            _loc3_ = this.var_117.secondsLeft;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_70,HabboWindowStyle.const_31,HabboWindowParam.const_63) as IWindowContainer;
         }
         ...
         this.var_424 = null;
         var _loc2_:String = "";
         if(this.var_117.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_117.isActive)
         {
         ...
         else
         {
            ...
            this.var_741 = this._window.findChildByName("effect_hilite");
            this.var_741.visible = false;
         }
         this.setTimeLeft();
         this.var_742 = this._window.findChildByName("loader_bar");
         if(this.var_742 != null)
         {
            this.var_341 = this.var_742.width;
            this.var_223.start();
            this.onUpdate();
         }
         if(this.var_117.icon)
         {
            this.setElementBitmap("effect_icon",this.var_117.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_117.type,this.var_117.isInUse);
         }
      }
