package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function init(param1:MeMenuWidget, param2:String) : void
      {
         ...
         this.var_186["rooms_icon"] = ["gohome_white","gohome_color"];
         this.var_186["dance_icon"] = ["dance_white","dance_color"];
         this.var_186["clothes_icon"] = ["clothes_white","clothes_color"];
         this.var_186["effects_icon"] = ["effects_white","effects_color"];
         this.var_186["badges_icon"] = ["badges_white","badges_color"];
         this.var_186["wave_icon"] = ["wave_white","wave_color"];
         this.var_186["hc_icon"] = ["_white","_color"];
         this.var_186["settings_icon"] = ["settings_white","settings_color"];
         this.var_186["credits_icon"] = ["credits_white","credits_color"];
         this.var_186["news_icon"] = ["news_white","news_color"];
         this._widget = param1;
      ...
      {
         if(this.var_186[param1] == null)
         {
            return;
         }
         if(param3 != null)
         {
            this.var_186[param1][0] = param3;
         }
         if(param4 != null)
         {
            this.var_186[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         for(_loc4_ in this.var_186)
         {
            _loc7_ = this.var_186[_loc4_];
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               this._widget.changeView(MeMenuWidget.const_1336);
               break;
            case "wave":
               if(this._widget.hasEffectOn)
               {
               ...
               if(this._widget.isDancing)
               {
                  this._widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_1341));
            ...
            case "effects":
               ...
               this._widget.messageListener.processWidgetMessage(new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_422));
               this._widget.hide();
               break;
            case "rooms":
            ...
            case "clothes":
               ...
               break;
            case "hc":
               this._widget.messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1333));
               this._widget.hide();
               break;
            case "settings":
