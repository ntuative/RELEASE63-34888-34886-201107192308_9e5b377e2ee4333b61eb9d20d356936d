package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1042:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_1017 = param1.volume;
         if(this.var_1042 != null)
         {
            this.var_1042.setValue(this.var_1017);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1044 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1043 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1040 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1041 = (_loc5_.content as BitmapData).clone();
         }
         this.var_1042 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.updateSoundIcons();
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1017 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1041);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1044);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1040);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1043);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_983);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_909);
         }
