package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_181:String = "me_menu_top_view";
      
      public static const const_596:String = "me_menu_my_clothes_view";
      
      public static const const_1336:String = "me_menu_dance_moves_view";
      
      public static const const_902:String = "me_menu_settings_view";
      
      public static const const_956:String = "me_menu_sound_settings";
      
      private static const const_1123:Point = new Point(95,440);
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2707 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_1875 = this._config.getBoolean("menu.own_avatar.enabled",false);
         (param1 as MeMenuWidgetHandler).widget = this;
         this.changeView(const_181);
         this.hide();
      }
      ...
      {
         return var_939 as MeMenuWidgetHandler;
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_826,this.onWaveEvent);
         ...
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_773,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1263,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1209,this.onHideAvatarEditor);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_172,this.onAvatarDeselected);
         param1.addEventListener(RoomWidgetHabboClubUpdateEvent.const_314,this.onHabboClubEvent);
         ...
         param1.addEventListener(RoomWidgetTutorialEvent.const_498,this.onTutorialEvent);
         ...
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_437,this.onGameMode);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_826,this.onWaveEvent);
         ...
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_773,this.onToolbarClicked);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_172,this.onAvatarDeselected);
         param1.removeEventListener(RoomWidgetHabboClubUpdateEvent.const_314,this.onHabboClubEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1263,this.onHideAvatarEditor);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1209,this.onAvatarEditorClosed);
         ...
         param1.removeEventListener(RoomWidgetTutorialEvent.const_498,this.onTutorialEvent);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_563 && this.var_54.window.name == const_596))
         {
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_54.window.name == const_956)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_498:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_563 + " view: " + this.var_54.window.name);
               if(this.var_563 != true || this.var_54.window.name != const_181)
               {
                  return;
               }
               (this.var_54 as MeMenuMainView).setIconAssets("clothes_icon",const_181,"clothes_highlighter_blue");
               break;
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_563)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_783);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      {
         if(this.var_54 != null && this.var_54.window.name != const_596)
         {
            this.hide();
         }
      }
      ...
      {
         var _loc2_:* = param1.daysLeft != this.var_1575;
         this.var_1575 = param1.daysLeft;
         this.var_2709 = param1.periodsLeft;
         this.var_3087 = param1.pastPeriods;
         this.var_2706 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_1969);
         this.var_1969 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_54 != null)
            {
      ...
      private function onCreditBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         this.var_2708 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",this.var_2708.toString());
      }
