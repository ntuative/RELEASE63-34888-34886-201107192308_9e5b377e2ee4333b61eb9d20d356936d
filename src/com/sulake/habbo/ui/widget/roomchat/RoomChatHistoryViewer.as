package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public static const const_1330:int = 3;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_197.state = RoomChatHistoryPulldown.const_305;
         ...
         this.var_53 = param2.createWindow("chatscroller","",HabboWindowType.const_1202,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_197.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_305);
      }
      ...
      {
         return !!this.var_459 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_197.state == RoomChatHistoryPulldown.const_432 || this.var_197.state == RoomChatHistoryPulldown.const_645;
      }
      ...
      {
         if(!this.var_459 && !this.var_1845)
         {
            this.var_459 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_197.state = RoomChatHistoryPulldown.const_432;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_53 != null)
         {
            ...
            if(param2)
            {
               this.var_53.scrollV = this.var_665;
            }
         }
         if(this.var_197 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_460 > 0 && param2)
         {
            if(this.var_1924)
            {
               if(Math.abs(param1 - this.var_460) <= const_1330)
               {
                  return;
               }
               this.var_1924 = false;
            ...
            if(this.var_459)
            {
               ...
               _loc3_ = this.var_665 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_460;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_53.scrollV < 1 - const_1603 / this.var_53.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1925)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_53 != null)
         {
            this.var_665 = this.var_53.scrollV;
         }
         if(this.var_53 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_665 - this.var_53.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
