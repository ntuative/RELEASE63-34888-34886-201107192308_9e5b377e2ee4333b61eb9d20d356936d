package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1678:int = 250;
      
      private static const const_1679:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1680:String = "${widgets.chatinput.say}";
      ...
      private var var_2088:IWindow;
      
      private var _button:IWindow;
      
      private var var_2089:IWindow;
      
      private var var_1628:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1359 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_2890 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2889 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_410 = new Timer(1000,1);
         this.var_410.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_495 = new Timer(10000,1);
         this.var_495.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_495.reset();
            this.var_495.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_495 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2088 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2089 = this._window.findChildByName("send_button_text");
         this.var_1628 = this._window.findChildByName("block_text");
         this.var_2089.caption = const_1680;
         ...
         this.var_27.addEventListener(WindowKeyboardEvent.const_183,this.windowKeyEventProcessor);
         this.var_27.addEventListener(WindowKeyboardEvent.const_379,this.keyUpHandler);
         this.var_27.addEventListener(WindowEvent.const_114,this.onInputChanged);
         ...
         this._window.addEventListener(WindowEvent.const_554,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2088.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1678 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1679);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_27 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1359 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_27.text = "";
                  this.var_718 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_718.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_717);
