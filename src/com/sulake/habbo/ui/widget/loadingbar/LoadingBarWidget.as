package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_532:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_532.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_532 = null;
         }
         if(this.var_48 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_326,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_326,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_532 == null)
         {
            this.var_532 = new Sprite();
            this.var_532.addChild(new Bitmap(this.var_48));
            this.var_532.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_532.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_48;
            }
         }
         _loc2_.setDisplayObject(this.var_532);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_326)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1334 != "")
         {
            HabboWebTools.openWebPage(this.var_1334);
         }
      }
   }
}
