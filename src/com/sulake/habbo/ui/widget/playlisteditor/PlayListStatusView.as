package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_896:String = "PLSV_ADD_SONGS";
      
      public static const const_1168:String = "PLSV_START_PLAYBACK";
      
      public static const const_628:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_54 != const_628)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_480[this.var_54];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_480[const_896];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_480.add(const_628,_loc1_);
