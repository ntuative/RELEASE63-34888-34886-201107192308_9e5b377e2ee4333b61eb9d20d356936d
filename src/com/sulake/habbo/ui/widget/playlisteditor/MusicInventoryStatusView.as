package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_799:String = "MISV_BUY_MORE";
      
      public static const const_978:String = "MISV_PREVIEW_PLAYING";
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_480[param1] as IWindowContainer,0);
         this.var_54 = param1;
      }
      ...
      {
         this.blitBackgroundImage(const_978,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_799,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_480.add(const_978,_loc1_);
            this.var_2138 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2137 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
         ...
         if(_loc1_ != null)
         {
            this.var_480.add(const_799,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_548));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_480[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
