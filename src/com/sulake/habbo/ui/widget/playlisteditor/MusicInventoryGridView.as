package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         this._items = new Map();
         var _loc4_:int = this.var_256.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_256.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_256.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_256.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_111.playButtonState = MusicInventoryGridItem.const_1167;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_111 != null)
         {
            this.var_111.playButtonState = MusicInventoryGridItem.const_560;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_111.playButtonState == MusicInventoryGridItem.const_560)
               {
                  this.var_111.playButtonState = MusicInventoryGridItem.const_1342;
