package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_2071:uint = 0;
      
      private const const_2349:uint = 4.282169599E9;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_2071) : uint(this.const_2070);
      ...
      private function highlightItem(param1:int) : void
      {
         ...
         if(this.var_1033 != -1)
         {
            ...
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_1033 % 2) ? uint(this.const_2071) : uint(this.const_2070);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_2349;
