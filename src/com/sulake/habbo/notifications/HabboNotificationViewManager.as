package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      public function HabboNotificationViewManager(param1:IAssetLibrary, param2:IHabboWindowManager, param3:IHabboConfigurationManager, param4:IHabboToolbar, param5:Map, param6:Map)
      {
         ...
         this._toolbar.events.addEventListener(ExtensionViewEvent.const_1193,this.refreshTopMargin);
      }
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_1271,this.var_1083,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_658 < this._windowManager.getDesktop(0).height;
      }
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc3_ < this.var_195.length)
         {
            ...
            if(_loc2_ + HabboNotificationItemView.const_658 < _loc4_.verticalPosition)
            {
               return _loc2_;
            }
            _loc2_ = _loc4_.verticalPosition + HabboNotificationItemView.const_658 + const_476;
            _loc3_++;
         }
         return _loc2_;
      }
