package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1553:String = "selectbadge";
      
      private static const const_1552:String = "inventory";
      
      private static const const_1551:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1554:String = "friendlist";
      
      private static const const_1550:String = "pet_inventory";
      
      private static const const_1555:String = "go_to_room";
      ...
      private var var_1846:IHabboToolbar;
      ...
      private var var_541:HabboNotificationViewManager;
      
      private var var_248:HabboAlertDialogManager;
      
      private var var_807:ParkBusDialogManager;
      
      private var var_2526:Boolean;
      
      private var var_1010:ClubGiftNotification;
      
      private var var_1008:ClubEndingNotification;
      
      private var var_1009:ClubPromoNotification;
      
      private var var_3077:Dictionary;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         this.var_1247.push(_loc8_);
         return this.var_1247.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1247.splice(0,1);
      ...
      {
         this.var_1846 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_541 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1846,this.var_1007["styles"],this.var_1007["view"]);
         ...
         registerUpdateReceiver(this.var_541,1);
         registerUpdateReceiver(this,2);
         this.var_426.events.addEventListener(BadgeImageReadyEvent.const_212,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_426.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1257,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1257,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1847,null);
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_426.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_64)
               {
                  _loc7_ = this.var_426.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_426.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1919,_loc5_);
               }
            }
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_64:
               ...
               break;
            case CatalogPageMessageProductData.const_180:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1282)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1841,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1009 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1008 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_541.isSpaceAvailable() && this.var_1247.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_541.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      {
         if(param1 != null && this.var_541 != null)
         {
            this.var_541.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_383;
            }
            if(param2 == 3002)
            {
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_807 == null)
         {
            this.var_807 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_807 != null)
         {
            this.var_807.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1338,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1338,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1095.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_62);
            if(_loc6_ != null)
            {
      ...
      {
         if(param2.type == WindowEvent.const_175 || param2.type == WindowEvent.const_529)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1010 && this.var_1010.visible)
         {
            return;
         }
         this.var_1010 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1846);
      }
