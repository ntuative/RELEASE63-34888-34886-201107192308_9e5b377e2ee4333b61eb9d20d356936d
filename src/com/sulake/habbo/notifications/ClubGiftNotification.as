package com.sulake.habbo.notifications
{
   ...
   public class ClubGiftNotification
   {
      ...
      private static const const_693:String = "club_gift_notification";
      ...
      public function ClubGiftNotification(param1:int, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboCatalog, param5:IHabboToolbar)
      {
         ...
         this._toolbar.extensionView.attachExtension(const_693,this._window);
         this.var_1808 = this._window.findChildByName("cancel_link") as ITextWindow;
      ...
      public function dispose() : void
      {
         if(this._toolbar)
         {
            this._toolbar.extensionView.detachExtension(const_693);
         }
         if(this._window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "open_catalog_button":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1863,true);
               }
               this.dispose();
               break;
      ...
      {
         this.var_1808.textColor = const_1496;
      }
      
      private function onMouseOut(param1:WindowMouseEvent) : void
      {
         this.var_1808.textColor = const_1495;
      }
