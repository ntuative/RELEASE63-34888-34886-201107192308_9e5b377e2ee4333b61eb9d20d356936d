package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private var var_255:HabboNotificationItem;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_2068 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_2068 = 15;
         }
         this.var_2070 = this._window.height;
         this.var_1625 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      {
         if(param1.badgeId != this.var_255.style.iconSrc)
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_645:
               ...
               _loc2_ = Number(this.var_1352) / Number(this.var_1083["time_fade_in"]);
               if(this.var_1352 > int(this.var_1083["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1138:
               ...
               if(this.var_1624 > int(this.var_1083["time_display"]) && !this.var_2069)
               {
                  this.startFadeOut();
               }
               break;
            case const_1137:
               ...
               _loc3_ = 1 - Number(this.var_1351) / Number(this.var_1083["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1351 > int(this.var_1083["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2068;
         if(this._window.height < this.var_2070)
         {
            this._window.height = this.var_2070;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1762;
         this._window.y = this.var_1625;
      }
