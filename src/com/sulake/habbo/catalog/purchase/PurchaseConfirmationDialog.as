package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2070:uint = 4.293848814E9;
      
      private const const_2071:uint = 4.294967295E9;
      
      private const const_1480:uint = 4.291613146E9;
      ...
      public function showOffer(param1:IHabboCatalog, param2:IRoomEngine, param3:IPurchasableOffer, param4:int, param5:String = "", param6:Array = null) : void
      {
         ...
         this.var_1255 = param3.offerId;
         this.var_1527 = param4;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1255 != param1.offerId)
         {
            return;
         }
      ...
      private function showConfirmationDialog(param1:IPurchasableOffer) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            if(param1 is Offer)
            {
               _loc15_ = param1.productContainer.method_1;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowKeyboardEvent.const_379,this.onNameInputKeyUp);
         }
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_590,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1856 = _loc1_.stuffTypes;
            this.var_818 = _loc1_.boxTypes;
            this.var_819 = _loc1_.ribbonTypes;
            this.var_1256 = this.var_1856[0];
            this.var_389 = this.var_818[0];
            this.var_390 = this.var_819[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_390 < 0)
         {
            this.var_390 = this.var_819.length - 1;
         }
         if(this.var_390 > this.var_819.length - 1)
         {
            this.var_390 = 0;
         }
         if(this.var_389 < 0)
         {
            this.var_389 = this.var_818.length - 1;
         }
         if(this.var_389 > this.var_818.length - 1)
         {
            this.var_389 = 0;
         }
         var _loc1_:int = this.var_818[this.var_389] * 1000 + this.var_819[this.var_390];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1256,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1525 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1856)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1256);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_818[this.var_389]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_819[this.var_390]);
         this._catalog.purchaseProductAsGift(this.var_1527,this.var_1255,this.var_1526,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1527,this.var_1255,this.var_1526);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_247)
         {
            ...
            if(_loc4_.length >= this.const_2346)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2552 = _loc2_.text;
      }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_820 == null)
         {
            this.var_820 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_284 == null || this.var_820 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_820.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1480;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2070) : uint(this.const_2071);
      }
      ...
      {
         this.var_1256 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1256;
               }
            }
            _loc4_++;
         }
