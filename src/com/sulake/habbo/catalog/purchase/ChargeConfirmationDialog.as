package com.sulake.habbo.catalog.purchase
{
   ...
   public class ChargeConfirmationDialog implements IDisposable
   {
      ...
      private var var_865:ChargeInfo;
      ...
      public function refresh() : void
      {
         ...
         {
            this.showChargeInfo(this.var_865);
         }
      }
      ...
      public function showChargeInfo(param1:ChargeInfo) : void
      {
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.currentamount","charges","" + this.var_865.charges);
         var _loc2_:ChargeOffer = new ChargeOffer(this.var_865);
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.info","patch_size","" + this.var_865.chargePatchSize);
      ...
      {
         this._catalog.connection.send(new UseFurnitureMessageComposer(this.var_865.stuffId,2));
      }
