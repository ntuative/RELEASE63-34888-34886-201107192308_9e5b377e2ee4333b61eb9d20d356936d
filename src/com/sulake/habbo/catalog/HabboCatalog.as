package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_730:uint = 1;
      ...
      private var var_237:CatalogViewer;
      
      private var var_267:ICatalogNavigator;
      ...
      private var var_236:ChargeConfirmationDialog;
      ...
      private var var_3027:Boolean = true;
      
      private var var_3028:Boolean = true;
      
      private var var_2201:Boolean = false;
      
      private var var_3026:GiftWrappingConfiguration;
      
      private var var_1404:ClubGiftController;
      
      private var var_602:ClubBuyController;
      
      private var var_744:ClubExtendController;
      
      private var var_921:Map;
      
      private var var_1403:Boolean = false;
      
      private var var_920:IPurchasableOffer;
      
      private var var_1696:IDragAndDropDoneReceiver;
      ...
      private var var_745:RoomPreviewer;
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1820);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_426.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_602.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_3025 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_426.loadProductData(this);
      }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_173,this.onObjectPlaced);
         this.initializeRoomPreviewer();
      }
      ...
      {
         if(this._roomEngine != null && this.var_145 != null && this.var_145.getKey("catalog.furniture.animation","false") == "true")
         {
            if(this.var_745 == null)
            {
               this.var_745 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_145.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_778 || !this.var_267 || !this.var_267.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1139 = -1;
            this.var_919 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_267.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_145.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_145.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_426.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_426.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_64)
         {
            _loc3_ = this.var_426.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_921.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_237.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_267 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_237 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_237.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:String = "catalog";
         if(this.var_145.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_730) as IWindowContainer;
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_79:
               this.var_2201 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1404 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_602 == null)
         {
            this.var_602 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_744 == null)
         {
            this.var_744 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_237 != null)
         {
            this.var_237.catalogWindowClosed();
         }
         if(this.var_107 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_107.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1697 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_267.buildCatalogIndex(_loc2_);
         if(this.var_919 && this.var_919 != "")
         {
            this.var_267.openPage(this.var_919);
            this.var_919 = "";
            this.var_1139 = -1;
         }
         else if(this.var_1139 > -1)
         {
            this.var_267.openPageById(this.var_1139,this.var_2200);
            this.var_1139 = -1;
            this.var_2200 = -1;
            this.var_919 = "";
         }
         else if(this.var_1697 && this.var_3025)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_267.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1784));
         }
         else
         {
            this.var_267.loadFrontPage();
         }
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_237.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_237 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_237.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_3027 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1380);
         }
         this.var_3027 = false;
         if(this.var_236 != null && !this.var_236.disposed)
         {
            this.var_236.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_123,this.var_118.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_3028 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1280);
         }
         this.var_3028 = false;
         if(this.var_236 != null && !this.var_236.disposed)
         {
         ...
         if(_loc2_.type == ActivityPointTypeEnum.const_843)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_325,_loc2_.amount));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.points["null"] != null)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_325,_loc2_.points["null"]));
         }
         events.dispatchEvent(new PurseUpdateEvent());
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_118.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1335 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1404.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_3026 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_602 != null)
         {
            this.var_602.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_744 != null && this.var_145.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_744.onOffer(param1);
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_236 == null || this.var_236.disposed)
         {
            this.var_236 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_236.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_921.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_921.add(_loc2_.productCode,_loc3_.slice());
            this.var_237.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_145.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_145.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_175)
         {
            _loc3_ = this.var_145.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_145.keyExists("catalog.drag_and_drop") || this.var_145.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         ...
         var _loc2_:IProduct = param1.productContainer.method_1;
         var _loc3_:Boolean = true;
         switch(_loc2_.productType)
         {
            case ProductTypeEnum.const_180:
               _loc3_ = false;
               break;
      ...
      public function requestSelectedItemToMover(param1:IDragAndDropDoneReceiver, param2:Offer) : void
      {
         ...
         var _loc3_:IProduct = param2.productContainer.method_1;
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1403 && param1.type == RoomEngineObjectEvent.const_173)
         {
            this.resetPlacedOfferData(true);
            if(this.var_920 == null || this.var_920.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_920.productContainer.method_1;
            _loc4_ = false;
            ...
            this.var_67 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_920);
            _loc5_ = this.var_1696;
            if(_loc5_ != null)
            {
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_145.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_730);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_745 != null)
         {
            this.var_745.updatePreviewRoomView();
         }
      }
   }
}
