package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2041:String = "ctlg_";
       
      
      protected var var_2258:XML;
      ...
      private var var_540:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1235:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_540 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1236);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1236);
      }
      ...
      {
         var _loc2_:String = const_2041 + param1;
         ...
         this.var_2258 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2258) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1897:
               if(this.var_1235 == null)
               {
                  this.var_1235 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1235);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1949:
               ...
               break;
            case CatalogWidgetEnum.const_1937:
            ...
            case CatalogWidgetEnum.const_1902:
               ...
               break;
            case CatalogWidgetEnum.const_1768:
            ...
            case CatalogWidgetEnum.const_1864:
               ...
               break;
            case CatalogWidgetEnum.const_1813:
            ...
            case CatalogWidgetEnum.const_2001:
               ...
               break;
            case CatalogWidgetEnum.const_1776:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_540.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_540 != null)
         {
            return this.var_540.dispatchEvent(param1);
         }
         return false;
      }
