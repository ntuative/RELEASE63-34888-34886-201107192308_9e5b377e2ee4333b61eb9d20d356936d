         ...
         switch(this.var_1691)
         {
            ...
            case ProductTypeEnum.const_64:
               if(param3)
               {
                  ...
                  {
                     case "floor":
                        _loc10_ = ["th",this._furnitureData.name,param3.productContainer.method_1.extraParam].join("_");
                        break;
                     case "wallpaper":
                        _loc10_ = ["th","wall",param3.productContainer.method_1.extraParam].join("_");
                        break;
                     case "landscape":
                        _loc10_ = ["th",this._furnitureData.name,param3.productContainer.method_1.extraParam.replace(".","_"),"001"].join("_");
                        break;
                     default:
