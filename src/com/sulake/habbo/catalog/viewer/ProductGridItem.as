package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1096:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_225:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1096).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1096).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_92,MouseCursorType.const_818);
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            this.var_225.select(this);
            this.var_567 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_567 != null && this.var_567 == param2)
         {
            _loc3_ = this.var_225.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_567 = null;
            }
