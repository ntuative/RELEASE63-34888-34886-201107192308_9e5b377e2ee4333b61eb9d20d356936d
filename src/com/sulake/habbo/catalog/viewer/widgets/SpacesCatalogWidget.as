package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1589:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1320 = this.parseElements(_loc2_.walls.pattern);
         this.var_1319 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            _loc5_ = _loc3_.productContainer.method_1;
               ...
               case "floor":
                  for(_loc10_ in this.var_1057)
                  {
                     ...
                     if(this.var_686.indexOf(_loc10_) == -1)
                     {
                        ...
                        this.var_1317.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1320[_loc8_] != null)
                  {
                     this.var_862.push(_loc8_);
                  ...
                  break;
               case "landscape":
                  if(this.var_1319[_loc8_] != null)
                  {
                     this.var_863.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1588,this.var_1589,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1318[this.var_472];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1317[this.var_474];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_476];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1589);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_686[this.var_474];
         var _loc3_:Array = this.var_1057[_loc2_];
         if(_loc3_ != null && this.var_471 >= 0)
         {
            _loc11_ = _loc3_[this.var_471];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1317[this.var_474];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_862[this.var_472];
         var _loc6_:Array = this.var_1320[_loc5_];
         if(_loc6_ != null && this.var_475 >= 0)
         {
            _loc13_ = _loc6_[this.var_475];
            if(_loc13_ != null)
            {
               this.var_1588 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1318[this.var_472];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_863[this.var_476];
         var _loc9_:Array = this.var_1319[_loc8_];
         if(_loc9_ != null && this.var_473 >= 0)
         {
            _loc15_ = _loc9_[this.var_473];
            if(_loc15_ != null)
            {
               this.var_1589 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_476];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_111:
               ...
               if(this.var_474 < 0)
               {
                  this.var_474 = this.var_686.length - 1;
               }
               if(this.var_474 >= this.var_686.length)
               {
                  this.var_474 = 0;
               }
               this.var_471 = 0;
               this.var_1058 = 0;
               _loc5_ = this.var_686[this.var_474];
               _loc6_ = this.var_1057[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_1058 = _loc6_.length;
               }
            ...
            case const_243:
               ...
               if(this.var_472 < 0)
               {
                  this.var_472 = this.var_862.length - 1;
               }
               if(this.var_472 == this.var_862.length)
               {
                  this.var_472 = 0;
               }
               this.var_475 = 0;
               this.var_1056 = 0;
               _loc7_ = this.var_862[this.var_472];
               _loc8_ = this.var_1320[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_1056 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_476 < 0)
               {
                  this.var_476 = this.var_863.length - 1;
               }
               if(this.var_476 >= this.var_863.length)
               {
                  this.var_476 = 0;
               }
               this.var_473 = 0;
               this.var_1055 = 0;
               _loc9_ = this.var_863[this.var_476];
               _loc10_ = this.var_1319[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_1055 = _loc10_.length;
               }
