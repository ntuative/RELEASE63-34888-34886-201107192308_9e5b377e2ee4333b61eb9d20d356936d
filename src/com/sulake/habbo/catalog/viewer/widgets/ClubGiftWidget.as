package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_26.purse.pastVipDays >= this.const_242 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_26.purse.pastVipDays % this.const_242;
            _loc4_ = this.var_26.purse.pastVipDays / this.const_242;
            this.var_26.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_26.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function createListItem(param1:Offer, param2:ClubGiftData) : IWindow
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         if(!param1 || !param1.productContainer || !param1.productContainer.method_1 || !param2)
         {
            return null;
         }
         ...
         var _loc4_:IProduct = param1.productContainer.method_1;
         if(!_loc4_)
         {
            return null;
         }
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         var _loc3_:IProduct = param1.productContainer.method_1;
         if(!_loc3_)
         {
            return;
         }
