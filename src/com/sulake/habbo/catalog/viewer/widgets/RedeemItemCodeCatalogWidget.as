package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1022.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1022 = null;
         }
         if(this.var_1023 != null)
         {
            this.var_1023.removeEventListener(WindowKeyboardEvent.const_183,this.windowKeyEventProcessor);
            this.var_1023 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1022 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1022 != null)
         {
            this.var_1022.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1023 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1023 != null)
         {
            this.var_1023.addEventListener(WindowKeyboardEvent.const_183,this.windowKeyEventProcessor);
         }
         return true;
      }
