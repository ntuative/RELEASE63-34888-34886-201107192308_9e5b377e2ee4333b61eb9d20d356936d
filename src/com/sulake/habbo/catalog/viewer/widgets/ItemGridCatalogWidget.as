   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         if(this._scrollBar != null)
         {
            ...
            this._scrollBar.addEventListener(WindowEvent.const_794,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_272,this.activateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_972,this.deActivateScrollbar);
            this._scrollBar.addEventListener(WindowEvent.const_308,this.deActivateScrollbar);
         }
         this.var_33 = param2;
      }
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc2_.productContainer.method_1.productType == ProductTypeEnum.const_64)
            {
      ...
      protected function loadItemGridGraphics(param1:TimerEvent = null) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < 3)
            {
               if(this.var_797 >= 0 && this.var_797 < _loc2_)
               {
                  _loc4_ = page.offers[this.var_797];
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(this.var_2073) as IWindowContainer;
         ...
         if(param1.pricingModel == Offer.const_503)
         {
            ++this.var_1821;
            (param1.productContainer as BundleProductContainer).setBundleCounter(this.var_1821);
         }
      }
