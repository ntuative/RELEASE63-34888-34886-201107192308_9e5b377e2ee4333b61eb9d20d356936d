package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_582:IDisplayObjectWrapper;
      
      private var var_2115:Point;
      
      private var var_581:IItemGridWindow;
      
      private var var_1641:IScrollbarWindow;
      
      protected var var_2073:XML;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1364 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_101 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_208 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_208 != null)
         {
            this.var_208.visible = false;
            this.var_582 = this.var_208.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_582 != null && _loc3_ != null)
            {
               this.var_208.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_582.width,this.var_582.height);
               if(_loc4_ != null)
               {
                  this.var_582.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_2115 = new Point(this.var_101.x,this.var_101.y);
         this.var_581 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1641 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_581 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_2073 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_581 != null)
         {
            this.var_581.visible = false;
            this.var_581.destroyGridItems();
         }
         ...
         this.var_1364.text = _loc5_;
         this.var_1098.height = this.var_1098.textHeight + 5;
         this.var_1364.y = this.var_1098.y + this.var_1098.height;
         this.var_1364.height = Math.max(130,this.var_1364.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_503:
                  ...
                  if(this.var_581 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_581,this.var_1641,this.var_2073);
                     this.var_581.scrollV = 0;
                  }
                  if(this.var_208 != null)
                  {
                     this.var_208.visible = false;
               ...
               case Offer.const_434:
                  _loc9_ = _loc2_.productContainer.method_1;
                  if(this.var_208 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_78 || _loc9_.productType == ProductTypeEnum.const_64 || _loc9_.productType == ProductTypeEnum.const_180)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_78:
                        if(_loc8_ != null && this.var_582 != null)
                        {
                     ...
                     case ProductTypeEnum.const_180:
                        ...
                        else
                        {
                           ...
                           _loc6_ = new BitmapData(this.var_101.width,this.var_101.height,false,_loc15_);
                           _loc16_ = null;
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_366,AvatarAction.const_646);
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(this.var_101);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_101 != null && true)
         {
            ...
            if(this.var_101.bitmap == null)
            {
               this.var_101.bitmap = new BitmapData(this.var_101.width,this.var_101.height,true,16777215);
            }
            this.var_101.bitmap.fillRect(this.var_101.bitmap.rect,16777215);
            _loc4_ = new Point((this.var_101.width - param1.width) / 2,(this.var_101.height - param1.height) / 2);
            this.var_101.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_101.invalidate();
            this.var_101.x = this.var_2115.x;
            this.var_101.y = this.var_2115.y;
            if(param3 != null)
            {
               this.var_101.x += param3.x;
               this.var_101.y += param3.y;
            }
         }
         if(param2)
         {
