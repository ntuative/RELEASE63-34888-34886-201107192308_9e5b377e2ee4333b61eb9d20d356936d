package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      private var var_487:IButtonWindow;
      ...
      {
         super(param1);
         this.var_487 = _window.findChildByName("listen") as IButtonWindow;
         this.var_1169 = _window.findChildByName("ctlg_song_length") as ITextWindow;
         if(this.var_487 != null)
         {
            this.var_487.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
            this.var_487.disable();
         }
         this.var_1170 = _window.findChildByName("playPreviewContainer") as IWindowContainer;
         if(this.var_1170 != null)
         {
            this.var_1170.visible = false;
         }
      ...
      override public function dispose() : void
      {
         if(this.var_487 != null)
         {
            this.var_487.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickPlay);
         }
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.playSong(this.var_954,HabboMusicPrioritiesEnum.const_211,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         var _loc2_:IProduct = param1.offer.productContainer.method_1;
         if(_loc2_.extraParam.length > 0)
         {
            this.var_954 = parseInt(_loc2_.extraParam);
            if(this.var_1170 != null)
            {
               this.var_1170.visible = true;
            }
         }
         else
         {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1169.text = _loc8_;
            }
         }
         else if(this.var_1169 != null)
         {
            this.var_1169.text = "";
         }
         if(this.var_487 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_954);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_954);
         }
         return -1;
      }
