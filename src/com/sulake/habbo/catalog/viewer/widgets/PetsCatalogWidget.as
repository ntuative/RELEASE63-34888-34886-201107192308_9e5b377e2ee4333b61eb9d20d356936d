package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2343 = _loc3_.localizationId;
         this.var_418 = [];
         if(page && false && page.viewer.catalog)
         {
         ...
         events.addEventListener(WidgetEvent.const_938,this.onApproveNameResult);
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent = null) : void
      {
         ...
         var _loc3_:* = [];
         for each(_loc4_ in this.var_418)
         {
      ...
      public function onDropMenuEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_48)
         {
            ...
            if(this.var_235 == null || _loc3_ >= this.var_235.length)
            {
               return;
            }
            this.var_898 = _loc3_;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         this.var_594 = param1.index;
         if(this.var_594 < 0 || this.var_594 > this.var_418.length)
         {
            this.var_594 = 0;
         }
         this.updateImage();
      ...
      {
         if(param1.productCode == this.var_2343)
         {
            this.var_235 = this.parseSellableBreeds(param1.sellableBreeds);
            this.var_898 = 0;
      ...
      private function updateBreedSelections() : void
      {
         ...
         {
            _loc5_ = this.var_235[_loc3_] as int;
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_235 == null || this.var_898 >= this.var_235.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_594 >= 0 && this.var_594 < this.var_418.length)
         {
            _loc7_ = this.var_418[this.var_594] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_235[this.var_898] as int;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_529,_loc3_,_loc2_,AvatarScaleType.const_62,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_366,AvatarAction.const_840);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_594 >= this.var_418.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_418[this.var_594] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_235[this.var_898] as int;
      ...
      private function updateAvailableBreeds(param1:String) : void
      {
         ...
         if(this.var_235 == null)
         {
            ...
            this.var_235 = this.parseSellableBreeds(_loc2_);
            this.var_898 = 0;
            if(this.var_235 != null)
            {
               this.updateBreedSelections();
