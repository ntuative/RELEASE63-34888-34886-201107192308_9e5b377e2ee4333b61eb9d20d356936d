package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1460:int = 18;
      ...
      private var var_235:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2343 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_235 != null && this.var_235.length > 0)
         {
            this.var_374 = this.var_235[0];
         }
         else
         {
            this.var_374 = -1;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_235 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1460 && _loc2_ < this.var_235.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_529,this.var_235[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_235 != null && this.var_235.length > 0)
         {
            ...
            this.var_374 = this.var_235[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_529,this.var_374),this.getRaceLocalizationKey(this.var_529,this.var_374));
            }
         }
         return this.getRaceLocalizationKey(this.var_529,this.var_374);
      }
