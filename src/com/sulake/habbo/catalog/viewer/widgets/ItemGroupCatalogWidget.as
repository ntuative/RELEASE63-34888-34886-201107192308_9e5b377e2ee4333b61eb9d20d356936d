package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_233[this.var_580][this.var_708];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_580 = var_511.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_580];
         var _loc3_:Array = this.var_233[this.var_580] as Array;
         var _loc4_:Array = new Array();
         for each(_loc5_ in _loc3_)
         {
            _loc6_ = _loc5_.productContainer.method_1.furnitureData;
            _loc7_ = _loc6_.colours[_loc6_.colours.length - 1];
            _loc4_.push(_loc7_);
         }
         Logger.log("Show the colors for current selection..." + _loc2_ + " " + _loc4_.length);
         events.dispatchEvent(new CatalogWidgetColoursEvent(_loc4_,"ctlg_clr_40x32_1","ctlg_clr_40x32_2","ctlg_clr_40x32_3",this.var_708));
      }
      
      override public function startDragAndDrop(param1:IGridItem) : Boolean
      {
         var _loc2_:Array = this.var_233[this.var_580] as Array;
         var _loc3_:Offer = _loc2_[this.var_708] as Offer;
         if(_loc3_ != null)
         {
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_708 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_708] as Offer;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_233[this.var_580] as Array;
         var _loc2_:Offer = _loc1_[this.var_708] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         for each(_loc1_ in page.offers)
         {
            ...
            {
               _loc3_ = _loc1_.productContainer.method_1;
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_64 || _loc3_.productType == ProductTypeEnum.const_78)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_233[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      private function debug(param1:Array) : void
      {
         ...
         {
            _loc4_ = _loc3_.productContainer.method_1.furnitureData;
      ...
      {
         var _loc3_:IFurnitureData = param1.productContainer.method_1.furnitureData;
         var _loc4_:IFurnitureData = param2.productContainer.method_1.furnitureData;
