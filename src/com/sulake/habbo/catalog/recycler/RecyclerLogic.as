package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_1133:int = 0;
      ...
      {
         return this.var_691 != const_1133;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_2003 != RecyclerStatusMessageEvent.const_1353;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_691 == const_483;
      }
      ...
      {
         this.var_691 = const_1132;
         this.var_134 = new Array(const_216);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_216)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_691 = const_1133;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_2003)
         {
            case RecyclerStatusMessageEvent.const_2003:
               this.var_691 = const_483;
            ...
            case RecyclerStatusMessageEvent.const_1353:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1848:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1282:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1861:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_134.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_216)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_134.length < const_216)
         {
            return false;
         }
         var _loc1_:int = 0;
