package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1700:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1652:XML;
      
      private static var var_1653:XML;
       
      
      private var var_2139:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3097:IWindowContainer;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1653 == null)
         {
            ...
            var_1653 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_2139 == 4294967295)
            {
               this.var_2139 = _loc1_.color;
            }
            _loc1_.color = const_1700;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1803;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1832;
            }
         }
      }
      ...
      {
         this.var_65 = navigator.catalog.windowManager.buildFromXML(var_1653) as IItemListWindow;
         if(this.var_65 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1652) as IWindowContainer;
         }
         else
         {
