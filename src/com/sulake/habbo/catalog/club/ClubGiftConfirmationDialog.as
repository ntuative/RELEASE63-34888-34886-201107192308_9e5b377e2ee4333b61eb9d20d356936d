package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_106.productContainer.initProductIcon(this.var_26.roomEngine);
      }
      
      private function getProductName() : String
      {
         var _loc1_:* = null;
         if(this.var_106 && this.var_106.productContainer && this.var_106.productContainer.method_1)
         {
            _loc1_ = this.var_106.productContainer.method_1.productData;
            if(_loc1_)
            {
               return _loc1_.name;
            }
      ...
      {
         if(!param1 || !param2 || !this.var_26 || !this.var_106)
         {
            return;
         }
         ...
         {
            case "select_button":
               this.var_26.confirmSelection(this.var_106.localizationId);
               break;
