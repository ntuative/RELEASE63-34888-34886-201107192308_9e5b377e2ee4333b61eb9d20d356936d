package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1576:String = "your_price_icon";
      
      private static const const_1575:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1574:String = "image/png";
      
      private static const const_1577:int = 2000;
      
      private static const const_1578:int = 75;
      
      protected static const const_2042:uint = 0;
      ...
      private var var_659:IRegionWindow;
      
      private var var_658:ITextWindow;
      
      private var var_393:IBitmapWrapperWindow;
      
      private var var_656:Vector.<BitmapData>;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_26 = param1;
         this.var_106 = param2;
         this.var_656 = new Vector.<BitmapData>(const_386);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_659)
         {
            this.var_659.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_659.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_659 = null;
         }
         if(this.var_658)
         {
         ...
         if(this.var_656)
         {
            ...
            {
               this.var_656[_loc1_].dispose();
               this.var_656[_loc1_] = null;
               _loc1_++;
            }
            this.var_656 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = null;
         if(!this.var_106 || !this.var_26 || this._disposed)
         {
            return;
         }
         ...
         this.var_659 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_658 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_659 || !this.var_658)
         {
            return;
         }
         this.var_659.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_659.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1575,const_1574,this.onTeaserLoaded);
         ...
         this.var_393 = this._view.findChildByName(const_1576) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_386)
         {
            ...
            this.var_656[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_658)
         {
            this.var_658.textColor = const_2042;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_658)
         {
            this.var_658.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_830 = new Timer(const_1577);
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_393.bitmap)
         {
            this.var_393.bitmap.dispose();
         }
         if(this.var_657 < const_386)
         {
            this.var_393.bitmap = new BitmapData(this.var_393.width,this.var_393.height,true,0);
            this.var_393.bitmap.copyPixels(this.var_656[this.var_657],this.var_656[this.var_657].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_657);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_455 = new Timer(const_1578,const_386 - 1);
         this.var_455.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_455.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_455.start();
      }
      ...
      {
         if(!param1 || !param2 || !this.var_26 || !this.var_106 || this._disposed)
         {
            return;
         }
