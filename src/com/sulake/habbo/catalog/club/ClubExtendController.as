package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendController
   {
      ...
      {
         this.closeConfirmation();
         this._confirmationDialog = new ClubExtendConfirmationDialog(this,this.var_106);
      ...
      public function confirmSelection() : void
      {
         ...
         this._catalog.purchaseVipMembershipExtension(this.var_106.offerId);
         this.closeConfirmation();
      }
