package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger, IAvatarImageListener
   {
      ...
      private var var_458:Conversations;
      
      private var var_196:MessengerView;
      ...
      {
         if(this._windowManager && this._communication && this.var_145 && this._localization && this._friendList && this.var_612 && this._soundManager)
         {
            unlock();
      ...
      {
         this.var_458 = new Conversations(new ConversationsDeps(this));
         this.var_196 = new MessengerView(this);
      ...
      {
         var _loc2_:Conversation = this.var_458.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         {
            this.var_458.setSelected(_loc2_);
            this.var_196.openMessenger();
            this.var_196.refresh();
         }
      }
      
      public function getActiveConversation() : IConversation
      {
         return !!this.var_458 ? this.var_458.findSelectedConversation() : null;
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         this.var_458.setFollowingAllowedAndUpdateView(param1,param2);
      }
      
      public function setOnlineStatus(param1:int, param2:Boolean) : void
      {
         this.var_458.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         return this.var_196 && this.var_196.isMessengerOpen();
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_196)
         {
            if(this.var_196.isMessengerOpen())
            {
               this.var_196.close();
            }
            else
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = this.var_145.getKey("url.prefix",_loc2_);
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_941,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         this.addMsg(_loc3_);
      }
      ...
      {
         this.var_458.addMessageAndUpdateView(param1);
         if(!this.var_196.isMessengerOpen())
         {
            if(this._soundManager != null)
            {
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_1195,_loc2_.userId,this.getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         this.var_458.addMessageAndUpdateView(_loc3_);
      }
