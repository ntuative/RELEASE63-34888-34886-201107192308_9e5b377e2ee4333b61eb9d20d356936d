package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private var var_2624:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_154 = param1;
         this.var_1910 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_65 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2624 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1104 + const_1590)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1589;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1910.enable();
         }
         else
         {
            this.var_1910.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_65.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_552.messages.length - const_1104);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_981 || param3.type == Message.const_941 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_154.send(new FollowFriendMessageComposer(this.var_552.id));
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_941)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1195)
         {
            return 4294927974;
         }
