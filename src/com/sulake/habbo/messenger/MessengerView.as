package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1047:ConversationsTabView;
      
      private var var_1039:ITextFieldWindow;
      
      private var var_16:IFrameWindow;
      
      private var var_1579:ConversationView;
      ...
      public function refresh() : void
      {
         ...
         this.var_1047.refresh();
         this.var_1579.refresh();
         if(this.var_154.conversations.openConversations.length < 1)
         {
            this.var_16.visible = false;
         }
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1579.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_1047 = new ConversationsTabView(this.var_154,this.var_16);
         this.var_1047.refresh();
         this.var_1039 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_1039.addEventListener(WindowKeyboardEvent.const_183,this.onMessageInput);
         this.var_1579 = new ConversationView(this.var_154,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_860,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1397,true);
         this.var_16.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_1039.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_1039.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_1039.text;
         ...
         this.var_1039.text = "";
         this.var_154.conversations.addMessageAndUpdateView(new Message(Message.const_981,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_1047 == null ? 7 : int(this.var_1047.getTabCount());
      }
   }
}
