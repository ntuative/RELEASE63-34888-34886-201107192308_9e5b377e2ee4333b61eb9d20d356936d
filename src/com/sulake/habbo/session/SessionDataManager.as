package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_3094:Array;
      
      private var var_2053:GroupDetailsView;
      ...
      private var var_707:ProductDataParser;
      ...
      private var var_2050:UserTagManager;
      
      private var var_1344:BadgeImageManager;
      
      private var var_1345:HabboGroupInfoManager;
      
      private var var_1079:IgnoredUsersManager;
      ...
      private var var_1343:FaceBookSession;
      
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super(param1,param2,param3);
         this.var_3094 = [];
         this.var_2050 = new UserTagManager(events);
         this.var_1345 = new HabboGroupInfoManager(this,events);
         this.var_1079 = new IgnoredUsersManager(this);
         this.var_1343 = new FaceBookSession();
         this.var_1166 = new Dictionary();
         this.var_1341 = [];
         this.var_1078 = [];
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_338)
         {
            this.var_338.removeEventListener(FurnitureDataParser.const_127,this.onFurnitureReady);
            this.var_338.dispose();
            this.var_338 = null;
         }
         if(this.var_707)
         {
            this.var_707.removeEventListener(ProductDataParser.const_127,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         if(this.var_145 == null || this._localization == null)
         {
            return;
         }
         this.var_1344 = new BadgeImageManager(context.root.assets,events,this.var_145,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_2050.communication = this._communication;
         this.var_1345.communication = this._communication;
         this.var_1343.communication = this._communication;
         this.var_1079.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_338)
         {
            ...
            this.var_338 = new FurnitureDataParser(this.var_573,this._wallItems,this.var_572,this._localization);
            this.var_338.addEventListener(FurnitureDataParser.const_127,this.onFurnitureReady);
            if(this.var_145.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_145.getKey("furnidata.load.url");
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_2049 = _loc2_.clubLevel;
         this.var_2052 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2604 = _loc3_.respectTotal;
         this.var_1342 = _loc3_.respectLeft;
         this.var_881 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_960 = _loc3_.sex;
         this.var_2046 = _loc3_.realName;
         this.var_2605 = _loc3_.identityId;
         this.var_1079.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_960 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_960));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2863 = _loc2_.isOpen;
         this.var_2862 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_2052 >= SecurityLevelEnum.const_1262;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_2050.getTags(param1);
      }
      ...
      {
         return this.var_1344.getBadgeImageWithInfo(param1);
      }
      
      public function showGroupBadgeInfo(param1:int) : void
      {
         if(this.var_2053 == null)
         {
            this.var_2053 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1345.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_2053.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1345.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1345.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1344.getBadgeImage(param1,BadgeImageManager.const_1197);
      }
      ...
      {
         return this.var_1079.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1079.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1079.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1342 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to user: " + param1);
         }
         _loc2_.send(new RespectUserMessageComposer(param1));
         this.var_1342 = this.var_1342 - 1;
      }
      
      public function givePetRespect(param1:int) : void
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_881 < 1 || _loc2_ == null)
         {
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_573.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_572.getValue(param1);
      ...
      public function openHabboHomePage(param1:int) : void
      {
         ...
         {
            urlString = this.var_145.getKey("link.format.userpage");
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1341.indexOf(param1) == -1)
         {
         ...
         {
            _loc2_ = this.var_145.getKey("productdata.load.url");
            this.var_707 = new ProductDataParser(_loc2_,this.var_1166);
            this.var_707.addEventListener(ProductDataParser.const_127,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         var _loc2_:Array = this.var_573.getValues();
