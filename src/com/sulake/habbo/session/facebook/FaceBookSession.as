package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1158:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1711:String = "sendAccessTokenToServer";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1711,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1712,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1158);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1158);
         }
      }
