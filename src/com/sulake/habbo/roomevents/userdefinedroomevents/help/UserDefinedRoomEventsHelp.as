package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1906 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1282 = this.var_1906.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1282)
         {
            this.var_1282.procedure = this.onButtonClick;
         }
         this.var_1281 = this.var_1906.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1281)
         {
      ...
      {
         if(this.var_287 >= this.var_75.length - 1)
         {
      ...
      {
         ++this.var_287;
         this.var_287 = Math.min(this.var_287,this.var_75.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_287;
         this.var_287 = Math.max(this.var_287,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_75[this.var_287][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_75[this.var_287][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_75[this.var_287][1]).value;
