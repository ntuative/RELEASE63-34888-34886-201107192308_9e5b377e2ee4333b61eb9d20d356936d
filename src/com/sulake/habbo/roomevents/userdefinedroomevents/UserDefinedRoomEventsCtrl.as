package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1443:int = 2;
      ...
      private var var_1731:ActionTypes;
      
      private var var_1730:ConditionTypes;
      
      private var var_273:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_763:RoomObjectHightLighter;
      
      private var var_194:UserDefinedRoomEventsHelp;
      ...
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         ...
         this.var_1731 = new ActionTypes();
         this.var_1730 = new ConditionTypes();
         this.var_273 = new Dictionary();
         super();
         this.var_93 = param1;
         this.var_763 = new RoomObjectHightLighter(param1);
         this.var_194 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_273[param1])
         {
            delete this.var_273[param1];
            this.var_763.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_273[param1] = param2;
            this.var_763.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1165 = new SliderWindowController(this.var_93,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_93.assets,0,20,1);
         this.var_1165.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1165.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_763.hideAll(this.var_273);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1165.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_194.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1443) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1443 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1731);
