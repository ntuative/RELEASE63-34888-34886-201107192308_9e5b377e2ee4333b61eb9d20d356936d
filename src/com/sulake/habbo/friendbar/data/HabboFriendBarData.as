package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_687:String = "Navigation";
      
      private static const const_688:String = "Friend Bar";
      
      private static const const_1448:String = "go.friendbar";
      
      private static const const_1449:String = "chat_btn_click";
      
      private static const const_1451:String = "find_friends_btn_click";
      
      private static const const_1057:String = "Toolbar";
      
      private static const const_1058:String = "open";
      
      private static const const_1056:String = "close";
      
      private static const const_1450:String = "FRIENDLIST";
      
      private static const const_1452:String = "MESSENGER";
       
      
      private var var_959:IHabboConfigurationManager;
      
      private var var_94:IHabboCommunicationManager;
      
      private var var_83:IHabboFriendList;
      
      private var var_217:IHabboMessenger;
      
      private var var_618:IHabboEventStream;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_959)
            {
               this.var_959.release(new IIDHabboConfigurationManager());
               this.var_959 = null;
            }
            if(this.var_94)
            {
            ...
            if(this.var_83)
            {
               if(!this.var_83.disposed)
               {
                  ...
                  this.var_83.events.removeEventListener(FriendRequestEvent.const_209,this.onFriendRequestEvent);
               }
            ...
            if(this.var_217)
            {
               this.var_217.release(new IIDHabboMessenger());
               this.var_217 = null;
            }
            if(this.var_618)
            {
               this.var_618.release(new IIDHabboEventStream());
               this.var_618 = null;
            }
            this.var_110 = null;
      ...
      {
         return this.var_321.getValue(param1);
      }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_687,const_688,const_1448));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_217)
         {
            this.var_217.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_94)
            {
               this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_687,const_688,const_1449));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_687,const_688,const_1451));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_83)
         {
            if(!this.var_83.disposed)
            {
               ...
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1057,const_1450,!!this.var_83.isOpen() ? const_1058 : const_1056));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_217)
         {
            if(!this.var_217.disposed)
            {
               this.var_217.toggleMessenger();
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1057,const_1452,!!this.var_217.isOpen() ? const_1058 : const_1056));
               }
            }
         }
      }
      ...
      public function toggleOfflineStream() : void
      {
         if(this.var_618)
         {
            if(!this.var_618.disposed)
            {
               this.var_618.visible = !this.var_618.visible;
            }
         }
      }
      ...
      {
         this.var_959 = param2 as IHabboConfigurationManager;
         this.var_2324 = this.var_959.getBoolean("friendbar.notifications.enabled",false);
         this.var_1750 = this.var_959.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_217 = param2 as IHabboMessenger;
      }
      
      private function onOfflineStreamAvailable(param1:IID, param2:IUnknown) : void
      {
         this.var_618 = param2 as IHabboEventStream;
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_83.events.addEventListener(FriendRequestEvent.const_209,this.onFriendRequestEvent);
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            _loc3_ = this.var_321.getValue(_loc8_);
            if(_loc3_)
            {
               this.var_321.remove(_loc8_);
               this.var_110.splice(this.var_110.indexOf(_loc3_),1);
            }
         }
         for each(_loc4_ in _loc6_)
         {
            _loc3_ = this.var_321.getValue(_loc4_.id);
            if(_loc3_)
            {
            ...
            else if(_loc4_.online || const_316)
            {
               ...
               this.var_321.add(_loc3_.id,_loc3_);
            }
         }
         for each(_loc4_ in _loc7_)
         {
            if(_loc4_.online || const_316)
            {
               if(this.var_321.getValue(_loc4_.id) == null)
               {
                  _loc3_ = new FriendEntity(_loc4_.id,_loc4_.name,_loc4_.realName,_loc4_.motto,_loc4_.gender,_loc4_.online,_loc4_.followingAllowed,_loc4_.figure,_loc4_.categoryId,_loc4_.lastAccess);
         ...
         {
            this.var_110 = !!const_316 ? this.sortByNameAndOnlineStatus(this.var_110) : this.sortByName(this.var_110);
         }
         events.dispatchEvent(new FriendBarUpdateEvent());
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_769 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_217)
         {
            if(this.var_217.isOpen())
            {
               _loc4_ = this.var_217.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_769)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_769));
            this.makeNotification(String(this.var_769),FriendNotification.const_409,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_769 = _loc2_.senderId;
         if(this.var_217 && !this.var_217.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_769));
            this.makeNotification(String(this.var_769),FriendNotification.const_409,null,true,false);
         }
      }
