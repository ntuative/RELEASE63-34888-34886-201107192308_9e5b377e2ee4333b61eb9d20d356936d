package com.sulake.habbo.friendbar.view
{
   ...
   public class AbstractView extends Component
   {
      ...
      protected var var_759:IHabboLocalizationManager;
      
      protected var var_1122:IHabboConfigurationManager;
      ...
      {
         this.var_759 = param2 as IHabboLocalizationManager;
      }
      
      private function onConfigurationAvailable(param1:IID, param2:IHabboConfigurationManager) : void
      {
         this.var_1122 = param2 as IHabboConfigurationManager;
      }
   }
}
