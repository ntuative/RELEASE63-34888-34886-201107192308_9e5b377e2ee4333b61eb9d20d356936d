package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1652:String = "entity_xml";
      
      private static const const_1651:String = "facebook_piece_xml";
      
      private static const const_1649:String = "controls_piece_xml";
      ...
      protected static const const_1411:String = "controls";
      
      protected static const const_315:String = "canvas";
      
      protected static const const_704:String = "name";
      
      protected static const const_1105:String = "btn_message";
      
      protected static const const_1035:String = "icon_message";
      
      protected static const const_1412:String = "btn_visit";
      ...
      private static const const_1060:uint = 13891476;
      
      private static const const_1130:String = null;
      
      private static const const_715:String = "icon_tag_notify";
      
      private static const const_1650:String = "icon_tag_message";
      
      private static const POOL:Vector.<FriendEntityTab> = new Vector.<FriendEntityTab>();
      
      private static const const_482:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         ...
         _loc3_ = _loc2_.getListItemByName(const_1411) as IWindowContainer;
         if(_loc3_)
         {
            _loc3_.dispose();
         }
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1651).content as XML) as IWindowContainer;
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1649).content as XML) as IWindowContainer;
               _loc3_.name = const_1411;
               _loc8_ = _loc3_.getChildByName(const_1105);
               if(_loc8_)
               {
                  _loc8_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClick);
               }
               _loc8_ = _loc3_.getChildByName(const_1412);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_167)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1036)).getListItemByName(const_464) as IWindowContainer;
            _loc1_.findChildByName(const_704).caption = this.var_167.name;
            var_2246.crop(_loc1_.getChildByName(const_704) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_315));
            _loc2_.bitmap = var_507.getAvatarFaceBitmap(this.var_167.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_482.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1652).content as XML) as IWindowContainer;
      ...
      private function releaseFriendTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_482.indexOf(param1) == -1)
            {
               const_482.push(param1);
            }
         }
      }
      ...
      private function onButtonClick(param1:WindowMouseEvent) : void
      {
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               case const_1105:
               case const_1035:
                  this.removeNotificationToken(FriendNotification.const_409,true);
                  if(var_360 && this.var_167)
                  {
                     var_360.startConversation(this.var_167.id);
                     this.deselect(true);
                     if(param1.window.name == const_1035)
                     {
                        var_507.setMessengerIconNotify(false);
                     }
                  }
                  break;
               case const_1412:
                  if(var_360 && this.var_167)
                  {
                     var_360.followToRoom(this.var_167.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1130;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1273:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2219);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_715;
               break;
            case FriendNotification.const_1340:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2219);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_715;
               break;
            case FriendNotification.const_409:
