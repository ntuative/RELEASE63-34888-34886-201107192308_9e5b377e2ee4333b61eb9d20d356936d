package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_2035:String = "friend_request_tab_xml";
      
      protected static const const_465:String = "bubble";
      
      protected static const const_1105:String = "message";
      ...
      private static const const_72:uint = 16435481;
      
      private static const const_1060:uint = 16767334;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1453:uint = 16777215;
      
      private static var var_1455:FriendRequestTab;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1455 ? var_1455 : new FriendRequestTab();
         ...
         if(_loc2_.friend)
         {
            if(_loc2_.friend.figure != param1.figure)
            {
               ...
               _loc3_.bitmap = var_507.getAvatarFaceBitmap(param1.figure);
            }
         }
      ...
      {
         var _loc6_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2035).content as XML) as IWindowContainer;
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_332,WindowStyle.const_102,WindowParam.const_30,new Rectangle(0,0,25,25)) as IRegionWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2036:
                  var_360.acceptFriendRequest(var_167.id);
                  break;
               case const_1420:
                  if(selected)
                  {
                  ...
                  break;
               case const_1034:
                  var_360.declineFriendRequest(var_167.id);
            }
         }
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1034)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1453;
            }
         }
      }
         ...
         if(!disposed)
         {
            if(friend)
            {
               if(friend.figure == param1.figure)
               {
                  ...
                  if(_loc3_)
                  {
                     _loc4_ = var_507.getAvatarFaceBitmap(param1.figure);
                     if(_loc4_)
                     {
