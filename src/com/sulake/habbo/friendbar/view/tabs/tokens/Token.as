package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static const const_2043:String = "title";
      ...
      protected function prepare(param1:String, param2:String, param3:String, param4:String, param5:String, param6:Boolean) : void
      {
         ...
         this._window.findChildByName(const_2043).caption = param1;
         this._window.findChildByName(const_1105).caption = !!param2 ? param2 : "";
         ...
         this._icon = var_1433.create("ICON_" + this.typeCode,WindowType.const_332,WindowStyle.const_102,WindowParam.const_30,Token.const_1409) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1433.create("BITMAP_" + this.typeCode,WindowType.const_429,WindowStyle.const_102,WindowParam.const_198,Token.const_1409) as IBitmapWrapperWindow;
