package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class Icon implements IDisposable
   {
      ...
      protected static const const_468:int = 1;
      
      protected static const const_2057:int = 2;
      
      protected static const const_2058:int = 3;
      ...
      {
         this.var_1387 = const_468 | const_467;
         this.var_736 = new Point();
         super();
      }
      ...
      protected function redraw() : void
      {
         ...
         if(this.var_98 && !this.var_98.disposed)
         {
            ...
            {
               this.var_736.x = this.var_736.y = 0;
               _loc1_ = this.var_48.content as BitmapData;
               switch(this.var_1387 & const_2058)
               {
                  case const_468:
                     this.var_736.x = this.var_98.bitmap.width / 2 - _loc1_.width / 2;
                     break;
                  case const_2057:
                     this.var_736.x = this.var_98.bitmap.width - _loc1_.width;
               }
               switch(this.var_1387 & const_2056)
               {
                  case const_467:
                     this.var_736.y = this.var_98.bitmap.height / 2 - _loc1_.height / 2;
                     break;
                  case const_276:
                     this.var_736.y = this.var_98.bitmap.height - _loc1_.height;
               }
               this.var_98.bitmap.copyPixels(_loc1_,_loc1_.rect,this.var_736);
