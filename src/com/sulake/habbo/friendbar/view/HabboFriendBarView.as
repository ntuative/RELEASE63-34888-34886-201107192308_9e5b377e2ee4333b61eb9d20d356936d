package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends AbstractView implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1440:int = 127;
      ...
      private static const const_1438:Boolean = false;
      
      private static const const_685:int = 3;
      
      private static const const_1427:String = "arrow";
      
      private static const const_1429:String = "left";
      
      private static const const_1437:String = "right";
      
      private static const const_1430:String = "bar_xml";
      
      private static const const_1425:String = "toggle_xml";
      
      private static const const_70:String = "container";
      
      private static const const_1049:String = "wrapper";
      
      private static const const_1432:String = "border";
      ...
      private static const const_1428:String = "button_right";
      
      private static const const_1439:String = "button_left_page";
      
      private static const const_1435:String = "button_right_page";
      
      private static const const_1431:String = "button_left_end";
      
      private static const const_1436:String = "button_right_end";
      
      private static const const_1420:String = "button_close";
      
      private static const const_1434:String = "button_open";
      
      private static const const_1426:String = "link_friendlist";
      
      private static const const_1046:String = "messenger";
      
      private static const const_1048:String = "friendlist";
      ...
      private var var_1167:ITab;
      
      private var var_952:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1444:TextCropper;
      
      private var var_521:FriendListIcon;
      
      private var var_369:MessengerIcon;
      
      private var var_764:StreamIcon;
         ...
         if(!disposed)
         {
            ...
            if(this.var_49)
            {
               if(!this.var_49.disposed)
               {
                  ...
                  {
                     this.var_49.events.removeEventListener(FriendBarUpdateEvent.const_987,this.onRefreshView);
                     this.var_49.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_49.events.removeEventListener(FriendRequestUpdateEvent.const_940,this.onFriendRequestUpdate);
                     this.var_49.events.removeEventListener(NewMessageEvent.const_872,this.onNewInstantMessage);
                     this.var_49.events.removeEventListener(NotificationEvent.const_852,this.onFriendNotification);
                  }
            ...
            if(_windowManager)
            {
               if(true)
               {
                  _windowManager.getWindowContext(const_469).getDesktopWindow().removeEventListener(WindowEvent.const_40,this.onDesktopResized);
               }
            }
      ...
      public function populate() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc1_:int = this.var_952;
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_45.findChildByName(const_70) as IWindowContainer;
         ...
         var _loc9_:int = _loc6_ + (!!this.var_1445 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(this.var_1445)
         {
            ...
            {
               _loc15_ = 1;
               if(this.var_72.length + _loc15_ < const_685)
               {
                  _loc15_ = Math.min(_loc8_ - this.var_72.length,const_685 - this.var_72.length);
               }
      ...
      private function onFriendBarDataAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_49.events.addEventListener(FriendBarUpdateEvent.const_987,this.onRefreshView);
         this.var_49.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_49.events.addEventListener(FriendRequestUpdateEvent.const_940,this.onFriendRequestUpdate);
         this.var_49.events.addEventListener(NewMessageEvent.const_872,this.onNewInstantMessage);
         this.var_49.events.addEventListener(NotificationEvent.const_852,this.onFriendNotification);
      }
      ...
      {
         var_759 = param2 as IHabboLocalizationManager;
      }
      ...
      {
         var _loc2_:* = null;
         Tab.var_360 = this.var_49;
         Tab.var_507 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = _windowManager;
         Tab.var_2219 = var_759;
         Tab.var_2246 = this.var_1444;
         Token.WINDOWING = _windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1430);
         this.var_45 = _windowManager.buildFromXML(_loc1_.content as XML,const_469) as IWindowContainer;
         this.var_45.x = const_684;
         this.var_45.y = this.var_45.parent.height - (this.var_45.height + const_1433);
         this.var_45.width = this.var_45.parent.width - (const_684 + const_1047);
         this.var_45.setParamFlag(WindowParam.const_250,true);
         this.var_45.procedure = this.barWindowEventProc;
         if(const_1438)
         {
            _loc1_ = assets.getAssetByName(const_1425);
            this.var_215 = _windowManager.buildFromXML(_loc1_.content as XML,const_469) as IWindowContainer;
            this.var_215.x = this.var_45.x;
            this.var_215.y = this.var_45.y;
            this.var_215.setParamFlag(WindowParam.const_250,true);
            this.var_215.visible = false;
            this.var_215.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_1048));
         ...
         this.var_521 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_1046));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_369 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_369.enable(false);
         this.visible = true;
         _windowManager.getWindowContext(const_469).getDesktopWindow().addEventListener(WindowEvent.const_40,this.onDesktopResized);
         this.var_45.findChildByName(const_683).visible = var_1122.getBoolean("friendbar.stream.enabled",false) == true;
         _loc2_ = IWindowContainer(this.var_45.findChildByName(const_683));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_764 = new StreamIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
      }
      
      private function onAvatarRendererAvailable(param1:IID, param2:IUnknown) : void
      {
         var_612 = param2 as IAvatarRenderManager;
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(var_612)
         {
            _loc3_ = var_612.createAvatarImage(param1,AvatarScaleType.const_62,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_45.findChildByName(const_686) as IItemListWindow;
      ...
      public function selectTab(param1:ITab, param2:Boolean) : void
      {
         if(!param1.selected)
         {
            ...
            {
               this.var_952 = FriendEntityTab(param1).friend.id;
            }
         }
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_521)
         {
            this.var_521.notify(this.var_49.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            _loc4_ = this.var_49.numFriends + (!!this.var_1445 ? 1 : 0) + (this.var_49.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
         ...
         if(param1.type == WindowEvent.const_664)
         {
            this.deSelect(true);
         }
      }
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_45.findChildByName(const_1049) as IWindowContainer;
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1427,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            _loc4_.visible = param1;
         }
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1429,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1437,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param3)
            {
         ...
         if(!disposed)
         {
            if(this.var_45)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_72.length < const_685)
                     {
                        param1 = true;
                     }
                     else if(this.var_72.length < this.var_49.numFriends + (!!this.var_1445 ? 1 : 0))
                     {
                        param1 = true;
                     }
      ...
      {
         var _loc1_:IWindowContainer = this.var_45.findChildByName(const_70) as IWindowContainer;
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1049) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_686) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1440 + _loc3_.spacing);
      }
