package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_579:IKeyExchange;
      
      private var var_1097:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2922:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_723 = param1;
            this.var_66.initConnection(HabboConnectionType.const_252);
         }
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_723 = this.var_161.getKey("sso.ticket",null);
         this.var_2105 = this.var_161.getKey("flash.client.url","");
         this.var_2920 = this.var_161.getKey("external.variables.txt","");
         if(this.var_262 == null)
         {
            this.var_262 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_812,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1943);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_66.mode = HabboConnectionType.const_1364;
            }
         }
         this.var_66.initConnection(HabboConnectionType.const_252);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_967);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2922 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_66.mode)
         {
            case HabboConnectionType.const_99:
               ...
               this.var_262.loadBannerImage(_loc7_ + "?token=" + this.var_1639,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1364:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_2022:
               this.var_1097 = this.generateRandomHexString(30);
               this.var_579 = new DiffieHellman(new BigInteger(this.var_161.getKey("connection.development.prime"),16),new BigInteger(this.var_161.getKey("connection.development.generator"),16));
               this.var_579.init(this.var_1097);
               _loc8_ = this.var_579.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_579.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_579.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2922);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_2105,this.var_2920));
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_723 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_723);
            _loc2_.send(_loc4_);
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2921)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1639);
         ...
         this.var_579 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_579.init(_loc14_);
            _loc15_ = this.var_579.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1097 = _loc14_;
            }
