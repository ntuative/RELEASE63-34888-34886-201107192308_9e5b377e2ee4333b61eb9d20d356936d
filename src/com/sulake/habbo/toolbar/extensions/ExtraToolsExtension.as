package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1479:uint = 16777215;
      
      private static const const_1480:uint = 12247545;
      
      private static const const_1481:String = "HELP";
      ...
      {
         this.var_65.removeListItem(this.var_420);
      }
      
      public function showRoomInfo() : void
      {
         this.var_65.addListItemAt(this.var_420,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_325)
         {
            this.var_325 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_325.x = _loc1_.x + this._window.width - this.var_325.width;
            this.var_325.y = _loc1_.y + this._window.height - this.var_325.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1481);
               break;
