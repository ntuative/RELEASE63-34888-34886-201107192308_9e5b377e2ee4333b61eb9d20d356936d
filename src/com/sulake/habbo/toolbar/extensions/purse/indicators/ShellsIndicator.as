package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class ShellsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_474:Array = ["icon_shell_0_png","icon_shell_1_png","icon_shell_2_png","icon_shell_3_png"];
       
      
      private const const_1455:uint = 4.283212437E9;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(PurseEvent.const_325,this.onShellBalance);
      }
      
      override protected function onContainerClick(param1:WindowMouseEvent) : void
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1835,true);
      }
      ...
      private function onShellBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1816 != 0)
         {
            if(this.var_1816 > param1.balance)
            {
