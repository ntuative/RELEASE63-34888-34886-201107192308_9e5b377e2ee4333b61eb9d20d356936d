package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class PixelsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1455:uint = 4285767869;
      
      private static const const_1456:uint = 4283664040;
      
      private static const const_474:Array = ["icon_pixel_0_png","icon_pixel_1_png","icon_pixel_2_png","icon_pixel_3_png"];
      ...
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1912);
      }
      ...
      private function onPixelBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1756 != 0)
         {
            if(this.var_1756 > param1.balance)
            {
