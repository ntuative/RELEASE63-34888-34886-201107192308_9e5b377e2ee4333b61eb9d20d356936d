package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ClubDiscountPromoExtension
   {
      ...
      private static const const_1497:int = 13;
      
      private static const const_1135:int = 14;
      
      private static const const_1495:uint = 16777215;
      
      private static const const_1496:uint = 12247545;
      ...
      private var var_678:IExtensionView;
      ...
      private var var_1365:IRegionWindow;
      ...
      public function ClubDiscountPromoExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager, param6:ICoreLocalizationManager, param7:IHabboInventory, param8:IHabboCatalog, param9:IConnection)
      {
         ...
         this.var_678 = param1.extensionView;
         if(this.var_12)
         {
            this.var_12.events.addEventListener(HabboInventoryHabboClubEvent.const_320,this.onClubChanged);
         }
      }
            ...
            if(_loc3_)
            {
               ...
               if(this.var_89)
               {
                  ...
                  if(_loc5_)
                  {
                     ...
                     if(this.var_892)
                     {
                        this.var_89.bitmap = this.var_892.clone();
                     }
                  }
                  this.var_89.visible = false;
               }
               this.var_1365 = _loc3_.findChildByName("text_region") as IRegionWindow;
               if(this.var_1365)
               {
                  this.var_1365.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onTextRegionClicked);
                  this.var_1365.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onTextRegionMouseOver);
                  this.var_1365.addEventListener(WindowMouseEvent.const_25,this.onTextRegionMouseOut);
               }
               this.assignState();
            }
         }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_678)
            {
               this.var_678.detachExtension(const_720);
               this.var_678 = null;
            }
            this.animate(false);
            this.clearAnimation();
            ...
            if(this.var_12)
            {
               this.var_12.events.removeEventListener(HabboInventoryHabboClubEvent.const_320,this.onClubChanged);
               this.var_12 = null;
            }
            this._catalog = null;
      ...
      private function onClubChanged(param1:HabboInventoryHabboClubEvent) : void
      {
         if(this.var_12.clubIsExpiring)
         {
            if(!this._view)
            {
               ...
               this.assignState();
               this.var_678.attachExtension(const_720,this._view,ExtensionFixedSlotsEnum.const_1757);
            }
         }
         else
         {
      ...
      private function animate(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            this.var_724 = new Timer(15000);
            this.var_724.addEventListener(TimerEvent.TIMER,this.onTriggerTimer);
            this.var_724.start();
         }
         else
         {
      ...
      private function resetAnimationVariables() : void
      {
         ...
         this.var_2118 = this._view.width - 7 - this.var_89.bitmap.width;
         this.var_1644 = 0;
      }
      
      private function startAnimationTimer() : void
      {
         this.var_695 = new Timer(25,26);
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         this.var_89.x = 3 + this.var_1644 / 20 * this.var_2118;
         if(this.var_89.x > this.var_2118)
         {
            _loc2_ = this._view.width - 4 - this.var_89.x;
            _loc3_ = new BitmapData(_loc2_,this.var_892.height);
            _loc3_.copyPixels(this.var_892,new Rectangle(0,0,_loc2_,this.var_892.height),new Point(0,0));
