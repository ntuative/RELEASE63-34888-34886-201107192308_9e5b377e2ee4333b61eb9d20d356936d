package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1635:String = "purse";
      
      private static const const_1634:String = "extra_tools";
      ...
      private var var_677:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1309:PurseExtension;
      
      private var var_1578:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_678:ExtensionView;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_271.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_271 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
            this.var_271.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
            unlock();
         }
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_678 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_678)
            {
               this.var_1309 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_677 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1578 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_678.attachExtension(const_1635,this.var_1309.window,ExtensionFixedSlotsEnum.const_1898);
               this.var_678.attachExtension(const_1634,this.var_677.window,ExtensionFixedSlotsEnum.const_1785);
            }
         }
         if(this._view == null)
         {
      ...
      public function setToolbarState(param1:String) : void
      {
         switch(param1)
         {
            case HabboToolbarEnum.const_930:
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_677.showRoomInfo();
         }
         else
         {
            this.var_677.hideRoomInfo();
         }
      }
