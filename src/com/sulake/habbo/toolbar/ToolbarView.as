package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1473:Point = new Point(3,3);
      
      private static const const_1593:uint = 7433577;
      
      private static const const_1598:uint = 5723213;
      
      private static const const_478:String = "_hover";
      
      private static const const_480:String = "_normal";
      
      private static const const_479:int = 5;
      
      private static const const_1594:int = 600;
      
      private static const const_1596:int = 80;
      
      private static const const_1600:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1599:int = -2;
      
      private static const const_1597:int = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1473;
         this._window.addEventListener(WindowEvent.const_652,this.onParentResized);
         ...
         this.var_220.x = _loc13_.width - this.var_220.width - const_479;
         this.var_220.y = const_479;
         this.var_2636 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1594;
         if(!param1 && _loc2_ == this.var_1561)
         {
            return;
         }
         this.var_1561 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1600) : int(const_1596);
         var _loc4_:int = !!_loc2_ ? int(const_1599) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1597 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1595;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_220 != null && this.var_2636)
               {
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_478 ? this.var_1559 : this.var_1560;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_478)
         {
            param1.color = const_1593;
         }
         else
         {
            param1.color = const_1598;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1561 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1561 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1559 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_479;
            _loc2_.y = const_479;
