   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_40)
         {
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_213,_windowManager,_assetLibrary);
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_264,_windowManager,_assetLibrary);
         ...
         if(var_78 && var_166 == "")
         {
            var_78.switchCategory(FigureData.const_213);
         }
      }
