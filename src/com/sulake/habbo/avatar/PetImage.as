package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_606:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_55)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1681);
            if(_loc3_ != null)
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1128);
         this.getCache().resetBodyPartCache(this.var_1128);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1680 = this._structure.sortActions(this.var_362);
         ...
         {
            this.var_785 = this._structure.getCanvasOffsets(this.var_1680,this._scale,this.var_103);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1680)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_323)
               {
                  this.var_1129 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1326 = _loc4_.id;
                     this.var_1926 = _loc4_.breed;
                     break;
                  }
               }
            }
