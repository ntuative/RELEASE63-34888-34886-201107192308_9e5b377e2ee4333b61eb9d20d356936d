package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_2700 = parseInt(_loc2_,16);
         this.var_2699 = parseInt(_loc3_,16);
         ...
         this.var_782 = new ColorTransform(this.var_1735,this.var_1736,this.var_1734,this._alphaMultiplier);
         this.var_1308 = this.generatePaletteMapForGrayscale(this.var_2699,this.var_2700);
      }
      ...
      {
         return this.var_1308.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1308.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1308.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1308.getValue("alphas") as Array;
      }
