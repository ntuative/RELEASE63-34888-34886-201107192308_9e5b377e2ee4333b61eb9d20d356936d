package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1274:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2597:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         this.var_2597.appendXML(this.var_1890);
         dispatchEvent(new Event(AvatarStructureDownload.const_1274));
      }
