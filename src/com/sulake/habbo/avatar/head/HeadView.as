   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_40)
         {
            ...
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_278,_windowManager,_assetLibrary);
            var_40["null"] = new AvatarEditorGridView(var_78,FigureData.const_306,_windowManager,_assetLibrary);
