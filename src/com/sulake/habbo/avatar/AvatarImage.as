package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1586:String = "Default";
      
      private static const const_1587:int = 2;
      
      private static const const_1588:String = AvatarSetType.const_43;
      ...
      protected var var_305:AvatarImageCache;
      
      protected var _figure:AvatarFigureContainer;
      
      protected var var_606:IAvatarDataContainer;
      
      protected var var_362:Array;
      
      protected var var_48:BitmapData;
      
      private var var_1128:IActiveActionData;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1588,const_1587);
         this.var_362 = new Array();
         this.var_1128 = new ActiveActionData(AvatarAction.const_441);
         this.var_1128.definition = this._structure.getActionDefinition(const_1586);
         this.resetActions();
      ...
      {
         param2 += this.var_1909;
         if(param2 < AvatarDirectionAngle.const_1384)
         {
            param2 = AvatarDirectionAngle.const_365 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_365)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_55 || param1 == AvatarSetType.const_43)
         {
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_288.length == 1 && this.var_103 == this.var_2095)
         {
            return this.var_103 + this.var_551 + this.var_662 % 4;
         }
      ...
      {
         if(param3 != this.var_2621 || param2 != this.var_2622 || param1 != this.var_2623)
         {
            this.var_2621 = param3;
            this.var_2622 = param2;
            this.var_2623 = param1;
            this.var_1908 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1426 || this.var_48 == null || (this.var_48.width != _loc5_.width || this.var_48.height != _loc5_.height))
         {
            if(this.var_48 != null && !this.var_1426)
            {
               this.var_48.dispose();
            }
         ...
         {
            if(this.var_606.paletteIsGrayscale)
            {
               ...
               this.var_48 = _loc13_;
               this.var_48.paletteMap(this.var_48,this.var_48.rect,new Point(0,0),this.var_606.reds,[],[]);
            }
            else
            {
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_362.push(new ActiveActionData(param1,param2,this.var_662));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_317 = this.var_1128;
         this.var_317.definition = this.var_1128.definition;
         this.resetBodyPartCache(this.var_1128);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_551 = "";
         this.var_288 = this._structure.sortActions(this.var_362);
         if(this.var_288 == null)
         {
         ...
         {
            this.var_785 = this._structure.getCanvasOffsets(this.var_288,this._scale,this.var_103);
            ...
            if(this.var_1283 != this.var_551)
            {
               _loc1_ = true;
               this.var_1283 = this.var_551;
            }
         }
         this.var_1546 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_288)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1129 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1909 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_606 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_323 || _loc1_.actionType == AvatarAction.const_279 || _loc1_.actionType == AvatarAction.const_430)
               {
                  this.var_1129 = true;
               }
            }
