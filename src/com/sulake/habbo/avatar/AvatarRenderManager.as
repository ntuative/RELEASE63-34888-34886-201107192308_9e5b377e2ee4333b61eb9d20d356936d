package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2347:String = "hd-99999-99999";
      ...
      private var var_821:PaletteManager;
      ...
      private var var_1868:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_692 = RenderMode.const_1851;
         ...
         this.var_123.add(AvatarType.const_137,_loc4_);
         ...
         this.var_821 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_331.init();
         this.var_821.init();
         _loc2_ = this.var_123.getValue(AvatarType.const_137) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_123.getValue(AvatarType.const_137) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_145.getKey("external.figurepartlist.txt","figure.xml");
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1274,this.onFigureDataDownloadDone);
               if(this.var_249 == null)
               {
                  Logger.log("[AvatarRenderManager] Init Avatar Assets Download Manager");
                  _loc6_ = this.var_145.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_145.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_1119)
         {
            if(this.var_2577 && this.var_2578 && this.var_2576)
            {
               this.var_1119 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_123.getValue(AvatarType.const_137) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1868)
         {
            this.var_1868 = new AvatarFigureContainer(this.const_2347);
         }
         this.var_249.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1868,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1951)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_123.getValue(AvatarType.const_137) as AvatarStructure;
