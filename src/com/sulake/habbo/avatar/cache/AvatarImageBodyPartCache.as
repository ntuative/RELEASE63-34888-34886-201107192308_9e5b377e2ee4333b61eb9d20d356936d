package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageBodyPartCache
   {
      ...
      public function disposeActions(param1:int, param2:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc6_:* = null;
         if(this.var_305 == null || this._disposed)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_305.getValue(_loc6_) as AvatarImageActionCache;
            if(_loc4_ != null)
            {
      ...
      public function getActionCache(param1:IActiveActionData = null) : AvatarImageActionCache
      {
         ...
         return this.var_305.getValue(param1.id) as AvatarImageActionCache;
      }
      
      public function updateActionCache(param1:IActiveActionData, param2:AvatarImageActionCache) : void
      {
         this.var_305.add(param1.id,param2);
      }
