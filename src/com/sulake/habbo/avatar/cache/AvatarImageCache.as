package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_2089:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1677:IAvatarImage;
      ...
      private var var_446:AvatarImageBodyPartContainer;
      
      private var var_1633:String;
      
      private var var_138:AvatarImagePartContainer;
      
      private var var_2901:Point;
      ...
      private var var_2900:ByteArray;
      
      private var var_2899:ImageData;
      
      private var var_1000:PaletteMap;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_305.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_305.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_305.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_305.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_305.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_305.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      {
         if(this.var_888 == param1)
         {
            return;
         }
         if(this.var_888 == GeometryType.const_1407 && param1 == GeometryType.const_1288 || this.var_888 == GeometryType.const_1288 && param1 == GeometryType.const_1407)
         {
            this.var_888 = param1;
            this.var_98 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_305.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_411.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_541)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1677.getFigure(),_loc5_,this.var_888,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_446 = _loc10_.getImageContainer(_loc4_);
         if(this.var_446 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_446 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_411);
            if(this.var_446 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_446,_loc4_);
         }
         this.var_446.offset = _loc8_;
         return this.var_446;
      }
      
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_305.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_305.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_98)
         {
            this.var_98 = this._structure.getCanvas(this._scale,this.var_888);
            if(!this.var_98)
            {
               return null;
            }
            this.var_2901 = new Point(0,this.var_98.height - int(this.var_98.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_2016[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_838 || _loc10_ == AvatarAction.const_430;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1633 = this.var_138.bodyPartId;
               this.var_206 = this.var_138.partType;
               this.var_2090 = this.var_138.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_138.flippedPartType != this.var_206)
                     {
                        this.var_206 = this.var_138.flippedPartType;
                     }
                  }
               }
               this.var_1632 = this._scale + "_" + this.var_138.action.assetPartDefinition + "_" + this.var_206 + "_" + this.var_2090 + "_" + _loc5_ + "_" + this._frame;
               this.var_496 = this._assets.getAssetByName(this.var_1632) as BitmapDataAsset;
               if(this.var_496 == null)
               {
                  this.var_1632 = this._scale + "_std_" + this.var_206 + "_" + this.var_2090 + "_" + _loc5_ + "_0";
                  this.var_496 = this._assets.getAssetByName(this.var_1632) as BitmapDataAsset;
               }
               if(!(!this.var_496 || !this.var_496.content))
               {
                  if(this.var_138.paletteMapId > -1)
                  {
                     this.var_1000 = this._structure.renderManager.paletteManager.getPalette(this.var_138.paletteMapId);
                     if(this.var_1000 != null)
                     {
                        this.var_1090 = this.var_496.content as BitmapData;
                        this.var_207 = new BitmapData(this.var_1090.width,this.var_1090.height);
                        this.var_2900 = this.var_1000.colorize(this.var_1090.getPixels(this.var_1090.rect));
                        this.var_207.setPixels(this.var_207.rect,this.var_2900);
                     }
                     else
                     {
                        this.var_207 = (this.var_496.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1633 == AvatarBodyPartType.const_245 || this.var_1633 == AvatarBodyPartType.const_1866 || this.var_1633 == AvatarBodyPartType.const_1844) && this.var_138.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_207.colorTransform(this.var_207.rect,this.var_138.color.colorTransform);
                  }
                  if(this.var_138.isBlendable)
                  {
                     this.var_207.colorTransform(this.var_207.rect,this.var_138.blendTransform);
                  }
                  this.var_1091 = this.var_496.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_62)
                     {
                  ...
                  this.var_2899 = new ImageData(this.var_207,this.var_1091,_loc7_);
                  this.var_1089.push(this.var_2899);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_1089,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2901.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_62)
            {
         ...
         _loc8_ = this.var_1089.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1089.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
