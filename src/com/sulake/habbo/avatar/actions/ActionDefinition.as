package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2434 = String(param1.@activepartset);
         this.var_2435 = String(param1.@assetpartdefinition);
         this.var_2438 = String(param1.@lay);
         this.var_888 = String(param1.@geometrytype);
         this.var_2436 = Boolean(parseInt(param1.@main));
         this.var_2441 = Boolean(parseInt(param1.@const_461));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2439 = _loc6_;
            }
            else
            {
               this.var_1797[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1797[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2439;
         }
         return _loc2_;
      }
