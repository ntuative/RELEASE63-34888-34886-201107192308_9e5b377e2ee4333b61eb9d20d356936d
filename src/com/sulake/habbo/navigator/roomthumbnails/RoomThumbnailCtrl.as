package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2207:IButtonWindow;
      
      private var var_2206:IButtonWindow;
      
      private var var_2208:IButtonWindow;
      
      private var var_3042:IWindowContainer;
      
      private var var_3041:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_2207 = IButtonWindow(this.find("bg_tab"));
         this.var_2206 = IButtonWindow(this.find("top_tab"));
         this.var_2208 = IButtonWindow(this.find("obj_tab"));
         this.var_3042 = IWindowContainer(this.find("tile_grid"));
         this.var_3041 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_2207,this.onBgTabButton);
         Util.setProcDirectly(this.var_2206,this.onTopTabButton);
         Util.setProcDirectly(this.var_2208,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_2207,this.var_78.mode != ThumbnailEditorModel.const_38);
         this.setEnabled(this.var_2206,this.var_78.mode != ThumbnailEditorModel.const_65);
         this.setEnabled(this.var_2208,this.var_78.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_3041;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_3042;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_70,HabboWindowStyle.const_31,HabboWindowParam.const_63,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_332,HabboWindowStyle.const_47,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_321,HabboWindowStyle.const_47,HabboWindowParam.const_63,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));
