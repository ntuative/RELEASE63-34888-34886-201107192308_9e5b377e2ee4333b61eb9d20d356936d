package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:IWindowContainer)
      {
         ...
         this.var_868 = new TextFieldManager(this._navigator,_loc3_,25,this.searchRooms,this._navigator.getText("navigator.search.info"));
      ...
      private function searchRooms() : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_280,Tabs.const_426,_loc1_);
