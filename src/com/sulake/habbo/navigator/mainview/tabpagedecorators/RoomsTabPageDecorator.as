package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_229,Tabs.const_407);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_229,Tabs.const_790);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_229,Tabs.const_407,"" + _loc3_);
         }
         if(this.var_159)
         {
