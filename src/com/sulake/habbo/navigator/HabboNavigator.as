package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_322:MainViewCtrl;
      
      private var var_625:RoomInfoViewCtrl;
      
      private var var_1180:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_482:Tabs;
      ...
      private var var_2356:RoomThumbnailRenderer;
      
      private var var_986:GuestRoomPasswordInput;
      
      private var var_323:GuestRoomDoorbell;
      
      private var var_1181:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2355 = new Array();
         ...
         this.var_322 = new MainViewCtrl(this);
         this.var_625 = new RoomInfoViewCtrl(this);
         this.var_1180 = new RoomCreateViewCtrl(this);
         this.var_2356 = new RoomThumbnailRenderer(this);
         this.var_986 = new GuestRoomPasswordInput(this);
         this.var_323 = new GuestRoomDoorbell(this);
         this.var_482 = new Tabs(this);
         this.var_1181 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_321,HabboWindowStyle.const_47,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_322.onNavigatorToolBarIconClick();
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_145.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_322.startSearch(Tabs.const_280,Tabs.const_657,param1);
         this.trackNavigationDataPoint("Search","search.tag",param1);
         this.var_322.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_322.startSearch(Tabs.const_265,Tabs.const_275);
         this.var_482.getTab(Tabs.const_265).tabPageDecorator.tabSelected();
      }
