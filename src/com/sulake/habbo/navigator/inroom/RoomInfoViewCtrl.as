package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomInfoViewCtrl implements IRoomSettingsCtrlOwner
   {
      ...
      private var var_310:RoomThumbnailCtrl;
      
      private var var_1133:TagRenderer;
      ...
      private var var_2183:IWindowContainer;
      ...
      private var var_1686:ITextWindow;
      ...
      private var var_1687:IButtonWindow;
      ...
      private var var_911:IButtonWindow;
      
      private var var_1685:Boolean = false;
      
      private const const_980:int = 75;
      
      private const const_839:int = 3;
      ...
      public function RoomInfoViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_310 = new RoomThumbnailCtrl(this._navigator);
         this.var_1133 = new TagRenderer(this._navigator);
         this._navigator.roomSettingsCtrls.push(this.var_164);
         this.var_421 = new Timer(6000,1);
         this.var_421.addEventListener(TimerEvent.TIMER,this.hideInfo);
      }
      ...
      public function dispose() : void
      {
         if(this.var_421)
         {
            this.var_421.removeEventListener(TimerEvent.TIMER,this.hideInfo);
            this.var_421.reset();
            this.var_421 = null;
         }
      ...
      public function toggle() : void
      {
         ...
         this._window.x = this._window.desktop.width - this._window.width - this.const_839;
         this._window.y = this.const_980;
      ...
      private function refreshRoom() : void
      {
         ...
         this.var_310.refresh(this.var_420);
         ...
         Logger.log("XORP: " + this.var_423.visible + ", " + this.var_1392.visible + ", " + this.var_739.visible + ", " + this.var_739.rectangle + ", " + this.var_420.rectangle);
      }
      ...
      private function refreshEvent() : void
      {
         ...
         this.var_422.refresh(this.var_309);
         if(Util.hasVisibleChildren(this.var_309) && !(this.var_164.active || this.var_310.active))
         {
      ...
      private function refreshEmbed() : void
      {
         ...
         if(_loc2_ && _loc1_ && !this.var_164.active && !this.var_310.active && !this.var_422.active)
         {
            this.var_912.visible = true;
            this.var_1130.text = this.getEmbedData();
         }
         else
         {
      ...
      private function refreshButtons() : void
      {
         ...
         if(this.var_911)
         {
            ...
            this.var_911.visible = _loc1_;
            if(this.var_1685)
            {
               this.var_911.caption = "${navigator.zoom.in}";
            }
            else
            {
               this.var_911.caption = "${navigator.zoom.out}";
            }
         }
      }
      ...
      {
         if(param1 == null || this.var_164.active || this.var_310.active)
         {
            return;
         }
         this.var_965.text = param1.roomName;
         this.var_965.height = this.var_965.textHeight + 5;
         this._ownerName.text = param1.ownerName;
         this.var_909.text = param1.description;
         this.var_1133.refreshTags(this.var_423,param1.tags);
         ...
         this._navigator.refreshButton(this.var_1396,"facebook_logo_small",_loc3_,null,0);
         this.var_1396.visible = _loc3_;
         var _loc4_:* = this._navigator.data.currentRoomRating == -1;
         this._navigator.refreshButton(this.var_1394,"thumb_up",_loc4_,null,0);
         this.var_1394.visible = _loc4_;
         this.var_908.visible = !_loc4_;
         this.var_1686.visible = !_loc4_;
         this.var_1686.text = "" + this._navigator.data.currentRoomRating;
         ...
         Util.moveChildrenToColumn(this.var_423,["room_name","owner_name_cont","tags","room_desc","rating_cont","staff_pick_button"],this.var_965.y,0);
      ...
      private function refreshPublicSpaceDetails(param1:PublicRoomShortData) : void
      {
         ...
         this.var_1131.text = this._navigator.getPublicSpaceName(param1.unitPropertySet,param1.worldId);
         this.var_1131.height = this.var_1131.textHeight + 5;
         this.var_1397.text = this._navigator.getPublicSpaceDesc(param1.unitPropertySet,param1.worldId);
         this.var_1397.height = this.var_1397.textHeight + 5;
         Util.moveChildrenToColumn(this.var_739,["public_space_name","public_space_desc"],this.var_1131.y,0);
         this.var_739.visible = true;
         this.var_739.height = Math.max(86,Util.getLowestPoint(this.var_739));
      }
      ...
      private function refreshEventDetails(param1:RoomEventData) : void
      {
         ...
         this.var_2181.text = param1.eventName;
         this.var_740.text = param1.eventDescription;
         this.var_1133.refreshTags(this.var_910,[this._navigator.getText("roomevent_type_" + param1.eventType),param1.tags[0],param1.tags[1]]);
         this.var_740.visible = false;
         if(param1.eventDescription != "")
         {
            this.var_740.height = this.var_740.textHeight + 5;
            this.var_740.y = Util.getLowestPoint(this.var_910) + 2;
      ...
      {
         if(this._navigator.data.enteredGuestRoom == null || this.var_164.active || this.var_310.active)
         {
            return;
         }
         ...
         this.var_1398.visible = this._navigator.data.canEditRoomSettings && !param1;
      ...
      private function refreshEventButtons(param1:RoomEventData) : void
      {
         ...
         this.var_1687.visible = param1 != null && (this._navigator.data.currentRoomOwner || this._navigator.data.eventMod);
         this.var_1682.visible = Util.hasVisibleChildren(this.var_1682);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_739 = IWindowContainer(this.find("public_space_details"));
         this.var_2183 = IWindowContainer(this.find("owner_name_cont"));
         this.var_2182 = IWindowContainer(this.find("rating_cont"));
         this.var_1392 = IWindowContainer(this.find("room_buttons"));
         this.var_965 = ITextWindow(this.find("room_name"));
         this.var_1131 = ITextWindow(this.find("public_space_name"));
         this._ownerName = ITextWindow(this.find("owner_name"));
         this.var_909 = ITextWindow(this.find("room_desc"));
         this.var_1397 = ITextWindow(this.find("public_space_desc"));
         this.var_1132 = ITextWindow(this.find("owner_caption"));
         this.var_908 = ITextWindow(this.find("rating_caption"));
         this.var_1686 = ITextWindow(this.find("rating_txt"));
         this.var_309 = IWindowContainer(this.find("event_info"));
         this.var_910 = IWindowContainer(this.find("event_details"));
         this.var_1682 = IWindowContainer(this.find("event_buttons"));
         this.var_2181 = ITextWindow(this.find("event_name"));
         this.var_740 = ITextWindow(this.find("event_desc"));
         this.var_1396 = IContainerButtonWindow(this.find("facebook_like_button"));
         this.var_1394 = IContainerButtonWindow(this.find("rate_up_button"));
         this.var_2184 = this.find("staff_pick_button");
         this.var_1395 = IContainerButtonWindow(this.find("add_favourite_button"));
         this._remFavouriteButton = IContainerButtonWindow(this.find("rem_favourite_button"));
         this.var_1398 = IContainerButtonWindow(this.find("make_home_button"));
         this.var_1684 = IButtonWindow(this.find("room_settings_button"));
         this.var_1683 = IButtonWindow(this.find("create_event_button"));
         this.var_1687 = IButtonWindow(this.find("edit_event_button"));
         this.var_912 = IWindowContainer(this.find("embed_info"));
         this.var_1393 = ITextWindow(this.find("embed_info_txt"));
         this.var_1130 = ITextFieldWindow(this.find("embed_src_txt"));
         this._buttons = IWindowContainer(this.find("buttons_container"));
         this.var_911 = IButtonWindow(this.find("zoom_button"));
         this.addMouseClickListener(this.var_1395,this.onAddFavouriteClick);
         ...
         this.addMouseClickListener(this.var_1398,this.onMakeHomeClick);
         this.addMouseClickListener(this.var_1683,this.onEventSettingsClick);
         this.addMouseClickListener(this.var_1687,this.onEventSettingsClick);
         this.addMouseClickListener(this.var_1130,this.onEmbedSrcClick);
         this.addMouseClickListener(this.var_1394,this.onThumbUp);
         this.addMouseClickListener(this.var_2184,this.onStaffPick);
         this.addMouseClickListener(this.var_1396,this.onFacebookLike);
         this.addMouseClickListener(this.var_911,this.onZoomClick);
         ...
         this._navigator.refreshButton(this.var_1398,"home",true,null,0);
         ...
         Util.moveChildrenToRow(this.var_2183,["owner_caption","owner_name"],this.var_1132.x,this.var_1132.y,3);
         this.var_908.width = this.var_908.textWidth;
         Util.moveChildrenToRow(this.var_2182,["rating_caption","rating_txt"],this.var_908.x,this.var_908.y,3);
         this.var_1393.height = this.var_1393.textHeight + 5;
         Util.moveChildrenToColumn(this.var_912,["embed_info_txt","embed_src_txt"],this.var_1393.y,2);
         this.var_912.height = Util.getLowestPoint(this.var_912) + 5;
      ...
      {
         this.var_1130.setSelection(0,this.var_1130.text.length);
      }
      
      private function onZoomClick(param1:WindowEvent) : void
      {
         this._navigator.events.dispatchEvent(new HabboNavigatorEvent(HabboNavigatorEvent.const_369));
         this.var_1685 = !this.var_1685;
         this.refreshButtons();
      }
