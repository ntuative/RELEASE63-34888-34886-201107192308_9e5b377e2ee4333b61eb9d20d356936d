package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2356 = new RoomThumbnailRenderer(param1);
         this.var_1133 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_199,this.var_133);
         if(this.var_133.ownerName != "" && this.var_133.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_199,!!this.var_133.event ? this.getEventCtg(this.var_133.categoryId) : this.getRoomCtg(this.var_133.categoryId));
         this.refreshRoomDesc(this.var_199,this.var_133);
         this.refreshExtraCont();
         this.refreshInfo(this.var_199,"trading_allowed",this.var_133.allowTrading);
         this.refreshInfo(this.var_199,"doormode_doorbell",this.var_133.doorMode == 1);
         this.refreshInfo(this.var_199,"doormode_password",this.var_133.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_199,this.var_133.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1133.refreshTags(_loc1_,this.var_133.tags);
         ...
         this.var_2356.refreshThumbnail(_loc1_,this.var_133.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_280,Tabs.const_426,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
