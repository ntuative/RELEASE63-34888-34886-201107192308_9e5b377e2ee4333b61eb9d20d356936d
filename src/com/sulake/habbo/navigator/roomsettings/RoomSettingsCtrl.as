package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1211:ICheckBoxWindow;
      
      private var var_1215:ICheckBoxWindow;
      
      private var var_788:ICheckBoxWindow;
      ...
      {
         if(param1 != this.var_379 || this.var_1214 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1214 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1770)
         {
            this.var_789.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1854)
         {
            this.var_789.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1883)
         {
            this.var_1210.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1947)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1922)
         {
            this.var_986.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_789.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_583,this.onDoorModePasswordUnselect);
         ...
         this.var_789 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1210 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         ...
         this.var_986 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1208 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1213 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1211 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1215 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_788 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1804 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_988 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_987 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2443 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1209 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1212 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1803 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1499 = IWindowContainer(this._window.findChildByName("footer_container"));
         ...
         this.var_1497 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1497.mouseThreshold = 0;
         this.var_1497.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1216.visible = false;
         if(!this.var_1498)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1803.visible = this.var_1498;
         this.populateForm();
         if(this.var_790)
         {
            ...
            this.var_1212.height = Util.getLowestPoint(this.var_1212) + 4;
         }
         else
         {
            this.var_1209.visible = true;
            this.var_1499.visible = true;
            this.var_2443.visible = this.var_1498;
            this.var_1209.height = Util.getLowestPoint(this.var_1209) + 4;
         }
         this.var_1497.text = !!this.var_790 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1209.name,this.var_1212.name,this.var_1499.name,this.var_1803.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_789.setText(_loc1_.name);
         this.var_1210.setText(_loc1_.description);
         this.var_986.setText("");
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_131);
         ...
         if(this.var_1211)
         {
            ...
            {
               this.var_1211.select();
            }
            else
            {
               this.var_1211.unselect();
            }
         }
         if(this.var_1215)
         {
         ...
         {
            this.disableWindow(this.var_788);
            this.disableWindow(this.var_988);
            this.disableWindow(this.var_987);
            this.disableWindow(this.var_1804);
         }
         else
         {
            this.enableWindow(this.var_788);
            this.enableWindow(this.var_988);
            this.enableWindow(this.var_987);
            this.enableWindow(this.var_1804);
         }
         if(this.var_788)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_788.unselect();
            }
         }
         if(this.var_988)
         {
            this.var_988.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_987)
         {
            this.var_987.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_789.getText();
         _loc2_.description = this.var_1210.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_225;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_131;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_677;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_131)
         {
            _loc8_ = this.var_986.getText();
         ...
         _loc2_.allowPets = this.var_1213.isSelected;
         _loc2_.allowFoodConsume = this.var_1211.isSelected;
         _loc2_.allowWalkThrough = this.var_1215.isSelected;
         _loc2_.hideWalls = this.var_788.isSelected;
         _loc2_.wallThickness = this.var_988.selection - 2;
         _loc2_.floorThickness = this.var_987.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_957,_loc2_.tags);
         this.addTag(this.var_955,_loc2_.tags);
         this.clearErrors();
         this.var_1214 = _loc2_.roomId;
      ...
      private function refreshFlatControllers() : void
      {
         ...
         var _loc1_:IWindow = this.var_245.findChildByName("ruler");
         if(_loc1_ != null)
         {
            _loc1_.visible = true;
         }
         var _loc2_:IWindow = this.var_245.findChildByName("flat_ctrls_caption_txt");
         if(_loc2_ != null)
         {
            this._navigator.registerParameter("navigator.roomsettings.flatctrls.caption","cnt","" + this.var_57.controllerCount);
            _loc2_.visible = true;
         }
         var _loc3_:IWindowContainer = IWindowContainer(this.var_245.findChildByName("flat_controller_list"));
         if(_loc3_ != null)
         {
            ...
            _loc5_ = this.var_245.findChildByName("flat_ctrls_info_txt");
            _loc6_ = this.var_245.findChildByName("flat_ctrls_limit_txt");
            _loc7_ = IWindowContainer(this.var_245.findChildByName("flat_controllers_footer"));
            if(this.var_57 != null && this.var_57.controllers.length > 0)
            {
               ...
               Util.moveChildrenToColumn(this.var_245,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc2_.y,5);
            }
            else
            {
         ...
         var _loc4_:IButtonWindow = IButtonWindow(this.var_245.findChildByName("remove_flat_ctrl"));
         if(_loc4_ != null)
         {
            if(_loc8_)
            {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_70,HabboWindowStyle.const_31,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
