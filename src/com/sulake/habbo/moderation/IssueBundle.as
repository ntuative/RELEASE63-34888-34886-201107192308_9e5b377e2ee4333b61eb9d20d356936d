package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_926:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2898 = param2.pickerUserId;
         this.var_3039 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1408 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1409;
         }
         if(this.var_926 == null || param1.timeStamp < this.var_926.timeStamp)
         {
            this.var_926 = param1;
         }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1408 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1409;
            }
            if(this.var_926 == _loc2_)
            {
               this.var_926 = null;
            }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_926;
         if(_loc2_ == null)
         {
