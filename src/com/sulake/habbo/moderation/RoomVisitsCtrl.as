package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1036:Array = [];
      ...
      {
         this.var_844 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1896;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1036.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_844.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1036.length < var_1950)
         {
            ...
            param1.width = this.var_844.width;
            param1.height = this.var_844.height;
            var_1036.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1569)
         {
