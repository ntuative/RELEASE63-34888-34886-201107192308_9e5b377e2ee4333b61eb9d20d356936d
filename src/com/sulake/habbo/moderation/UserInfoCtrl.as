package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1116:int = 3600;
      
      private static const const_1113:int = 86400;
      
      private static const const_1114:int = 31536000;
      ...
      private var var_1295:IWindowContainer;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_1116)
         {
            return Math.round(param1 / const_1115) + " mins ago";
         }
         if(param1 < 2 * const_1113)
         {
            return Math.round(param1 / const_1116) + " hours ago";
         }
         if(param1 < 2 * const_1114)
         {
            return Math.round(param1 / const_1113) + " days ago";
         }
         return Math.round(param1 / const_1114) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1295.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1295.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1198,this._data.userId),this._callerFrame,this.var_1294,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1294,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1482),this._callerFrame,this.var_1294,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1482),this._callerFrame,this.var_1294,false,true);
      }
