package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_537:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_537 = new UserInfoCtrl(this._window,this.var_73,_loc3_.message);
         this.var_1207 = new UserInfoCtrl(this._window,this.var_73,_loc3_.message);
         this.var_537.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1207.load(_loc4_,this.var_173.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_73 != null && this.var_73.issueManager != null && this.var_173 != null)
         {
            this.var_73.issueManager.removeHandler(this.var_173.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.issueManager.closeBundle(this.var_173.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.issueManager.closeBundle(this.var_173.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.issueManager.closeBundle(this.var_173.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.issueManager.releaseBundle(this.var_173.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_73,WindowTracker.const_1370,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_537 = new UserInfoCtrl(this._window,this.var_73,_loc3_.message);
            this.var_537.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
