package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2360:String = "my_issues";
      
      private const const_2359:String = "open_issues";
      
      private const const_2358:String = "picked_issues";
      
      private const const_2380:String = "closed_issues";
      ...
      private var var_413:IIssueBrowserView;
      
      private var var_2108:IIssueBrowserView;
      
      private var var_2110:IIssueBrowserView;
      
      private var var_2109:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_307 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_307.numTabItems)
            {
               _loc5_ = this.var_307.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_48,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_307 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_307 == null || this.var_307.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_307.selector.getSelectableByName("open_issues");
         this.var_307.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_413 == _loc2_)
         {
            return;
         }
         ...
         this.var_413.view.width = this.var_307.container.width;
         this.var_413.view.height = this.var_307.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2360:
               if(this.var_2108 == null)
               {
                  this.var_2108 = new MyIssuesView(this.issueManager,this,this.var_307.container);
               }
               return this.var_2108;
            case this.const_2359:
               if(this.var_2110 == null)
               {
                  this.var_2110 = new OpenIssuesView(this.issueManager,this,this.var_307.container);
               }
               return this.var_2110;
            case this.const_2358:
               if(this.var_2109 == null)
               {
                  this.var_2109 = new PickedIssuesView(this.issueManager,this,this.var_307.container);
               }
