package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1051:Array = [];
      
      private static var var_1984:int = 1000;
      
      private static var var_1052:Array = [];
      
      private static var var_1986:int = 200;
      ...
      private var var_1985:IMessageComposer;
      ...
      {
         this.var_858 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_857 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         ...
         this.var_35.connection.send(this.var_1985);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1051.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_857.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1051.length < var_1984)
         {
            ...
            param1.width = this.var_857.width;
            param1.height = this.var_857.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1052.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_858.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1052.length < var_1986)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_858.width;
            param1.height = this.var_858.height;
            var_1052.push(param1);
         }
         else
         {
            param1.dispose();
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1983[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1584.getValue(param2.chatterName))
            {
               this.var_1584.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1584.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1585)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1586)
         {
