package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1329:IDropMenuWindow;
      ...
      private var var_1600:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_379));
         Logger.log("BEGINNING TO SHOW: " + this.var_379);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1895;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1329 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1329);
         this.var_1329.procedure = this.onSelectTemplate;
         this.var_1067 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1601 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1600 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_815,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_1067.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_2030,_loc2_,this.var_534.text,"",""));
         if(this.var_1601.isSelected || this.var_1600.isSelected || this.var_1067.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1601.isSelected,this.var_1600.isSelected,this.var_1067.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1872);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1739);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1329.selection];
         if(_loc3_ != null)
         {
            this.var_722 = false;
            this.var_534.text = _loc3_;
         }
      }
   }
}
