package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private static const const_718:int = 20;
      ...
      private var var_2062:IWindowContainer;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_2062 = this.var_706.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         if(_loc4_ < _loc5_)
         {
            ...
            {
               _loc3_ = this.var_2062.clone() as IWindowContainer;
         ...
         for each(_loc7_ in param1)
         {
            ...
            if(_loc7_ == null || this.var_2062 == null)
            {
               return;
            }
