package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2673 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1959 = (param2 & 0) > 0;
         if(!this.var_1959)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1959)
            {
               if("false" == this.var_145.getKey("use.default.localizations","false"))
               {
                  _loc5_ = this.var_145.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_197,this.onLocalizationLoaded);
                  super.loadLocalizationFromURL(_loc5_);
               }
            }
            _loc4_ = 1;
            while(this.var_145.keyExists("localization." + _loc4_))
            {
               _loc6_ = this.var_145.getKey("localization." + _loc4_,"");
               _loc7_ = this.var_145.getKey("localization." + _loc4_ + ".name","");
               _loc8_ = this.var_145.getKey("localization." + _loc4_ + ".url","");
               super.method_7(_loc6_,_loc7_,_loc8_);
               _loc4_++;
            }
         }
      }
      ...
      public function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(this.var_145.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_145.getKey("external.override.texts.txt");
      ...
      {
         this.var_1958[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_1958[param1];
      }
      ...
      {
         return this.var_2673[Math.max(0,param1 - 1)];
      }
