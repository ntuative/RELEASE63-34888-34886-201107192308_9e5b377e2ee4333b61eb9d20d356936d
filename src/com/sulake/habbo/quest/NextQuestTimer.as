package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_986:int = 1000;
      
      private static const const_693:String = "next_quest";
      ...
      private function refresh() : void
      {
         ...
         if(_loc1_ < 1)
         {
            ...
            this.var_51.questController.onQuest(this.var_131);
         }
         ...
         this._window.findChildByName("quest_header_txt").caption = this.var_51.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_536 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_536;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_536;
         this._window.findChildByName("more_info_txt").visible = this.var_536 && this.var_51.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_536 && this.var_51.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_536;
         this._window.findChildByName("desc_txt").visible = this.var_536;
         this.refresh();
      }
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_51.questController.questDetails.showDetails(this.var_131);
         }
      }
