package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1647:int = 5;
      
      private static const const_1644:int = 800;
      
      private static const const_1646:int = 15;
      
      private static const const_1645:int = 300;
      ...
      private var var_1316:QuestController;
      
      private var var_1054:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1316 = new QuestController(this);
         this.var_1054 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1647);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_426.events.removeEventListener(BadgeImageReadyEvent.const_212,this.var_1054.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_426.events.addEventListener(BadgeImageReadyEvent.const_212,this.var_1054.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_49)
         {
            ...
            {
               this.var_1316.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1054.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1316.questTracker.isVisible();
      }
