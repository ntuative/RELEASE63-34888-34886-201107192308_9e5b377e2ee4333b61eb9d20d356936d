package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1707:int = 5;
      
      private static const const_1708:int = 10;
      
      private static const const_1710:int = 10;
      
      private static const const_1709:int = 30;
      ...
      private var var_2170:Boolean = true;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_762 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_762.toggle();
         this.var_2170 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1669.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1669[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_65.spacing = const_1708;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1710;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1707;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1709;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_2170 && !this.var_2169)
            {
               this.var_2170 = false;
