   ...
   public class Animation implements IDisposable
   {
      ...
      private function draw() : void
      {
         ...
         if(this.var_1385)
         {
            ...
            {
               if(!_loc2_.isFinished(this.var_1123))
               {
                  _loc1_ = true;
                  _loc3_ = _loc2_.getBitmap(this.var_1123);
                  if(_loc3_ != null)
                  {
                     this.var_98.bitmap.copyPixels(_loc3_,_loc3_.rect,_loc2_.getPosition(this.var_1123));
                  }
               }
            }
         }
         this.var_98.invalidate(this.var_98.rectangle);
         this.var_1385 = _loc1_;
      }
   }
}
