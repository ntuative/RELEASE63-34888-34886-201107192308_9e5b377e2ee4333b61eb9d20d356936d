package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1520:int = 56;
      
      private static const const_476:int = 5;
      
      private static const const_1601:int = 5;
      
      private static const const_1143:Point = new Point(8,8);
      
      private static const const_1690:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc8_.x = const_1143.x;
            _loc8_.y = const_1143.y;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1601;
         }
         ...
         this._window.height = _loc8_.height + const_1520;
      ...
      {
         return this.var_131.waitPeriodSeconds < 1 && const_1690.indexOf(this.var_131.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this.var_51.localization.hasKey(this.var_131.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this.var_51.localization.hasKey(this.var_131.getCampaignLocalizationKey() + ".searchtag");
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this.var_51.openNavigator(this.var_131);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1492 = NextQuestTimer.const_986;
         var _loc2_:Boolean = this.var_51.questController.questsList.refreshDelay(this._window,this.var_131);
         if(_loc2_)
         {
