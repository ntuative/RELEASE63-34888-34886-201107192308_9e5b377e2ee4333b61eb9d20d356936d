package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_2329:String = "WME_MIDDLE_CLICK";
      
      public static const const_2123:String = "WME_MIDDLE_DOWN";
      
      public static const const_2195:String = "WME_MIDDLE_UP";
      ...
      public static const const_254:String = "WME_UP_OUTSIDE";
      
      public static const const_344:String = "WME_WHEEL";
      
      public static const const_2124:String = "WME_RIGHT_CLICK";
      
      public static const const_2217:String = "WME_RIGHT_DOWN";
      
      public static const const_2278:String = "WME_RIGHT_UP";
      
      public static const const_1767:String = "WME_ROLL_OUT";
      
      public static const const_1870:String = "WME_ROLL_OVER";
      
      public static const const_2152:String = "WME_HOVERING";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_753 = param3;
         _loc13_.var_170 = false;
         _loc13_.var_752 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_516 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
