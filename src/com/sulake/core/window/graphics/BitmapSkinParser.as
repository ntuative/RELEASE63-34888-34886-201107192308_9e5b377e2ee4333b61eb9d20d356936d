   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_359 = SkinLayoutEntity.const_636;
                  break;
               case "move":
                  _loc5_.var_359 = SkinLayoutEntity.const_357;
                  break;
               case "strech":
                  _loc5_.var_359 = SkinLayoutEntity.const_663;
                  break;
               case "tiled":
                  _loc5_.var_359 = SkinLayoutEntity.const_352;
                  break;
               case "center":
                  _loc5_.var_359 = SkinLayoutEntity.const_648;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_361 = SkinLayoutEntity.const_636;
                  break;
               case "move":
                  _loc5_.var_361 = SkinLayoutEntity.const_357;
                  break;
               case "strech":
                  _loc5_.var_361 = SkinLayoutEntity.const_663;
                  break;
               case "tiled":
                  _loc5_.var_361 = SkinLayoutEntity.const_352;
                  break;
               case "center":
                  _loc5_.var_361 = SkinLayoutEntity.const_648;
            }
         }
