package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2299:uint = 64;
      
      public static const const_2189:uint = 128;
      ...
      protected var var_937:Boolean;
      
      protected var _disposed:Boolean = false;
      
      protected var var_10:Rectangle;
      
      protected var var_212:Shape;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_212)
            {
               this.var_212 = new Shape();
               this.var_212.visible = false;
               this.var_212.cacheAsBitmap = true;
               super.addChild(this.var_212);
            }
            this.var_212.graphics.clear();
            this.var_212.graphics.beginFill(255);
            this.var_212.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_212.graphics.endFill();
            this.getDisplayObject().mask = this.var_212;
         }
         else if(this.var_212)
         {
            super.removeChild(this.var_212);
            this.var_212.graphics.clear();
            this.var_212 = null;
         ...
         if(this.var_937)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2260,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2260,16777215);
                  }
                  var_366 += bitmap.width * bitmap.height * 4;
               }
