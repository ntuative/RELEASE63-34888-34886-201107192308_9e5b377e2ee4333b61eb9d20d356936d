package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1118:uint = 8;
      
      private static const const_1623:String = "skin";
      
      private static const const_1626:String = "bitmap";
      
      private static const const_1624:String = "fill";
      
      private static const const_1627:String = "text";
      
      private static const const_1628:String = "label";
      
      private static const const_1625:String = "shape";
      ...
      private var var_2655:Dictionary;
      
      private var var_2654:Dictionary;
      
      private var var_2656:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2655 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1951,this.var_2655);
         this.var_2654 = new Dictionary();
         this.var_2656 = new Dictionary();
         StateCodeTable.fillTables(this.var_2654,this.var_2656);
         this.var_467 = new Dictionary();
         this.var_467[const_1623] = BitmapSkinRenderer;
         this.var_467[const_1626] = BitmapDataRenderer;
         this.var_467[const_1624] = FillSkinRenderer;
         this.var_467[const_1627] = TextSkinRenderer;
         this.var_467[const_1628] = LabelRenderer;
         this.var_467[const_1625] = ShapeSkinRenderer;
         this.var_467[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_467[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_367 == null)
         {
            var_367 = new Array();
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3044 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1951[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1038[param1] == null)
         {
            this.var_1038[param1] = new Array(const_1118);
         }
         this.var_1038[param1][param2] = param3;
         if(this.var_1037[param1] == null)
         {
            this.var_1037[param1] = new Array(const_1118);
         }
         this.var_1037[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1038[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1037[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_102)
