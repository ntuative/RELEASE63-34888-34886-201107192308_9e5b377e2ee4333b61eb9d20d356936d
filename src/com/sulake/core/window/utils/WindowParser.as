package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1314:String = "_EXCLUDE";
      
      public static const const_2240:String = "_INCLUDE";
      
      public static const const_2317:String = "_TEMP";
      
      private static const const_1539:String = "layout";
      
      private static const const_1094:String = "window";
      
      private static const const_1093:String = "variables";
      
      private static const const_1092:String = "filters";
      
      private static const const_704:String = "name";
      
      private static const const_1534:String = "style";
      
      private static const const_703:String = "params";
      
      private static const const_1540:String = "tags";
      ...
      private static const const_1541:String = "visible";
      
      private static const const_1542:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1331:String = "blend";
      
      private static const const_1533:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1535:String = "treshold";
      
      private static const const_1546:String = "children";
      
      private static const const_1547:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1543:String = "height_min";
      
      private static const const_1536:String = "height_max";
      
      private static const const_702:String = "true";
      
      private static const const_195:String = "0";
      
      private static const const_1545:String = "$";
      
      private static const const_1537:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1538:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1544:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1711:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1425,this.var_1424);
         this.var_1148 = new Dictionary();
         this.var_1711 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1148,this.var_1711);
         this.var_2259 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1544,const_50);
         return param1.replace(const_1538,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1711)
            {
               delete this.var_1711[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1539)
         {
            _loc8_ = param1.child(const_1093);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1092).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1094);
         ...
         if(param1.localName() == const_1094)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         style = uint(this.parseAttribute(xml,const_1534,variables,style));
         params = uint(this.parseAttribute(xml,const_703,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1540,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1541,variables,visible.toString()) == const_702;
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1542,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1537);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1093)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1547,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1543,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1536,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_702;
         blend = Number(this.parseAttribute(xml,const_1331,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1533,variables,window.clipping.toString()) == const_702;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1535,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1092).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1424[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1314) == -1)
                  {
