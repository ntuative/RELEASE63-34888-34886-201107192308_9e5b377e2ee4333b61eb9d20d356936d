package com.sulake.core.window.utils
{
   ...
   public class MouseCursorControl
   {
      ...
      private static var var_353:Boolean = true;
      
      private static var _disposed:Boolean = false;
      
      private static var var_906:Boolean = true;
      
      private static var var_142:DisplayObject;
      
      private static var var_1675:Dictionary = new Dictionary();
         ...
         if(var_906)
         {
            ...
            else
            {
               ...
               switch(_type)
               {
                  ...
                  case MouseCursorType.const_1814:
                  case MouseCursorType.const_1888:
      ...
      {
         if(var_142 && _type != MouseCursorType.const_31)
         {
            Mouse.hide();
            var_353 = false;
         }
