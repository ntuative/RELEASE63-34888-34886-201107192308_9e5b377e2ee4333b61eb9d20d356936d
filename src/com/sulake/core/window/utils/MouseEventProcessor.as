package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_932:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_365 = new Array();
            var_365[0] = MouseCursorType.const_375;
            var_365[1] = MouseCursorType.const_31;
            var_365[2] = MouseCursorType.const_375;
            var_365[3] = MouseCursorType.const_375;
            var_365[4] = MouseCursorType.const_375;
            var_365[5] = MouseCursorType.const_31;
            var_365[6] = MouseCursorType.const_375;
         }
         if(var_319 == null)
         {
            var_319 = new Array();
            var_319[0] = WindowState.const_93;
            var_319[1] = WindowState.const_90;
            var_319[2] = WindowState.const_92;
            var_319[3] = WindowState.const_77;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_254;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_191 = state.var_1412 as WindowController;
         this.var_171 = state.renderer;
         this.var_932 = state.var_1411;
         eventQueue.begin();
         this.var_747.x = -1;
         this.var_747.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_747.x || event.stageY != this.var_747.y)
            {
               this.var_747.x = event.stageX;
               this.var_747.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_747,array,WindowParam.const_30);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_932.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1412 = this.var_191;
         state.renderer = this.var_171;
         state.var_1411 = this.var_932;
      }
