package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1681:String = "_SELECTOR";
      
      private static const const_1682:String = "_CONTENT";
       
      
      protected var var_1154:ITabSelectorWindow;
      
      protected var var_2269:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1154 = findChildByTag(const_1681) as ITabSelectorWindow;
            if(this.var_1154 != null)
            {
      ...
      {
         if(this.var_2269 == null)
         {
            this.var_2269 = findChildByTag(const_1682) as IWindowContainer;
         }
      ...
      {
         return !!this.var_778 ? this.selector.iterator : null;
      }
