package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_489,this._explicitStyle);
      ...
      private static function method_5(param1:TextController, param2:Boolean) : void
      {
         var _loc3_:TextFormat = param1.defaultTextFormat;
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_489 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_489,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      {
         return new Rectangle(this.var_940 * this.maxScrollH,this.var_608 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_1025,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1283));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1395 ? new PropertyStruct(PropertyDefaults.const_859,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1376) : PropertyDefaults.const_1795);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1199 ? new PropertyStruct(PropertyDefaults.const_1356,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1321) : PropertyDefaults.const_1950);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_951) ? new PropertyStruct(PropertyDefaults.const_457,this._field.textColor,PropertyStruct.const_159,true) : PropertyDefaults.const_1216);
         ...
         _loc1_.push(this.var_42.left != PropertyDefaults.const_899 ? new PropertyStruct(PropertyDefaults.const_311,this.var_42.left,PropertyStruct.const_39,true) : PropertyDefaults.const_946);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_855 ? new PropertyStruct(PropertyDefaults.const_244,this.var_42.top,PropertyStruct.const_39,true) : PropertyDefaults.const_980);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_782 ? new PropertyStruct(PropertyDefaults.const_261,this.var_42.right,PropertyStruct.const_39,true) : PropertyDefaults.const_839);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_876 ? new PropertyStruct(PropertyDefaults.const_307,this.var_42.bottom,PropertyStruct.const_39,true) : PropertyDefaults.const_763);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1301 ? new PropertyStruct(PropertyDefaults.const_901,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1794);
