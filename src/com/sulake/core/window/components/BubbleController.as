package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2076:String = "_POINTER_UP";
      
      private static const const_2077:String = "_POINTER_DOWN";
      
      private static const const_2078:String = "_POINTER_LEFT";
      
      private static const const_2075:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_856;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_834,this._direction,PropertyStruct.const_54,true));
         }
         else
         {
         ...
         if(this.var_856 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_788,this.var_856,PropertyStruct.const_39,true));
         }
         else
         {
