package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      private var var_202:DropMenuController;
      ...
      {
         if(param1 > this.var_291.lenght - 1)
         {
      ...
      {
         if(this.var_202 != null && !this.var_202.disposed)
         {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_202 == null || this.var_202.disposed)
         {
            this.var_202 = context.create(name + "::submenu","",WindowType.const_660,var_92,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_202.setGlobalRectangle(_loc1_);
         }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_291.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_1048 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_202.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_1048)
         {
            if(this.open())
            {
               if(this.var_291.length)
               {
                  this.populateMenuItemContainer(this.var_291,this.getSubMenu(),this.subMenuEventProc);
                  this.var_1048 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1048 = false;
            this.getTitleLabel().text = this.var_681 < this.var_291.length && this.var_681 > -1 ? this.var_291[this.var_681] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_574,var_92,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_433,var_92,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_681 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_681).setStateFlag(WindowState.const_56,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_970)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1350:
            case WindowMouseEvent.const_57:
               ...
               break;
            case WindowTouchEvent.const_979:
            case WindowMouseEvent.const_46:
               ...
               break;
            case WindowEvent.const_664:
               if(param2 == this.var_202)
               {
                  this.closeMenuView();
               }
         }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_291[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_291.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_870,this.var_291,PropertyStruct.const_143,true));
         }
         else
         {
