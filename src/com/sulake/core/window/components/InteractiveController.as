package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         this.var_1709 = PropertyDefaults.const_1019;
         this.var_1421 = PropertyDefaults.const_460;
         param4 |= 0;
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_460)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_1011,param1.toolTipCaption,PropertyStruct.const_54,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1775);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1019)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_998,param1.toolTipDelay,PropertyStruct.const_258,true));
         }
         else
         {
      ...
      {
         this.var_1421 = param1 == null ? "null" : param1;
      }
