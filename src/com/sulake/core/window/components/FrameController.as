package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1488:String = "_TITLE";
      
      private static const const_1487:String = "_HEADER";
      
      private static const const_1489:String = "_CONTENT";
      
      private static const const_1490:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1491:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1488) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1491 = findChildByTag(const_1487) as IHeaderWindow;
            if(!this.var_1491)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_200 = findChildByTag(const_1489) as IWindowContainer;
            if(!this.var_200)
            {
      ...
      {
         return findChildByTag(const_1490) as IScalerWindow;
      }
      ...
      {
         return this.content != null && this.var_1145 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_290);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_302);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_290,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_290,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_362,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_311,_loc3_.left,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_244,_loc3_.top,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_261,0 - _loc3_.right,PropertyStruct.const_39,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_307,0 - _loc3_.bottom,PropertyStruct.const_39,_loc2_));
         return _loc1_;
      }
