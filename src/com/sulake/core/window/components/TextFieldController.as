package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1709:uint = 500;
      
      protected var var_1421:String = "";
      
      protected var var_1429:Boolean = false;
      
      protected var var_778:Boolean = false;
      ...
      {
         this.var_1421 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_778 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_183,event,this,null);
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_18 = _field.text;
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_379,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_885,false,PropertyStruct.const_37,true) : PropertyDefaults.const_2013);
         _loc1_.push(this.var_1429 != PropertyDefaults.const_1344 ? new PropertyStruct(PropertyDefaults.const_814,this.var_1429,PropertyStruct.const_37,true) : PropertyDefaults.const_1862);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1303 ? new PropertyStruct(PropertyDefaults.const_842,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1787);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1389 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1796);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_814:
                  this.var_1429 = _loc2_.value as Boolean;
                  if(this.var_1429)
                  {
               ...
               case PropertyDefaults.const_885:
                  ...
                  break;
               case PropertyDefaults.const_1311:
