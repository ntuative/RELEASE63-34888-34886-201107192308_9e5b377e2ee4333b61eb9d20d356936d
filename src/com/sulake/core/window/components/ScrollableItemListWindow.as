package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_441:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_441)
         {
            this.var_441.removeEventListener(WindowEvent.const_272,this.scrollBarEventProc);
            this.var_441.removeEventListener(WindowEvent.const_308,this.scrollBarEventProc);
            this.var_441 = null;
         }
         if(this.var_1161)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1161)
         {
            this.var_1161 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_441)
         {
            this.var_441 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_441)
            {
               this.var_441.addEventListener(WindowEvent.const_272,this.scrollBarEventProc);
               this.var_441.addEventListener(WindowEvent.const_308,this.scrollBarEventProc);
            }
         }
         return this.var_441;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_308)
         {
            this.hideScrollBar();
         }
      }
