package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_985:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1802:StyleSheet = null;
      ...
      {
         if(PropertyDefaults.const_1027.indexOf(param1) > -1)
         {
            this.var_787 = param1;
         }
      }
      ...
      {
         return this.var_787 == LinkTarget.const_31 ? defaultLinkTarget : this.var_787;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1802;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1291)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_920,this.var_787,PropertyStruct.const_54,true,PropertyDefaults.const_1027));
         }
         else
         {
