   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_578 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_122 is BitmapDataAsset)
         {
            ...
            this.var_1508 = BitmapDataAsset(this.var_122).var_1508;
            this.var_1509 = BitmapDataAsset(this.var_122).var_1509;
            if(this._bitmap != null)
            {
               this.var_122 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1508 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1509 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
