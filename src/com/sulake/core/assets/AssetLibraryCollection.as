package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1151:LoaderContext;
      
      protected var var_508:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         this.var_1151 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         this.var_508 = new AssetLibrary("lib-" + this.var_614++);
         this.var_31.push(this.var_508);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            this.loaderContext = this.var_1151;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + this.var_614++);
      ...
      {
         return this.var_508.loadFromResource(param1,param2);
      }
      ...
      {
         return this.var_508.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return this.var_508.setAsset(param1,param2,param3);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return this.var_508.createAsset(param1,param2);
      }
      ...
      {
         return this.var_508.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_508.getAssetTypeDeclarationByMimeType(param1,true);
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_508.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = uint(this.var_31.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return this.var_508.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = uint(this.var_31.length);
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
