package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1152 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_44 = new Loader();
         this.var_1151 = new LoaderContext();
         this.var_1151.checkPolicyFile = true;
         ...
         {
            this.var_44.load(param2,this.var_1151);
         }
      }
      ...
      {
         this.var_1152 = param1.url;
         var_364 = 0;
         this.var_44.load(param1,this.var_1151);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_364 < var_3067)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1152 + (this.var_1152.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_364),this.var_1151);
               return true;
            }
         }
         return false;
