package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_2024:int = 10000;
      ...
      private var var_1300:IEncryption;
      
      private var var_842:IProtocol;
      
      private var _id:String;
      
      private var var_1301:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1301 = new MessageClassManager();
         this.var_87 = new Socket();
         this.var_222 = new Timer(const_2024,1);
      ...
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_271.addConnectionMessageEvent(this._id,param1);
      }
      ...
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_271.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1301.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         {
            _loc3_ = this.var_1300.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1301.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1300 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_842.getMessages(this.var_557,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1301.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_271.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_271.getMessageParser(parserClass);
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_557.writeByte(this.var_87.readUnsignedByte());
         }
      }
