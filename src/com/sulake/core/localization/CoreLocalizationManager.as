package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      public function method_7(param1:String, param2:String, param3:String) : void
      {
         var _loc4_:LocalizationDefinition = this.var_1126[param1];
         if(_loc4_ == null)
         {
            _loc4_ = new LocalizationDefinition(param1,param2,param3);
            this.var_1126[param1] = _loc4_;
         }
      }
      
      public function activateLocalization(param1:String) : Boolean
      {
         var _loc2_:LocalizationDefinition = this.var_1126[param1];
         if(_loc2_ != null)
         {
      ...
      {
         return this.var_1126[param1] as ILocalizationDefinition;
      }
      
      public function getActiveLocalizationDefinition() : ILocalizationDefinition
      {
         return this.getLocalizationDefinition(this.var_2996);
      }
      ...
      protected function onLocalizationFailed(param1:AssetLoaderEvent) : void
      {
         ...
         Core.error("Failed to download localization",true,Core.const_1800);
      }
