package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2237:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1400:uint = 4;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            this.var_1416 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1416);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1614 & const_1400)
         {
            if(_loc3_ == 0)
            {
