package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1755:String = "float";
      
      public static const const_37:String = "Boolean";
      
      public static const const_1990:String = "bool";
      ...
      private static const const_2100:String = "false";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_291 || _loc5_ == const_143)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1755:
               return Number(param1);
            case const_37:
               return param1 == const_702 || int(param1) > 0;
            case const_1990:
               return param1 == const_702 || int(param1) > 0;
            case const_159:
               return uint(param1);
            case const_143:
               return param1.split(const_1537);
            default:
