package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_726:Map = new Map();
      
      private static const const_390:Map = new Map();
      
      private static var var_1379:Boolean = false;
      ...
      {
         return const_726.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1379)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_726.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1379 = true;
         }
