package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2039:uint = 2;
      
      protected static const const_2037:uint = 4;
      
      protected static const const_2038:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_1907:int = 5;
      ...
      private static var var_976:Array = new Array();
      ...
      protected var var_3129:uint = 0;
      
      protected var var_3049:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1224)
         {
            ...
            while(var_781.length < const_1869 && false)
            {
               _loc1_ = var_976.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1145 ? uint(this.var_1422 - this.var_2254) : uint(getTimer() - this.var_2254);
      }
      ...
      {
         if(this.var_1144 && !_disposed)
         {
            this.var_1144 = false;
            if(!this.var_1145 && this.var_268)
            {
               this.var_1422 = -1;
               this.var_2254 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1145 && !_disposed && this.var_1423 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_268,const_1907 - this.var_1423);
            if(this.var_3049)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_510 == LibraryLoader.const_2038)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_733 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_733.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
