package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_506:Number = 64;
      
      public static const const_1292:Number = 32;
      ...
      private var var_1948:Number = 1.0;
      
      private var var_1946:Number = 1.0;
      
      private var var_1947:Number = 1.0;
      
      private var var_105:Vector3d;
      
      private var var_466:Vector3d;
      
      private var var_3085:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1947 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_463.assign(this.var_105);
         this.var_463.x *= this.var_464;
         this.var_463.y *= this.var_465;
         this.var_463.z *= this.var_462;
         return this.var_463;
      }
      ...
      {
         if(this.var_464 != param1 * this.var_1948)
         {
            this.var_464 = param1 * this.var_1948;
            ++this.var_181;
         }
      }
      ...
      {
         if(this.var_465 != param1 * this.var_1946)
         {
            this.var_465 = param1 * this.var_1946;
            ++this.var_181;
         }
      }
      ...
      {
         if(this.var_462 != param1 * this.var_1947)
         {
            this.var_462 = param1 * this.var_1947;
            ++this.var_181;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_105.x /= this.var_464;
         this.var_105.y /= this.var_465;
         this.var_105.z /= this.var_462;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_466.x;
         var _loc3_:Number = this.var_466.y;
         var _loc4_:Number = this.var_466.z;
         this.var_466.assign(param1);
         this._direction.assign(param1);
         if(this.var_466.x != _loc2_ || this.var_466.y != _loc3_ || this.var_466.z != _loc4_)
         {
            ++this.var_181;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1298.assign(this.var_179);
         }
         else
         {
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_464;
         _loc2_.y *= this.var_465;
         _loc2_.z *= this.var_462;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1299);
         if(_loc3_ < this.var_3085 || _loc3_ > this.var_3086)
         {
            return null;
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_105.x * this.var_464,this.var_105.y * this.var_465,this.var_105.z * this.var_462);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_179;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_464,param2.y * this.var_465,param2.z * this.var_462);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_464,param3.y * this.var_465,param3.z * this.var_462);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_464,param4.y * this.var_465,param4.z * this.var_462);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1292;
         }
         else
         {
            this.scale = const_506;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_506;
      }
