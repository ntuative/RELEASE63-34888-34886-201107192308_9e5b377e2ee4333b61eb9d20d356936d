package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_1020:int = 3;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_421,this.onContentLoaded);
      ...
      {
         var _loc1_:* = null;
         if(this.var_653 == null || this.var_548 == null)
         {
            return;
         }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1020.length > 0)
         {
            _loc2_ = this.var_1020[0];
            this.var_1020.splice(0,1);
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2566)
            {
               this.var_1865 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_59 == null || this.var_548 == null)
         {
            return;
         }
