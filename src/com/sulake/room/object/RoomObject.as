package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      public function RoomObject(param1:int, param2:int, param3:String)
      {
         ...
         this.var_705 = new Array(param2);
         var _loc4_:Number = param2 - 1;
         while(_loc4_ >= 0)
         {
            this.var_705[_loc4_] = 0;
            _loc4_--;
         }
         this._type = param3;
      ...
      {
         this.var_2036.assign(this.var_105);
         return this.var_2036;
      }
      
      public function getDirection() : IVector3d
      {
         this.var_2037.assign(this.var_466);
      ...
      {
         if(param2 >= 0 && param2 < this.var_705.length)
         {
            if(this.var_705[param2] != param1)
            {
               this.var_705[param2] = param1;
               ++this._updateID;
            }
            return true;
         }
