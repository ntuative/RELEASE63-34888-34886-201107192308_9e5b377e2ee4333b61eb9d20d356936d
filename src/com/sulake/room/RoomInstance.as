   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_277 != null)
         {
            ...
            {
               _loc3_ = this.var_277.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_619)
            {
               delete this.var_619[_loc1_];
            }
            this.var_619 = null;
         }
         this.var_1457 = [];
      ...
      public function setNumber(param1:String, param2:Number, param3:Boolean = false) : void
      {
         ...
         {
            this.var_622[param1] = param2;
         }
      }
      
      public function getString(param1:String) : String
      {
         return this.var_619[param1];
      }
      ...
      public function setString(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(this.var_619[param1] != param2)
         {
            this.var_619[param1] = param2;
         }
      }
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_277.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_277.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_277.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_277.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
