package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_1026 = param1 * 1024 * 1024;
         this.var_1895 = param2 * 1024 * 1024;
         this.var_1540 = param3 * 1024 * 1024;
         if(this.var_1540 < 0)
         {
            this.var_1540 = 0;
         }
      ...
      {
         this.var_1026 += this.var_1540;
         if(this.var_1026 > this.var_1895)
         {
            this.var_1026 = this.var_1895;
         }
      }
