package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1833 || param1.getUpdateID() != this.var_2506)
         {
            this.var_2506 = param1.getUpdateID();
            if(param2.updateId != this.var_1833 || _loc4_.x != this.var_1238.x || _loc4_.y != this.var_1238.y || _loc4_.z != this.var_1238.z)
            {
               this.var_1833 = param2.updateId;
               this.var_1238.assign(_loc4_);
               _loc3_ = true;
            }
         }
         this.var_2505 = _loc3_;
         if(_loc3_)
         {
