package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1095:Number = 60;
      
      private static const const_1561:Number = 50;
      ...
      private var var_282:BitmapDataCache;
      
      private var var_647:RoomObjectCache;
      
      private var var_544:Array;
      
      private var var_651:Array;
      
      private var var_1524:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2534:Number = -1.0E7;
      
      private var var_2537:Number = -1.0E7;
      ...
      private var var_1850:Number = 0.0;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_283.addChild(this.var_114);
         ...
         this.var_282 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_647 = new RoomObjectCache(_loc6_);
         this.var_782 = new ColorTransform();
         this.var_652 = new Matrix();
      ...
      {
         this.var_546.x -= param1 - this.var_648;
         this.var_648 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_546.y -= param1 - this.var_650;
         this.var_650 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1070 = true;
            if(this.var_156 != null && !this.var_283.contains(this.var_156))
            {
               this.var_283.addChild(this.var_156);
               this.var_114.mask = this.var_156;
            }
         }
         else if(!param1 && this.var_1070)
         {
            this.var_1070 = false;
            if(this.var_156 != null && this.var_283.contains(this.var_156))
            {
               this.var_283.removeChild(this.var_156);
      ...
      {
         this.var_647.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_1851 = !this.var_1851;
         if(this._container == null || this._geometry == null)
         {
            return;
         }
         if(param1 == this.var_1523)
         {
            return;
         }
         this.calculateUpdateInterval(param1);
         this.var_282.compress();
         ...
         if(this.var_547 != this.var_2535 || this.var_545 != this.var_2533)
         {
            _loc8_ = true;
         }
         if(this.var_114.x != this.var_648 || this.var_114.y != this.var_650)
         {
            this.var_114.x = this.var_648;
            this.var_114.y = this.var_650;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2535 = this.var_547;
         this.var_2533 = this.var_545;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1523 > 0)
         {
            _loc2_ = param1 - this.var_1523;
            if(_loc2_ > const_1095 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2532 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_813;
               if(this.var_813 == const_385 + 1)
               {
                  this.var_553 = _loc2_;
                  this.var_1850 = this.var_2538;
               }
               else if(this.var_813 > const_385 + 1)
               {
                  _loc3_ = Number(this.var_813 - const_385);
                  this.var_553 = this.var_553 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1850 = this.var_1850 * (_loc3_ - 1) / _loc3_ + Number(this.var_2538) / _loc3_;
                  if(this.var_813 > const_385 + const_1560)
                  {
                     this.var_813 = const_385;
                     if(!this.var_1254 && this.var_553 > const_1095)
                     {
                        this.var_1254 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1254 && this.var_553 < const_1561)
                     {
                        this.var_1254 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_647.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_647.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1851 && this.var_1254);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_648;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_650;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_648;
                     _loc17_.y = _loc20_ - this.var_650;
      ...
      {
         if(param1 < this.var_547 && param1 + param3 >= 0 && (param2 < this.var_545 && param2 + param4 >= 0))
         {
            if(!this.var_3078)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param2 + param4 >= this.var_545)
         {
            param4 -= this.var_545 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2536)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_814 || this.var_814 == 0)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_282.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_282.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_282.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_652.identity();
            if(flipH)
            {
               this.var_652.scale(-1,1);
               this.var_652.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_652.scale(1,-1);
               this.var_652.translate(0,data.height);
            }
            finalData.draw(data,this.var_652);
            if(name.length > 0)
            {
               this.var_282.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_782.redMultiplier = tR;
            this.var_782.greenMultiplier = tG;
            this.var_782.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_782);
            if(name.length > 0)
            {
               this.var_282.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_648;
         param2 -= this.var_650;
         this.var_546.x = param1;
         this.var_546.y = param2;
         if(this.var_1253 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - this.var_545 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1849,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_649.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_649.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2534 || param2 != this.var_2537)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_649.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_649.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_387.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1524.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1253 == 0)
         {
            this.checkMouseHits(this.var_546.x,this.var_546.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1253 = 0;
         ++this.var_1849;
      }
