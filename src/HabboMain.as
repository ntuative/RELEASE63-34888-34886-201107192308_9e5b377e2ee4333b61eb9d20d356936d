package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_1043:Number = 0.71;
      ...
      private var var_1436:HabboTracking;
      ...
      private function initializeCore() : void
      {
         ...
         catch(error:Error)
         {
            ...
            Core.crash("Failed to initialize the core: " + error.message,Core.const_1375,error);
         }
      }
      ...
      protected function onAddedToStage(param1:Event = null) : void
      {
         ...
         {
            Habbo.trackLoginStep(Habbo.const_23);
            Habbo.reportCrash("Failed to prepare the core: " + error.message,Core.const_1375,error);
            Core.dispose();
         }
      }
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1436 = HabboTracking.getInstance();
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1436 && !this.var_1436.disposed)
                  {
                     this.var_1436.trackGoogle("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_1043 + this.var_25.getNumberOfFilesLoaded() / _loc11_ * const_1043;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
